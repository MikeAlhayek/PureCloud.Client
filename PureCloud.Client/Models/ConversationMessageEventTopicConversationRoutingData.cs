...
/// </summary>
[DataContract]
public partial class ConversationMessageEventTopicConversationRoutingData : IEquatable<ConversationMessageEventTopicConversationRoutingData>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationMessageEventTopicConversationRoutingData" /> class.
    /// </summary>
    ...
    public ConversationMessageEventTopicConversationRoutingData(ConversationMessageEventTopicUriReference Queue = null, ConversationMessageEventTopicUriReference Language = null, long? Priority = null, List<ConversationMessageEventTopicUriReference> Skills = null, List<ConversationMessageEventTopicScoredAgent> ScoredAgents = null)
    {
        this.Queue = Queue;
    ...
    public ConversationMessageEventTopicUriReference Language { get; set; }
    ...
    public List<ConversationMessageEventTopicUriReference> Skills { get; set; }
    ...
    public List<ConversationMessageEventTopicScoredAgent> ScoredAgents { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationMessageEventTopicConversationRoutingData);
    }

    /// <summary>
    /// Returns true if ConversationMessageEventTopicConversationRoutingData instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationMessageEventTopicConversationRoutingData to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationMessageEventTopicConversationRoutingData other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
