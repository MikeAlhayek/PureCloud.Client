...
/// </summary>
[DataContract]
public partial class IVREntityListing : IEquatable<IVREntityListing>, IPagedResource<IVR>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="IVREntityListing" /> class.
    /// </summary>
    ...
    public IVREntityListing(List<IVR> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, long? TotalNumberOfEntities = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public List<IVR> Entities { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class IVREntityListing {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as IVREntityListing);
    }

    /// <summary>
    /// Returns true if IVREntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of IVREntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(IVREntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
