...
/// </summary>
[DataContract]
public partial class EmergencyGroupDivisionViewEntityListing : IEquatable<EmergencyGroupDivisionViewEntityListing>, IPagedResource<EmergencyGroupDivisionView>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="EmergencyGroupDivisionViewEntityListing" /> class.
    /// </summary>
    ...
    public EmergencyGroupDivisionViewEntityListing(List<EmergencyGroupDivisionView> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, long? TotalNumberOfEntities = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public List<EmergencyGroupDivisionView> Entities { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class EmergencyGroupDivisionViewEntityListing {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as EmergencyGroupDivisionViewEntityListing);
    }

    /// <summary>
    /// Returns true if EmergencyGroupDivisionViewEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of EmergencyGroupDivisionViewEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(EmergencyGroupDivisionViewEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
        ...
        return true &&
            ...
            (
                TotalNumberOfEntities == other.TotalNumberOfEntities ||
                TotalNumberOfEntities != null &&
                TotalNumberOfEntities.Equals(other.TotalNumberOfEntities)
            ) &&
            (
    ...
    public override int GetHashCode()
    {
        ...
        unchecked // Overflow is fine, just wrap
        {
            ...
            if (TotalNumberOfEntities != null)
            {
                hash = hash * 59 + TotalNumberOfEntities.GetHashCode();
            }
