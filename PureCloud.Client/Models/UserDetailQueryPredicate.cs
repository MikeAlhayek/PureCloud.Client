...
/// </summary>
[DataContract]
public partial class UserDetailQueryPredicate : IEquatable<UserDetailQueryPredicate>
{
    /// <summary>
    ...
    public override string ToString()
    {
        ...
        sb.Append("class UserDetailQueryPredicate {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as UserDetailQueryPredicate);
    }

    /// <summary>
    /// Returns true if UserDetailQueryPredicate instances are equal
    /// </summary>
    /// <param name="other">Instance of UserDetailQueryPredicate to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(UserDetailQueryPredicate other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
