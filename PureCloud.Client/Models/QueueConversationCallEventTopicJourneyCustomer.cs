...
/// </summary>
[DataContract]
public partial class QueueConversationCallEventTopicJourneyCustomer : IEquatable<QueueConversationCallEventTopicJourneyCustomer>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="QueueConversationCallEventTopicJourneyCustomer" /> class.
    /// </summary>
    ...
    public QueueConversationCallEventTopicJourneyCustomer(string Id = null, string IdType = null)
    {
        this.Id = Id;
        this.IdType = IdType;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationCallEventTopicJourneyCustomer);
    }

    /// <summary>
    /// Returns true if QueueConversationCallEventTopicJourneyCustomer instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationCallEventTopicJourneyCustomer to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationCallEventTopicJourneyCustomer other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
