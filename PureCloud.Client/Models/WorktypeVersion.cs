...
/// </summary>
[DataContract]
public partial class WorktypeVersion : IEquatable<WorktypeVersion>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="WorktypeVersion" /> class.
    /// </summary>
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as WorktypeVersion);
    }

    /// <summary>
    /// Returns true if WorktypeVersion instances are equal
    /// </summary>
    /// <param name="other">Instance of WorktypeVersion to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(WorktypeVersion other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
