...
/// </summary>
[DataContract]
public partial class GKNDocumentationSearchRequest : IEquatable<GKNDocumentationSearchRequest>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GKNDocumentationSearchRequest" /> class.
    /// </summary>
    ...
    public GKNDocumentationSearchRequest(SortOrderEnum? SortOrder = null, string SortBy = null, int? PageSize = null, int? PageNumber = null, List<SearchSort> Sort = null, List<GKNDocumentationSearchCriteria> Query = null)
    {
    ...
    public List<GKNDocumentationSearchCriteria> Query { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as GKNDocumentationSearchRequest);
    }

    /// <summary>
    /// Returns true if GKNDocumentationSearchRequest instances are equal
    /// </summary>
    /// <param name="other">Instance of GKNDocumentationSearchRequest to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(GKNDocumentationSearchRequest other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
