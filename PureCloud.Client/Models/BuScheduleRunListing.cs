...
public partial class BuScheduleRunListing : IEquatable<BuScheduleRunListing>
{
    ...
    public override string ToString()
    {
        ...
        sb.Append("class BuScheduleRunListing {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as BuScheduleRunListing);
    }

    /// <summary>
    /// Returns true if BuScheduleRunListing instances are equal
    /// </summary>
    /// <param name="other">Instance of BuScheduleRunListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(BuScheduleRunListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
