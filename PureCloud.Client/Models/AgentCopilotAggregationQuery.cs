...
/// </summary>
[DataContract]
public partial class AgentCopilotAggregationQuery : IEquatable<AgentCopilotAggregationQuery>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AgentCopilotAggregationQuery" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected AgentCopilotAggregationQuery() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="AgentCopilotAggregationQuery" /> class.
    /// </summary>
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as AgentCopilotAggregationQuery);
    }

    /// <summary>
    /// Returns true if AgentCopilotAggregationQuery instances are equal
    /// </summary>
    /// <param name="other">Instance of AgentCopilotAggregationQuery to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(AgentCopilotAggregationQuery other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
