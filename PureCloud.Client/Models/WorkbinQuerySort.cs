...
/// </summary>
[DataContract]
public partial class WorkbinQuerySort : IEquatable<WorkbinQuerySort>
{
    /// <summary>
    ...
    public override string ToString()
    {
        ...
        sb.Append("class WorkbinQuerySort {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as WorkbinQuerySort);
    }

    /// <summary>
    /// Returns true if WorkbinQuerySort instances are equal
    /// </summary>
    /// <param name="other">Instance of WorkbinQuerySort to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(WorkbinQuerySort other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
