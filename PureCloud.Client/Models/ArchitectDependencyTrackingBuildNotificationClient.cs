...
public partial class ArchitectDependencyTrackingBuildNotificationClient : IEquatable<ArchitectDependencyTrackingBuildNotificationClient>
{
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ArchitectDependencyTrackingBuildNotificationClient {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ArchitectDependencyTrackingBuildNotificationClient);
    }

    /// <summary>
    /// Returns true if ArchitectDependencyTrackingBuildNotificationClient instances are equal
    /// </summary>
    /// <param name="other">Instance of ArchitectDependencyTrackingBuildNotificationClient to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ArchitectDependencyTrackingBuildNotificationClient other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
