...
/// </summary>
[DataContract]
public partial class IVRDivisionViewEntityListing : IEquatable<IVRDivisionViewEntityListing>, IPagedResource<IVRDivisionView>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="IVRDivisionViewEntityListing" /> class.
    /// </summary>
    ...
    public IVRDivisionViewEntityListing(List<IVRDivisionView> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, long? TotalNumberOfEntities = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public List<IVRDivisionView> Entities { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as IVRDivisionViewEntityListing);
    }

    /// <summary>
    /// Returns true if IVRDivisionViewEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of IVRDivisionViewEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(IVRDivisionViewEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
