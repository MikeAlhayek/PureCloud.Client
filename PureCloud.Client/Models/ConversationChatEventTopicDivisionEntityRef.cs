...
/// </summary>
[DataContract]
public partial class ConversationChatEventTopicDivisionEntityRef : IEquatable<ConversationChatEventTopicDivisionEntityRef>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationChatEventTopicDivisionEntityRef" /> class.
    /// </summary>
    /// <param name="Id">Id.</param>
    /// <param name="SelfUri">SelfUri.</param>
    /// <param name="DateDivisionUpdated">The time the entity division was last updated..</param>
    public ConversationChatEventTopicDivisionEntityRef(string Id = null, string SelfUri = null, DateTime? DateDivisionUpdated = null)
    {
        this.Id = Id;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationChatEventTopicDivisionEntityRef);
    }

    /// <summary>
    /// Returns true if ConversationChatEventTopicDivisionEntityRef instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationChatEventTopicDivisionEntityRef to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationChatEventTopicDivisionEntityRef other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
