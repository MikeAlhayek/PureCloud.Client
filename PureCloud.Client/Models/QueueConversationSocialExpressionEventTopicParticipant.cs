...
public partial class QueueConversationSocialExpressionEventTopicParticipant : IEquatable<QueueConversationSocialExpressionEventTopicParticipant>
{
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationSocialExpressionEventTopicParticipant);
    }

    /// <summary>
    /// Returns true if QueueConversationSocialExpressionEventTopicParticipant instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationSocialExpressionEventTopicParticipant to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationSocialExpressionEventTopicParticipant other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
