...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="OutboundMessagingWhatsappCampaignConfigChangeWhatsAppConfig" /> class.
    /// </summary>
    ...
    public OutboundMessagingWhatsappCampaignConfigChangeWhatsAppConfig(List<string> WhatsAppColumns = null, OutboundMessagingWhatsappCampaignConfigChangeIntegrationRef Integration = null, OutboundMessagingWhatsappCampaignConfigChangeResponseRef ContentTemplate = null)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as OutboundMessagingWhatsappCampaignConfigChangeWhatsAppConfig);
    }

    /// <summary>
    /// Returns true if OutboundMessagingWhatsappCampaignConfigChangeWhatsAppConfig instances are equal
    /// </summary>
    /// <param name="other">Instance of OutboundMessagingWhatsappCampaignConfigChangeWhatsAppConfig to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(OutboundMessagingWhatsappCampaignConfigChangeWhatsAppConfig other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
