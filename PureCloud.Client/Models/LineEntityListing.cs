...
/// </summary>
[DataContract]
public partial class LineEntityListing : IEquatable<LineEntityListing>, IPagedResource<Line>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="LineEntityListing" /> class.
    /// </summary>
    ...
    public LineEntityListing(List<Line> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, long? TotalNumberOfEntities = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public List<Line> Entities { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as LineEntityListing);
    }

    /// <summary>
    /// Returns true if LineEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of LineEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(LineEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
