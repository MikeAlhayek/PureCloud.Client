...
/// </summary>
[DataContract]
public partial class ExternalContactsContactChangedTopicPhoneNumber : IEquatable<ExternalContactsContactChangedTopicPhoneNumber>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ExternalContactsContactChangedTopicPhoneNumber" /> class.
    /// </summary>
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ExternalContactsContactChangedTopicPhoneNumber);
    }

    /// <summary>
    /// Returns true if ExternalContactsContactChangedTopicPhoneNumber instances are equal
    /// </summary>
    /// <param name="other">Instance of ExternalContactsContactChangedTopicPhoneNumber to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ExternalContactsContactChangedTopicPhoneNumber other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
