...
/// </summary>
[DataContract]
public partial class ExtensionPoolDivisionViewEntityListing : IEquatable<ExtensionPoolDivisionViewEntityListing>, IPagedResource<ExtensionPoolDivisionView>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ExtensionPoolDivisionViewEntityListing" /> class.
    /// </summary>
    ...
    public ExtensionPoolDivisionViewEntityListing(List<ExtensionPoolDivisionView> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, long? TotalNumberOfEntities = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public List<ExtensionPoolDivisionView> Entities { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as ExtensionPoolDivisionViewEntityListing);
    }

    /// <summary>
    /// Returns true if ExtensionPoolDivisionViewEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of ExtensionPoolDivisionViewEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ExtensionPoolDivisionViewEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
