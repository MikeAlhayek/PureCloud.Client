...
/// </summary>
[DataContract]
public partial class ConversationChatEventTopicErrorBody : IEquatable<ConversationChatEventTopicErrorBody>
{
    /// <summary>
    ...
    public List<ConversationChatEventTopicDetail> Details { get; set; }
    ...
    public List<ConversationChatEventTopicErrorBody> Errors { get; set; }
    ...
    public ConversationChatEventTopicLimit Limit { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationChatEventTopicErrorBody);
    }

    /// <summary>
    /// Returns true if ConversationChatEventTopicErrorBody instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationChatEventTopicErrorBody to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationChatEventTopicErrorBody other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
