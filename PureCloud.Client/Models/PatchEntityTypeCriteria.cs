...
public partial class PatchEntityTypeCriteria : IEquatable<PatchEntityTypeCriteria>
{
    ...
    /// </summary>
    /// <param name="Key">The criteria key..</param>
    /// <param name="Values">The criteria values..</param>
    ...
    public PatchEntityTypeCriteria(string Key = null, List<string> Values = null, bool? ShouldIgnoreCase = null, OperatorEnum? Operator = null, EntityTypeEnum? EntityType = null)
    {
        this.Key = Key;
        this.Values = Values;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as PatchEntityTypeCriteria);
    }

    /// <summary>
    /// Returns true if PatchEntityTypeCriteria instances are equal
    /// </summary>
    /// <param name="other">Instance of PatchEntityTypeCriteria to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(PatchEntityTypeCriteria other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
