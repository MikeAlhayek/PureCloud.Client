...
public partial class WidgetClientConfigV1 : IEquatable<WidgetClientConfigV1>
{
    ...
    public WidgetClientConfigV1(WebChatSkinEnum? WebChatSkin = null, string AuthenticationUrl = null)
    {
    ...
    /// <summary>
    /// Returns true if WidgetClientConfigV1 instances are equal
    /// </summary>
    /// <param name="other">Instance of WidgetClientConfigV1 to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(WidgetClientConfigV1 other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
