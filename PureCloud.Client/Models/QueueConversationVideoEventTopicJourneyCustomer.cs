...
/// </summary>
[DataContract]
public partial class QueueConversationVideoEventTopicJourneyCustomer : IEquatable<QueueConversationVideoEventTopicJourneyCustomer>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="QueueConversationVideoEventTopicJourneyCustomer" /> class.
    /// </summary>
    ...
    public QueueConversationVideoEventTopicJourneyCustomer(string Id = null, string IdType = null)
    {
        this.Id = Id;
        this.IdType = IdType;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class QueueConversationVideoEventTopicJourneyCustomer {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationVideoEventTopicJourneyCustomer);
    }

    /// <summary>
    /// Returns true if QueueConversationVideoEventTopicJourneyCustomer instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationVideoEventTopicJourneyCustomer to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationVideoEventTopicJourneyCustomer other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
