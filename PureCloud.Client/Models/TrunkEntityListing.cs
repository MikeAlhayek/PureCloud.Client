...
public partial class TrunkEntityListing : IEquatable<TrunkEntityListing>, IPagedResource<Trunk>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="TrunkEntityListing" /> class.
    /// </summary>
    ...
    public TrunkEntityListing(List<Trunk> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, long? TotalNumberOfEntities = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public List<Trunk> Entities { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as TrunkEntityListing);
    }

    /// <summary>
    /// Returns true if TrunkEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of TrunkEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(TrunkEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
