...
/// </summary>
[DataContract]
public partial class ConversationEmailEventTopicJourneyCustomer : IEquatable<ConversationEmailEventTopicJourneyCustomer>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationEmailEventTopicJourneyCustomer" /> class.
    /// </summary>
    ...
    public ConversationEmailEventTopicJourneyCustomer(string Id = null, string IdType = null)
    {
        this.Id = Id;
        this.IdType = IdType;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ConversationEmailEventTopicJourneyCustomer {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationEmailEventTopicJourneyCustomer);
    }

    /// <summary>
    /// Returns true if ConversationEmailEventTopicJourneyCustomer instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationEmailEventTopicJourneyCustomer to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationEmailEventTopicJourneyCustomer other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
