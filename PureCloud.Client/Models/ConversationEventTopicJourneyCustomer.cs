...
/// </summary>
[DataContract]
public partial class ConversationEventTopicJourneyCustomer : IEquatable<ConversationEventTopicJourneyCustomer>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationEventTopicJourneyCustomer" /> class.
    /// </summary>
    ...
    public ConversationEventTopicJourneyCustomer(string Id = null, string IdType = null)
    {
        this.Id = Id;
        this.IdType = IdType;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ConversationEventTopicJourneyCustomer {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationEventTopicJourneyCustomer);
    }

    /// <summary>
    /// Returns true if ConversationEventTopicJourneyCustomer instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationEventTopicJourneyCustomer to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationEventTopicJourneyCustomer other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
