...
public partial class CallHistoryConversationEntityListing : IEquatable<CallHistoryConversationEntityListing>, IPagedResource<CallHistoryConversation>
{
    ...
    public CallHistoryConversationEntityListing(List<CallHistoryConversation> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class CallHistoryConversationEntityListing {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as CallHistoryConversationEntityListing);
    }

    /// <summary>
    /// Returns true if CallHistoryConversationEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of CallHistoryConversationEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(CallHistoryConversationEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
