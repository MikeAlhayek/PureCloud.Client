...
public partial class QueueConversationCallbackEventTopicLimit : IEquatable<QueueConversationCallbackEventTopicLimit>
{
    ...
    public QueueConversationCallbackEventTopicLimit(string Key = null, NamespaceEnum? Namespace = null, long? Value = null, bool? Documented = null)
    {
        this.Key = Key;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class QueueConversationCallbackEventTopicLimit {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationCallbackEventTopicLimit);
    }

    /// <summary>
    /// Returns true if QueueConversationCallbackEventTopicLimit instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationCallbackEventTopicLimit to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationCallbackEventTopicLimit other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
