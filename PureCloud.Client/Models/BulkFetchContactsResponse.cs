...
public partial class BulkFetchContactsResponse : IEquatable<BulkFetchContactsResponse>
{
    ...
    public BulkFetchContactsResponse(List<BulkResponseResultExternalContactEntityBulkEntityErrorEntity> Results = null, int? ErrorCount = null, List<int?> ErrorIndexes = null)
    {
    ...
    public List<BulkResponseResultExternalContactEntityBulkEntityErrorEntity> Results { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as BulkFetchContactsResponse);
    }
