...
/// </summary>
[DataContract]
public partial class ConversationActivityQueryPredicate : IEquatable<ConversationActivityQueryPredicate>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationActivityQueryPredicate" /> class.
    /// </summary>
    ...
    public ConversationActivityQueryPredicate(TypeEnum? Type = null, DimensionEnum? Dimension = null, OperatorEnum? Operator = null, string Value = null)
    {
        this.Type = Type;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ConversationActivityQueryPredicate {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationActivityQueryPredicate);
    }

    /// <summary>
    /// Returns true if ConversationActivityQueryPredicate instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationActivityQueryPredicate to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationActivityQueryPredicate other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
