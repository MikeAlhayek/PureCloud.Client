...
/// </summary>
[DataContract]
public partial class PublishTopicTestTopicPhraseResults : IEquatable<PublishTopicTestTopicPhraseResults>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="PublishTopicTestTopicPhraseResults" /> class.
    /// </summary>
    ...
    public PublishTopicTestTopicPhraseResults(long? ProcessedTranscriptsCount = null, long? MatchedTranscriptsCount = null, List<PublishTopicTestPhraseMatchedTranscript> MatchedTranscripts = null)
    {
    ...
    public List<PublishTopicTestPhraseMatchedTranscript> MatchedTranscripts { get; set; }
    ...
    /// <summary>
    /// Returns true if PublishTopicTestTopicPhraseResults instances are equal
    /// </summary>
    /// <param name="other">Instance of PublishTopicTestTopicPhraseResults to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(PublishTopicTestTopicPhraseResults other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
