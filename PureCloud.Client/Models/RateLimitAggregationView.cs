...
/// </summary>
[DataContract]
public partial class RateLimitAggregationView : IEquatable<RateLimitAggregationView>
{
    /// <summary>
    /// Target metric name
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="RateLimitAggregationView" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected RateLimitAggregationView() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="RateLimitAggregationView" /> class.
    /// </summary>
    ...
    public RateLimitAggregationView(TargetEnum? Target = null, string Name = null, FunctionEnum? Function = null, AggregationRange Range = null)
    {
        this.Target = Target;
        this.Name = Name;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class RateLimitAggregationView {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as RateLimitAggregationView);
    }

    /// <summary>
    /// Returns true if RateLimitAggregationView instances are equal
    /// </summary>
    /// <param name="other">Instance of RateLimitAggregationView to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(RateLimitAggregationView other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
