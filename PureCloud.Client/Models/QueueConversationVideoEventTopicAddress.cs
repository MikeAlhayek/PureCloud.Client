...
public partial class QueueConversationVideoEventTopicAddress : IEquatable<QueueConversationVideoEventTopicAddress>
{
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationVideoEventTopicAddress);
    }

    /// <summary>
    /// Returns true if QueueConversationVideoEventTopicAddress instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationVideoEventTopicAddress to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationVideoEventTopicAddress other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
