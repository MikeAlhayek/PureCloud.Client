...
public partial class WeekScheduleReference : IEquatable<WeekScheduleReference>
{
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as WeekScheduleReference);
    }

    /// <summary>
    /// Returns true if WeekScheduleReference instances are equal
    /// </summary>
    /// <param name="other">Instance of WeekScheduleReference to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(WeekScheduleReference other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
