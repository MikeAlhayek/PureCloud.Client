...
/// </summary>
[DataContract]
public partial class StationEntityListing : IEquatable<StationEntityListing>, IPagedResource<Station>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="StationEntityListing" /> class.
    /// </summary>
    ...
    public StationEntityListing(List<Station> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, long? TotalNumberOfEntities = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public List<Station> Entities { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class StationEntityListing {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as StationEntityListing);
    }

    /// <summary>
    /// Returns true if StationEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of StationEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(StationEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
