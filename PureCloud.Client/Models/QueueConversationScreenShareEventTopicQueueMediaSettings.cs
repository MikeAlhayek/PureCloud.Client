...
/// </summary>
[DataContract]
public partial class QueueConversationScreenShareEventTopicQueueMediaSettings : IEquatable<QueueConversationScreenShareEventTopicQueueMediaSettings>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="QueueConversationScreenShareEventTopicQueueMediaSettings" /> class.
    /// </summary>
    ...
    public QueueConversationScreenShareEventTopicQueueMediaSettings(long? AlertingTimeoutSeconds = null, double? AutoAnswerAlertToneSeconds = null, double? ManualAnswerAlertToneSeconds = null, bool? EnableAutoAnswer = null)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class QueueConversationScreenShareEventTopicQueueMediaSettings {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationScreenShareEventTopicQueueMediaSettings);
    }

    /// <summary>
    /// Returns true if QueueConversationScreenShareEventTopicQueueMediaSettings instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationScreenShareEventTopicQueueMediaSettings to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationScreenShareEventTopicQueueMediaSettings other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
