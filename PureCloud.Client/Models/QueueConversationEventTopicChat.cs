...
/// </summary>
[DataContract]
public partial class QueueConversationEventTopicChat : IEquatable<QueueConversationEventTopicChat>
{
    /// <summary>
    /// Gets or Sets State
    /// </summary>
    ...
    public override string ToString()
    {
        ...
        sb.Append("class QueueConversationEventTopicChat {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationEventTopicChat);
    }

    /// <summary>
    /// Returns true if QueueConversationEventTopicChat instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationEventTopicChat to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationEventTopicChat other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
