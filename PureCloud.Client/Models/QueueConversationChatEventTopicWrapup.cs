...
/// </summary>
[DataContract]
public partial class QueueConversationChatEventTopicWrapup : IEquatable<QueueConversationChatEventTopicWrapup>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="QueueConversationChatEventTopicWrapup" /> class.
    /// </summary>
    ...
    public QueueConversationChatEventTopicWrapup(string Code = null, string Notes = null, List<string> Tags = null, long? DurationSeconds = null, DateTime? EndTime = null)
    {
        this.Code = Code;
        this.Notes = Notes;
        this.Tags = Tags;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationChatEventTopicWrapup);
    }

    /// <summary>
    /// Returns true if QueueConversationChatEventTopicWrapup instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationChatEventTopicWrapup to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationChatEventTopicWrapup other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
