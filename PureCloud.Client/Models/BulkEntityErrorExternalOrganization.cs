...
/// </summary>
[DataContract]
public partial class BulkEntityErrorExternalOrganization : IEquatable<BulkEntityErrorExternalOrganization>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="BulkEntityErrorExternalOrganization" /> class.
    /// </summary>
    ...
    public BulkEntityErrorExternalOrganization(string Code = null, string Message = null, int? Status = null, bool? Retryable = null, List<BulkErrorDetail> Details = null, ExternalOrganization Entity = null)
    {
        this.Code = Code;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class BulkEntityErrorExternalOrganization {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as BulkEntityErrorExternalOrganization);
    }

    /// <summary>
    /// Returns true if BulkEntityErrorExternalOrganization instances are equal
    /// </summary>
    /// <param name="other">Instance of BulkEntityErrorExternalOrganization to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(BulkEntityErrorExternalOrganization other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
