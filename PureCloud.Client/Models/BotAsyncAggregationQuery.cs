...
/// </summary>
[DataContract]
public partial class BotAsyncAggregationQuery : IEquatable<BotAsyncAggregationQuery>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="BotAsyncAggregationQuery" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected BotAsyncAggregationQuery() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="BotAsyncAggregationQuery" /> class.
    /// </summary>
    ...
    public override string ToString()
    {
        ...
        sb.Append("class BotAsyncAggregationQuery {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as BotAsyncAggregationQuery);
    }

    /// <summary>
    /// Returns true if BotAsyncAggregationQuery instances are equal
    /// </summary>
    /// <param name="other">Instance of BotAsyncAggregationQuery to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(BotAsyncAggregationQuery other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
