...
/// </summary>
[DataContract]
public partial class ConversationCobrowseEventTopicErrorBody : IEquatable<ConversationCobrowseEventTopicErrorBody>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationCobrowseEventTopicErrorBody" /> class.
    /// </summary>
    ...
    public List<ConversationCobrowseEventTopicDetail> Details { get; set; }
    ...
    public List<ConversationCobrowseEventTopicErrorBody> Errors { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ConversationCobrowseEventTopicErrorBody {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationCobrowseEventTopicErrorBody);
    }

    /// <summary>
    /// Returns true if ConversationCobrowseEventTopicErrorBody instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationCobrowseEventTopicErrorBody to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationCobrowseEventTopicErrorBody other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
