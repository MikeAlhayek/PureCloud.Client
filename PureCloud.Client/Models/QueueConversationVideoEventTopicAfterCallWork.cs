...
public partial class QueueConversationVideoEventTopicAfterCallWork : IEquatable<QueueConversationVideoEventTopicAfterCallWork>
{
    ...
    public override string ToString()
    {
        ...
        sb.Append("class QueueConversationVideoEventTopicAfterCallWork {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationVideoEventTopicAfterCallWork);
    }

    /// <summary>
    /// Returns true if QueueConversationVideoEventTopicAfterCallWork instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationVideoEventTopicAfterCallWork to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationVideoEventTopicAfterCallWork other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
