...
public partial class Recognition : IEquatable<Recognition>
{
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as Recognition);
    }
    ...
    public bool Equals(Recognition other)
    {
        ...
        return true &&
            ...
            (
                DateDisplayed == other.DateDisplayed ||
                DateDisplayed != null &&
                DateDisplayed.Equals(other.DateDisplayed)
            ) &&
            (
                DateAcknowledged == other.DateAcknowledged ||
                DateAcknowledged != null &&
                DateAcknowledged.Equals(other.DateAcknowledged)
            ) &&
            (
    ...
    public override int GetHashCode()
    {
        ...
        unchecked // Overflow is fine, just wrap
        {
            ...
            {
                hash = hash * 59 + DateDisplayed.GetHashCode();
            }

            if (DateAcknowledged != null)
            {
                hash = hash * 59 + DateAcknowledged.GetHashCode();
            }
