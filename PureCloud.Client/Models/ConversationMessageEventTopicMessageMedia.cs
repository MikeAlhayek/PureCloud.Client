...
/// </summary>
[DataContract]
public partial class ConversationMessageEventTopicMessageMedia : IEquatable<ConversationMessageEventTopicMessageMedia>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationMessageEventTopicMessageMedia" /> class.
    /// </summary>
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ConversationMessageEventTopicMessageMedia {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationMessageEventTopicMessageMedia);
    }

    /// <summary>
    /// Returns true if ConversationMessageEventTopicMessageMedia instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationMessageEventTopicMessageMedia to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationMessageEventTopicMessageMedia other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
