...
/// </summary>
[DataContract]
public partial class RateLimitAggregateQueryFilter : IEquatable<RateLimitAggregateQueryFilter>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="RateLimitAggregateQueryFilter" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected RateLimitAggregateQueryFilter() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="RateLimitAggregateQueryFilter" /> class.
    /// </summary>
    ...
    public RateLimitAggregateQueryFilter(TypeEnum? Type = null, List<RateLimitAggregateQueryClause> Clauses = null, List<RateLimitAggregateQueryPredicate> Predicates = null)
    {
        this.Type = Type;
    ...
    public List<RateLimitAggregateQueryClause> Clauses { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class RateLimitAggregateQueryFilter {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as RateLimitAggregateQueryFilter);
    }

    /// <summary>
    /// Returns true if RateLimitAggregateQueryFilter instances are equal
    /// </summary>
    /// <param name="other">Instance of RateLimitAggregateQueryFilter to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(RateLimitAggregateQueryFilter other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
