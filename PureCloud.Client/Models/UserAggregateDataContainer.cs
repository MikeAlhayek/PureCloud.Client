...
public partial class UserAggregateDataContainer : IEquatable<UserAggregateDataContainer>
{
    ...
    public UserAggregateDataContainer(Dictionary<string, string> Group = null, List<StatisticalResponse> Data = null)
    {
        this.Group = Group;
        this.Data = Data;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as UserAggregateDataContainer);
    }

    /// <summary>
    /// Returns true if UserAggregateDataContainer instances are equal
    /// </summary>
    /// <param name="other">Instance of UserAggregateDataContainer to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(UserAggregateDataContainer other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
