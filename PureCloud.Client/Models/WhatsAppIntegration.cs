...
public partial class WhatsAppIntegration : IEquatable<WhatsAppIntegration>
{
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as WhatsAppIntegration);
    }
    ...
    public bool Equals(WhatsAppIntegration other)
    {
        ...
        return true &&
            ...
            (
                AvailablePhoneNumbers == other.AvailablePhoneNumbers ||
                AvailablePhoneNumbers != null &&
                AvailablePhoneNumbers.Equals(other.AvailablePhoneNumbers)
            ) &&
            (
                Status == other.Status ||
                Status != null &&
            ...
            (
                ActivationStatusCode == other.ActivationStatusCode ||
                ActivationStatusCode != null &&
                ActivationStatusCode.Equals(other.ActivationStatusCode)
            ) &&
            (
                ActivationErrorInfo == other.ActivationErrorInfo ||
                ActivationErrorInfo != null &&
                ActivationErrorInfo.Equals(other.ActivationErrorInfo)
            ) &&
            (
    ...
    public override int GetHashCode()
    {
        ...
        unchecked // Overflow is fine, just wrap
        {
            ...
            {
                hash = hash * 59 + AvailablePhoneNumbers.GetHashCode();
            }
            ...
            if (ActivationStatusCode != null)
            {
                hash = hash * 59 + ActivationStatusCode.GetHashCode();
            }

            if (ActivationErrorInfo != null)
            {
                hash = hash * 59 + ActivationErrorInfo.GetHashCode();
            }
