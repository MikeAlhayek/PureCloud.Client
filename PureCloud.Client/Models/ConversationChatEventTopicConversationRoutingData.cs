...
/// </summary>
[DataContract]
public partial class ConversationChatEventTopicConversationRoutingData : IEquatable<ConversationChatEventTopicConversationRoutingData>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationChatEventTopicConversationRoutingData" /> class.
    /// </summary>
    ...
    public ConversationChatEventTopicConversationRoutingData(ConversationChatEventTopicUriReference Queue = null, ConversationChatEventTopicUriReference Language = null, long? Priority = null, List<ConversationChatEventTopicUriReference> Skills = null, List<ConversationChatEventTopicScoredAgent> ScoredAgents = null)
    {
        this.Queue = Queue;
    ...
    public ConversationChatEventTopicUriReference Language { get; set; }
    ...
    public List<ConversationChatEventTopicUriReference> Skills { get; set; }
    ...
    public List<ConversationChatEventTopicScoredAgent> ScoredAgents { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationChatEventTopicConversationRoutingData);
    }

    /// <summary>
    /// Returns true if ConversationChatEventTopicConversationRoutingData instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationChatEventTopicConversationRoutingData to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationChatEventTopicConversationRoutingData other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
