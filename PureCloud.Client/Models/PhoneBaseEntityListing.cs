...
/// </summary>
[DataContract]
public partial class PhoneBaseEntityListing : IEquatable<PhoneBaseEntityListing>, IPagedResource<PhoneBase>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="PhoneBaseEntityListing" /> class.
    /// </summary>
    ...
    public PhoneBaseEntityListing(List<PhoneBase> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, long? TotalNumberOfEntities = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public List<PhoneBase> Entities { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as PhoneBaseEntityListing);
    }

    /// <summary>
    /// Returns true if PhoneBaseEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of PhoneBaseEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(PhoneBaseEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
