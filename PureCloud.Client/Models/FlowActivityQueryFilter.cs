...
/// </summary>
[DataContract]
public partial class FlowActivityQueryFilter : IEquatable<FlowActivityQueryFilter>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="FlowActivityQueryFilter" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected FlowActivityQueryFilter() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="FlowActivityQueryFilter" /> class.
    /// </summary>
    ...
    public FlowActivityQueryFilter(TypeEnum? Type = null, List<FlowActivityQueryClause> Clauses = null, List<FlowActivityQueryPredicate> Predicates = null)
    {
        this.Type = Type;
    ...
    public List<FlowActivityQueryClause> Clauses { get; set; }
    ...
    public List<FlowActivityQueryPredicate> Predicates { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class FlowActivityQueryFilter {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as FlowActivityQueryFilter);
    }

    /// <summary>
    /// Returns true if FlowActivityQueryFilter instances are equal
    /// </summary>
    /// <param name="other">Instance of FlowActivityQueryFilter to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(FlowActivityQueryFilter other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
