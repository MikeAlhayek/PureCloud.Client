...
/// </summary>
[DataContract]
public partial class QueueConversationVideoEventTopicFaxStatus : IEquatable<QueueConversationVideoEventTopicFaxStatus>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="QueueConversationVideoEventTopicFaxStatus" /> class.
    /// </summary>
    ...
    public QueueConversationVideoEventTopicFaxStatus(string Direction = null, long? ExpectedPages = null, long? ActivePage = null, long? LinesTransmitted = null, long? BytesTransmitted = null, long? BaudRate = null, long? PageErrors = null, long? LineErrors = null)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationVideoEventTopicFaxStatus);
    }

    /// <summary>
    /// Returns true if QueueConversationVideoEventTopicFaxStatus instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationVideoEventTopicFaxStatus to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationVideoEventTopicFaxStatus other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
