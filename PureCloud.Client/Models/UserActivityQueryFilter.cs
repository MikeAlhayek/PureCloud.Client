...
/// </summary>
[DataContract]
public partial class UserActivityQueryFilter : IEquatable<UserActivityQueryFilter>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="UserActivityQueryFilter" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected UserActivityQueryFilter() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="UserActivityQueryFilter" /> class.
    /// </summary>
    ...
    public UserActivityQueryFilter(TypeEnum? Type = null, List<UserActivityQueryClause> Clauses = null, List<UserActivityQueryPredicate> Predicates = null)
    {
        this.Type = Type;
    ...
    public List<UserActivityQueryClause> Clauses { get; set; }
    ...
    public List<UserActivityQueryPredicate> Predicates { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as UserActivityQueryFilter);
    }

    /// <summary>
    /// Returns true if UserActivityQueryFilter instances are equal
    /// </summary>
    /// <param name="other">Instance of UserActivityQueryFilter to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(UserActivityQueryFilter other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
