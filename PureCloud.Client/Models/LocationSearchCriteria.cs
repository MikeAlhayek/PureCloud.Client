...
/// </summary>
[DataContract]
public partial class LocationSearchCriteria : IEquatable<LocationSearchCriteria>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="LocationSearchCriteria" /> class.
    /// </summary>
    ...
    public LocationSearchCriteria(string EndValue = null, List<string> Values = null, string StartValue = null, string Value = null, OperatorEnum? Operator = null, List<LocationSearchCriteria> Group = null, string DateFormat = null, TypeEnum? Type = null, List<string> Fields = null)
    {
    ...
    public List<LocationSearchCriteria> Group { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as LocationSearchCriteria);
    }

    /// <summary>
    /// Returns true if LocationSearchCriteria instances are equal
    /// </summary>
    /// <param name="other">Instance of LocationSearchCriteria to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(LocationSearchCriteria other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
