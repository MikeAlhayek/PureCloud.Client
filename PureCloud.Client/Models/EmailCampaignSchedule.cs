...
public partial class EmailCampaignSchedule : IEquatable<EmailCampaignSchedule>
{
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as EmailCampaignSchedule);
    }
    ...
    public bool Equals(EmailCampaignSchedule other)
    {
        ...
        return true &&
            ...
            (
                EmailCampaign == other.EmailCampaign ||
                EmailCampaign != null &&
                EmailCampaign.Equals(other.EmailCampaign)
            ) &&
            (
    ...
    public override int GetHashCode()
    {
        ...
        unchecked // Overflow is fine, just wrap
        {
            ...
            {
                hash = hash * 59 + EmailCampaign.GetHashCode();
            }
