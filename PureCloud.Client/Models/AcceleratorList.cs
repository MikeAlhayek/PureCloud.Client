...
public partial class AcceleratorList : IEquatable<AcceleratorList>, IPagedResource<AcceleratorMetadata>
{
    ...
    {
        WriteIndented = true
        // MetadataPropertyHandling is not needed; System.Text.Json does not use $metadata by default
    };

    /// <summary>
    /// Initializes a new instance of the <see cref="AcceleratorList" /> class.
    /// </summary>
    ...
    public AcceleratorList(List<AcceleratorMetadata> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class AcceleratorList {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as AcceleratorList);
    }

    /// <summary>
    /// Returns true if AcceleratorList instances are equal
    /// </summary>
    /// <param name="other">Instance of AcceleratorList to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(AcceleratorList other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
