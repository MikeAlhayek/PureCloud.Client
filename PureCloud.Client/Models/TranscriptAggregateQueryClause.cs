...
public partial class TranscriptAggregateQueryClause : IEquatable<TranscriptAggregateQueryClause>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="TranscriptAggregateQueryClause" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected TranscriptAggregateQueryClause() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="TranscriptAggregateQueryClause" /> class.
    /// </summary>
    ...
    public TranscriptAggregateQueryClause(TypeEnum? Type = null, List<TranscriptAggregateQueryPredicate> Predicates = null)
    {
        this.Type = Type;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class TranscriptAggregateQueryClause {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as TranscriptAggregateQueryClause);
    }

    /// <summary>
    /// Returns true if TranscriptAggregateQueryClause instances are equal
    /// </summary>
    /// <param name="other">Instance of TranscriptAggregateQueryClause to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(TranscriptAggregateQueryClause other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
