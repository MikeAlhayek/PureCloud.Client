...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="OutboundMessagingCampaignPreContactEmailEventTopicEmailAttributes" /> class.
    /// </summary>
    ...
    public OutboundMessagingCampaignPreContactEmailEventTopicEmailAttributes(string EmailSubject = null, string ConfiguredEmailAddress = null, string ContactEmailAddress = null, string ReplyToAddress = null, string ContactEmailColumnName = null)
    {
    ...
    /// <summary>
    /// Returns true if OutboundMessagingCampaignPreContactEmailEventTopicEmailAttributes instances are equal
    /// </summary>
    /// <param name="other">Instance of OutboundMessagingCampaignPreContactEmailEventTopicEmailAttributes to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(OutboundMessagingCampaignPreContactEmailEventTopicEmailAttributes other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
