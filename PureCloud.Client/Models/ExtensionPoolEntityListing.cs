...
/// </summary>
[DataContract]
public partial class ExtensionPoolEntityListing : IEquatable<ExtensionPoolEntityListing>, IPagedResource<ExtensionPool>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ExtensionPoolEntityListing" /> class.
    /// </summary>
    ...
    public ExtensionPoolEntityListing(List<ExtensionPool> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, long? TotalNumberOfEntities = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public List<ExtensionPool> Entities { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ExtensionPoolEntityListing {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as ExtensionPoolEntityListing);
    }

    /// <summary>
    /// Returns true if ExtensionPoolEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of ExtensionPoolEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ExtensionPoolEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
