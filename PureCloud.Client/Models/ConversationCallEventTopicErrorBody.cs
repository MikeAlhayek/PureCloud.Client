...
/// </summary>
[DataContract]
public partial class ConversationCallEventTopicErrorBody : IEquatable<ConversationCallEventTopicErrorBody>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationCallEventTopicErrorBody" /> class.
    /// </summary>
    ...
    public ConversationCallEventTopicErrorBody(string Message = null, string Code = null, long? Status = null, string EntityId = null, string EntityName = null, string MessageWithParams = null, Dictionary<string, string> MessageParams = null, string ContextId = null, List<ConversationCallEventTopicDetail> Details = null, List<ConversationCallEventTopicErrorBody> Errors = null, ConversationCallEventTopicLimit Limit = null)
    {
    ...
    public List<ConversationCallEventTopicDetail> Details { get; set; }
    ...
    public List<ConversationCallEventTopicErrorBody> Errors { get; set; }
    ...
    public ConversationCallEventTopicLimit Limit { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationCallEventTopicErrorBody);
    }

    /// <summary>
    /// Returns true if ConversationCallEventTopicErrorBody instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationCallEventTopicErrorBody to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationCallEventTopicErrorBody other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
