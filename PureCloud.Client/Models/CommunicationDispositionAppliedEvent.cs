...
/// </summary>
[DataContract]
public partial class CommunicationDispositionAppliedEvent : IEquatable<CommunicationDispositionAppliedEvent>
{

    /// <summary>
    /// Initializes a new instance of the <see cref="CommunicationDispositionAppliedEvent" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected CommunicationDispositionAppliedEvent() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="CommunicationDispositionAppliedEvent" /> class.
    /// </summary>
    ...
    public CommunicationDispositionAppliedEvent(string EventId = null, DateTime? EventDateTime = null, string ConversationId = null, string CommunicationId = null, string Code = null, string Notes = null, List<string> Tags = null)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as CommunicationDispositionAppliedEvent);
    }

    /// <summary>
    /// Returns true if CommunicationDispositionAppliedEvent instances are equal
    /// </summary>
    /// <param name="other">Instance of CommunicationDispositionAppliedEvent to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(CommunicationDispositionAppliedEvent other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
