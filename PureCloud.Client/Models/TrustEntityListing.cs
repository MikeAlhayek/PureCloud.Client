...
/// </summary>
[DataContract]
public partial class TrustEntityListing : IEquatable<TrustEntityListing>, IPagedResource<Trustee>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="TrustEntityListing" /> class.
    /// </summary>
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as TrustEntityListing);
    }

    /// <summary>
    /// Returns true if TrustEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of TrustEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(TrustEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
