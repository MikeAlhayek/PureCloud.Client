...
/// </summary>
[DataContract]
public partial class ConversationCobrowseEventTopicWrapup : IEquatable<ConversationCobrowseEventTopicWrapup>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationCobrowseEventTopicWrapup" /> class.
    /// </summary>
    ...
    public ConversationCobrowseEventTopicWrapup(string Code = null, string Notes = null, List<string> Tags = null, long? DurationSeconds = null, DateTime? EndTime = null)
    {
        this.Code = Code;
        this.Notes = Notes;
        this.Tags = Tags;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ConversationCobrowseEventTopicWrapup {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationCobrowseEventTopicWrapup);
    }

    /// <summary>
    /// Returns true if ConversationCobrowseEventTopicWrapup instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationCobrowseEventTopicWrapup to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationCobrowseEventTopicWrapup other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
