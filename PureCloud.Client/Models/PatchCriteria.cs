...
public partial class PatchCriteria : IEquatable<PatchCriteria>
{
    ...
    public PatchCriteria(string Key = null, List<string> Values = null, bool? ShouldIgnoreCase = null, OperatorEnum? Operator = null)
    {
        this.Key = Key;
        this.Values = Values;
    ...
    /// <summary>
    /// Returns true if PatchCriteria instances are equal
    /// </summary>
    /// <param name="other">Instance of PatchCriteria to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(PatchCriteria other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
