...
/// </summary>
[DataContract]
public partial class JourneySessionEventsNotificationReferrer : IEquatable<JourneySessionEventsNotificationReferrer>
{
    /// <summary>
    /// Gets or Sets Medium
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="JourneySessionEventsNotificationReferrer" /> class.
    /// </summary>
    ...
    public JourneySessionEventsNotificationReferrer(string Url = null, string Domain = null, string Hostname = null, string Keywords = null, string Pathname = null, string QueryString = null, string Fragment = null, string Name = null, MediumEnum? Medium = null)
    {
        this.Url = Url;
        this.Domain = Domain;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class JourneySessionEventsNotificationReferrer {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as JourneySessionEventsNotificationReferrer);
    }

    /// <summary>
    /// Returns true if JourneySessionEventsNotificationReferrer instances are equal
    /// </summary>
    /// <param name="other">Instance of JourneySessionEventsNotificationReferrer to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(JourneySessionEventsNotificationReferrer other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
