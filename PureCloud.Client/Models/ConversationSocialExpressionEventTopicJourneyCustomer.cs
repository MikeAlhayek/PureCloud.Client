...
/// </summary>
[DataContract]
public partial class ConversationSocialExpressionEventTopicJourneyCustomer : IEquatable<ConversationSocialExpressionEventTopicJourneyCustomer>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationSocialExpressionEventTopicJourneyCustomer" /> class.
    /// </summary>
    ...
    public ConversationSocialExpressionEventTopicJourneyCustomer(string Id = null, string IdType = null)
    {
        this.Id = Id;
        this.IdType = IdType;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationSocialExpressionEventTopicJourneyCustomer);
    }

    /// <summary>
    /// Returns true if ConversationSocialExpressionEventTopicJourneyCustomer instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationSocialExpressionEventTopicJourneyCustomer to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationSocialExpressionEventTopicJourneyCustomer other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
