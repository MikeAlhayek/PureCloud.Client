...
/// </summary>
[DataContract]
public partial class QueueConversationChatEventTopicJourneyCustomer : IEquatable<QueueConversationChatEventTopicJourneyCustomer>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="QueueConversationChatEventTopicJourneyCustomer" /> class.
    /// </summary>
    ...
    public QueueConversationChatEventTopicJourneyCustomer(string Id = null, string IdType = null)
    {
        this.Id = Id;
        this.IdType = IdType;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class QueueConversationChatEventTopicJourneyCustomer {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationChatEventTopicJourneyCustomer);
    }

    /// <summary>
    /// Returns true if QueueConversationChatEventTopicJourneyCustomer instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationChatEventTopicJourneyCustomer to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationChatEventTopicJourneyCustomer other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
