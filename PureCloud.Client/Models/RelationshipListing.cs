...
/// </summary>
[DataContract]
public partial class RelationshipListing : IEquatable<RelationshipListing>, IPagedResource<Relationship>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="RelationshipListing" /> class.
    /// </summary>
    ...
    public RelationshipListing(List<Relationship> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, bool? PartialResults = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class RelationshipListing {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as RelationshipListing);
    }

    /// <summary>
    /// Returns true if RelationshipListing instances are equal
    /// </summary>
    /// <param name="other">Instance of RelationshipListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(RelationshipListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
