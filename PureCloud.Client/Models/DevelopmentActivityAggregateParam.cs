...
public partial class DevelopmentActivityAggregateParam : IEquatable<DevelopmentActivityAggregateParam>
{
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as DevelopmentActivityAggregateParam);
    }

    /// <summary>
    /// Returns true if DevelopmentActivityAggregateParam instances are equal
    /// </summary>
    /// <param name="other">Instance of DevelopmentActivityAggregateParam to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(DevelopmentActivityAggregateParam other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
