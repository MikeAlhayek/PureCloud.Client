...
public partial class MessageMediaParticipant : IEquatable<MessageMediaParticipant>
{
    ...
    /// </summary>
    /// <value>The ID of the participant being monitored when performing a message monitor.</value>
    ...
    [JsonPropertyName("monitoredParticipant")]
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as MessageMediaParticipant);
    }
    ...
    public bool Equals(MessageMediaParticipant other)
    {
        ...
        return true &&
            ...
            (
                MonitoredParticipant == other.MonitoredParticipant ||
                MonitoredParticipant != null &&
                MonitoredParticipant.Equals(other.MonitoredParticipant)
            );
    }
    ...
    public override int GetHashCode()
    {
        ...
        unchecked // Overflow is fine, just wrap
        {
            ...
            if (MonitoredParticipant != null)
            {
                hash = hash * 59 + MonitoredParticipant.GetHashCode();
            }
