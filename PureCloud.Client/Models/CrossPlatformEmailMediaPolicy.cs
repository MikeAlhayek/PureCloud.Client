...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CrossPlatformEmailMediaPolicy" /> class.
    /// </summary>
    ...
    public CrossPlatformEmailMediaPolicy(CrossPlatformPolicyActions Actions = null, EmailMediaPolicyConditions Conditions = null)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class CrossPlatformEmailMediaPolicy {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as CrossPlatformEmailMediaPolicy);
    }

    /// <summary>
    /// Returns true if CrossPlatformEmailMediaPolicy instances are equal
    /// </summary>
    /// <param name="other">Instance of CrossPlatformEmailMediaPolicy to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(CrossPlatformEmailMediaPolicy other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
