...
/// </summary>
[DataContract]
public partial class WorkPlanValidationRequest : IEquatable<WorkPlanValidationRequest>
{
    /// <summary>
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as WorkPlanValidationRequest);
    }

    /// <summary>
    /// Returns true if WorkPlanValidationRequest instances are equal
    /// </summary>
    /// <param name="other">Instance of WorkPlanValidationRequest to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(WorkPlanValidationRequest other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
