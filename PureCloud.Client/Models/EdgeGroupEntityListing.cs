...
/// </summary>
[DataContract]
public partial class EdgeGroupEntityListing : IEquatable<EdgeGroupEntityListing>, IPagedResource<EdgeGroup>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="EdgeGroupEntityListing" /> class.
    /// </summary>
    ...
    public EdgeGroupEntityListing(List<EdgeGroup> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, long? TotalNumberOfEntities = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public List<EdgeGroup> Entities { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class EdgeGroupEntityListing {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as EdgeGroupEntityListing);
    }

    /// <summary>
    /// Returns true if EdgeGroupEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of EdgeGroupEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(EdgeGroupEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
