...
public partial class JourneyWebEventsNotificationGeoLocation : IEquatable<JourneyWebEventsNotificationGeoLocation>
{
    ...
    public JourneyWebEventsNotificationGeoLocation(string Country = null, string CountryName = null, double? Latitude = null, double? Longitude = null, string Locality = null, string PostalCode = null, string Region = null, string RegionName = null, string Timezone = null, string Source = null)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as JourneyWebEventsNotificationGeoLocation);
    }

    /// <summary>
    /// Returns true if JourneyWebEventsNotificationGeoLocation instances are equal
    /// </summary>
    /// <param name="other">Instance of JourneyWebEventsNotificationGeoLocation to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(JourneyWebEventsNotificationGeoLocation other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
