...
public partial class DialerContactlistConfigChangeImportStatus : IEquatable<DialerContactlistConfigChangeImportStatus>
{
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as DialerContactlistConfigChangeImportStatus);
    }

    /// <summary>
    /// Returns true if DialerContactlistConfigChangeImportStatus instances are equal
    /// </summary>
    /// <param name="other">Instance of DialerContactlistConfigChangeImportStatus to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(DialerContactlistConfigChangeImportStatus other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
