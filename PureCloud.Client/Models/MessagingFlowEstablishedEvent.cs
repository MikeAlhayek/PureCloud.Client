...
/// </summary>
[DataContract]
public partial class MessagingFlowEstablishedEvent : IEquatable<MessagingFlowEstablishedEvent>
{

    /// <summary>
    /// Initializes a new instance of the <see cref="MessagingFlowEstablishedEvent" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected MessagingFlowEstablishedEvent() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="MessagingFlowEstablishedEvent" /> class.
    /// </summary>
    ...
    public MessagingFlowEstablishedEvent(string EventId = null, DateTime? EventDateTime = null, string ConversationId = null, string CommunicationId = null, MessagingInitialConfiguration InitialConfiguration = null, SourceConfiguration SourceConfiguration = null)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class MessagingFlowEstablishedEvent {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as MessagingFlowEstablishedEvent);
    }

    /// <summary>
    /// Returns true if MessagingFlowEstablishedEvent instances are equal
    /// </summary>
    /// <param name="other">Instance of MessagingFlowEstablishedEvent to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(MessagingFlowEstablishedEvent other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
