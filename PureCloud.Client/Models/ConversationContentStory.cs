...
public partial class ConversationContentStory : IEquatable<ConversationContentStory>
{
    ...
    public ConversationContentStory(TypeEnum? Type = null, string Url = null, string ReplyToId = null)
    {
        this.Type = Type;
        this.Url = Url;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationContentStory);
    }

    /// <summary>
    /// Returns true if ConversationContentStory instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationContentStory to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationContentStory other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
