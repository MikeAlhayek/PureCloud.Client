...
public partial class WorkitemsUserEventsNotificationWrapup : IEquatable<WorkitemsUserEventsNotificationWrapup>
{
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as WorkitemsUserEventsNotificationWrapup);
    }

    /// <summary>
    /// Returns true if WorkitemsUserEventsNotificationWrapup instances are equal
    /// </summary>
    /// <param name="other">Instance of WorkitemsUserEventsNotificationWrapup to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(WorkitemsUserEventsNotificationWrapup other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
