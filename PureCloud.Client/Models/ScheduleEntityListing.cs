...
/// </summary>
[DataContract]
public partial class ScheduleEntityListing : IEquatable<ScheduleEntityListing>, IPagedResource<Schedule>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ScheduleEntityListing" /> class.
    /// </summary>
    ...
    public ScheduleEntityListing(List<Schedule> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, long? TotalNumberOfEntities = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public List<Schedule> Entities { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ScheduleEntityListing {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as ScheduleEntityListing);
    }

    /// <summary>
    /// Returns true if ScheduleEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of ScheduleEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ScheduleEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
