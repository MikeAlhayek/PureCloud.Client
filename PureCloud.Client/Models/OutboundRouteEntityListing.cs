...
/// </summary>
[DataContract]
public partial class OutboundRouteEntityListing : IEquatable<OutboundRouteEntityListing>, IPagedResource<OutboundRoute>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="OutboundRouteEntityListing" /> class.
    /// </summary>
    ...
    public OutboundRouteEntityListing(List<OutboundRoute> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, long? TotalNumberOfEntities = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public List<OutboundRoute> Entities { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as OutboundRouteEntityListing);
    }

    /// <summary>
    /// Returns true if OutboundRouteEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of OutboundRouteEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(OutboundRouteEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
