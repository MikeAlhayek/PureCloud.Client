...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="QueueConversationSocialExpressionEventTopicDivisionEntityRef" /> class.
    /// </summary>
    /// <param name="Id">Id.</param>
    /// <param name="SelfUri">SelfUri.</param>
    /// <param name="DateDivisionUpdated">The time the entity division was last updated..</param>
    public QueueConversationSocialExpressionEventTopicDivisionEntityRef(string Id = null, string SelfUri = null, DateTime? DateDivisionUpdated = null)
    {
        this.Id = Id;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class QueueConversationSocialExpressionEventTopicDivisionEntityRef {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationSocialExpressionEventTopicDivisionEntityRef);
    }

    /// <summary>
    /// Returns true if QueueConversationSocialExpressionEventTopicDivisionEntityRef instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationSocialExpressionEventTopicDivisionEntityRef to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationSocialExpressionEventTopicDivisionEntityRef other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
