...
/// </summary>
[DataContract]
public partial class ConversationVideoEventTopicErrorBody : IEquatable<ConversationVideoEventTopicErrorBody>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationVideoEventTopicErrorBody" /> class.
    /// </summary>
    ...
    public ConversationVideoEventTopicErrorBody(string Message = null, string Code = null, long? Status = null, string EntityId = null, string EntityName = null, string MessageWithParams = null, Dictionary<string, string> MessageParams = null, string ContextId = null, List<ConversationVideoEventTopicDetail> Details = null, List<ConversationVideoEventTopicErrorBody> Errors = null, ConversationVideoEventTopicLimit Limit = null)
    {
    ...
    public List<ConversationVideoEventTopicDetail> Details { get; set; }
    ...
    public List<ConversationVideoEventTopicErrorBody> Errors { get; set; }
    ...
    public ConversationVideoEventTopicLimit Limit { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationVideoEventTopicErrorBody);
    }

    /// <summary>
    /// Returns true if ConversationVideoEventTopicErrorBody instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationVideoEventTopicErrorBody to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationVideoEventTopicErrorBody other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
