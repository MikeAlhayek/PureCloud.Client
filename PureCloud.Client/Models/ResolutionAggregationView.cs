...
/// </summary>
[DataContract]
public partial class ResolutionAggregationView : IEquatable<ResolutionAggregationView>
{
    /// <summary>
    /// Target metric name
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ResolutionAggregationView" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected ResolutionAggregationView() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="ResolutionAggregationView" /> class.
    /// </summary>
    ...
    public ResolutionAggregationView(TargetEnum? Target = null, string Name = null, FunctionEnum? Function = null, AggregationRange Range = null)
    {
        this.Target = Target;
        this.Name = Name;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ResolutionAggregationView {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ResolutionAggregationView);
    }

    /// <summary>
    /// Returns true if ResolutionAggregationView instances are equal
    /// </summary>
    /// <param name="other">Instance of ResolutionAggregationView to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ResolutionAggregationView other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
