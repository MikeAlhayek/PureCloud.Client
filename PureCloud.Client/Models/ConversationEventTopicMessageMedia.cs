...
/// </summary>
[DataContract]
public partial class ConversationEventTopicMessageMedia : IEquatable<ConversationEventTopicMessageMedia>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationEventTopicMessageMedia" /> class.
    /// </summary>
    ...
    public ConversationEventTopicMessageMedia(string Url = null, string MediaType = null, long? ContentLengthBytes = null, string Name = null, string Id = null)
    {
        this.Url = Url;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationEventTopicMessageMedia);
    }

    /// <summary>
    /// Returns true if ConversationEventTopicMessageMedia instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationEventTopicMessageMedia to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationEventTopicMessageMedia other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
