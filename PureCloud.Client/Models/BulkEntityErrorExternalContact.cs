...
public partial class BulkEntityErrorExternalContact : IEquatable<BulkEntityErrorExternalContact>
{
    ...
    public BulkEntityErrorExternalContact(string Code = null, string Message = null, int? Status = null, bool? Retryable = null, List<BulkErrorDetail> Details = null, ExternalContact Entity = null)
    {
        this.Code = Code;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as BulkEntityErrorExternalContact);
    }

    /// <summary>
    /// Returns true if BulkEntityErrorExternalContact instances are equal
    /// </summary>
    /// <param name="other">Instance of BulkEntityErrorExternalContact to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(BulkEntityErrorExternalContact other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
