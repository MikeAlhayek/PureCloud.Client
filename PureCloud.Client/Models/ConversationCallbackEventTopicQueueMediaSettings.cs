...
/// </summary>
[DataContract]
public partial class ConversationCallbackEventTopicQueueMediaSettings : IEquatable<ConversationCallbackEventTopicQueueMediaSettings>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationCallbackEventTopicQueueMediaSettings" /> class.
    /// </summary>
    ...
    public ConversationCallbackEventTopicQueueMediaSettings(long? AlertingTimeoutSeconds = null, double? AutoAnswerAlertToneSeconds = null, double? ManualAnswerAlertToneSeconds = null, bool? EnableAutoAnswer = null)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ConversationCallbackEventTopicQueueMediaSettings {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationCallbackEventTopicQueueMediaSettings);
    }

    /// <summary>
    /// Returns true if ConversationCallbackEventTopicQueueMediaSettings instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationCallbackEventTopicQueueMediaSettings to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationCallbackEventTopicQueueMediaSettings other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
