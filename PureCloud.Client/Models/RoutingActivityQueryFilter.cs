...
/// </summary>
[DataContract]
public partial class RoutingActivityQueryFilter : IEquatable<RoutingActivityQueryFilter>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="RoutingActivityQueryFilter" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected RoutingActivityQueryFilter() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="RoutingActivityQueryFilter" /> class.
    /// </summary>
    ...
    public RoutingActivityQueryFilter(TypeEnum? Type = null, List<RoutingActivityQueryClause> Clauses = null, List<RoutingActivityQueryPredicate> Predicates = null)
    {
        this.Type = Type;
    ...
    public List<RoutingActivityQueryClause> Clauses { get; set; }
    ...
    public List<RoutingActivityQueryPredicate> Predicates { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class RoutingActivityQueryFilter {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as RoutingActivityQueryFilter);
    }

    /// <summary>
    /// Returns true if RoutingActivityQueryFilter instances are equal
    /// </summary>
    /// <param name="other">Instance of RoutingActivityQueryFilter to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(RoutingActivityQueryFilter other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
