...
public partial class QueueConversationEventTopicMessageMedia : IEquatable<QueueConversationEventTopicMessageMedia>
{
    ...
    public QueueConversationEventTopicMessageMedia(string Url = null, string MediaType = null, long? ContentLengthBytes = null, string Name = null, string Id = null)
    {
        this.Url = Url;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationEventTopicMessageMedia);
    }

    /// <summary>
    /// Returns true if QueueConversationEventTopicMessageMedia instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationEventTopicMessageMedia to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationEventTopicMessageMedia other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
