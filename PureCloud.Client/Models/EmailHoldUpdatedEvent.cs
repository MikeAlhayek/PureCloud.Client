...
/// </summary>
[DataContract]
public partial class EmailHoldUpdatedEvent : IEquatable<EmailHoldUpdatedEvent>
{

    /// <summary>
    /// Initializes a new instance of the <see cref="EmailHoldUpdatedEvent" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected EmailHoldUpdatedEvent() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="EmailHoldUpdatedEvent" /> class.
    /// </summary>
    ...
    public EmailHoldUpdatedEvent(string EventId = null, DateTime? EventDateTime = null, string ConversationId = null, string CommunicationId = null, bool? Held = null)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class EmailHoldUpdatedEvent {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as EmailHoldUpdatedEvent);
    }

    /// <summary>
    /// Returns true if EmailHoldUpdatedEvent instances are equal
    /// </summary>
    /// <param name="other">Instance of EmailHoldUpdatedEvent to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(EmailHoldUpdatedEvent other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
