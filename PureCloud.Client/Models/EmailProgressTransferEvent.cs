...
/// </summary>
[DataContract]
public partial class EmailProgressTransferEvent : IEquatable<EmailProgressTransferEvent>
{

    /// <summary>
    /// Initializes a new instance of the <see cref="EmailProgressTransferEvent" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected EmailProgressTransferEvent() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="EmailProgressTransferEvent" /> class.
    /// </summary>
    ...
    public EmailProgressTransferEvent(string EventId = null, DateTime? EventDateTime = null, string ConversationId = null, string CommandId = null, string ObjectCommunicationId = null, string DestinationCommunicationId = null)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as EmailProgressTransferEvent);
    }

    /// <summary>
    /// Returns true if EmailProgressTransferEvent instances are equal
    /// </summary>
    /// <param name="other">Instance of EmailProgressTransferEvent to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(EmailProgressTransferEvent other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
