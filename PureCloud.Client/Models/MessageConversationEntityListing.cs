...
public partial class MessageConversationEntityListing : IEquatable<MessageConversationEntityListing>, IPagedResource<MessageConversation>
{
    ...
    public MessageConversationEntityListing(List<MessageConversation> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class MessageConversationEntityListing {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as MessageConversationEntityListing);
    }

    /// <summary>
    /// Returns true if MessageConversationEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of MessageConversationEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(MessageConversationEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
