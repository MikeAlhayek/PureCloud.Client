...
/// </summary>
[DataContract]
public partial class ContactListing : IEquatable<ContactListing>, IPagedResource<ExternalContact>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ContactListing" /> class.
    /// </summary>
    ...
    public ContactListing(List<ExternalContact> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, bool? PartialResults = null, string FirstUri = null, string SelfUri = null, string NextUri = null, string LastUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ContactListing {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ContactListing);
    }

    /// <summary>
    /// Returns true if ContactListing instances are equal
    /// </summary>
    /// <param name="other">Instance of ContactListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ContactListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
