...
public partial class OutboundRouteBase : IEquatable<OutboundRouteBase>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="OutboundRouteBase" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected OutboundRouteBase() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="OutboundRouteBase" /> class.
    /// </summary>
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as OutboundRouteBase);
    }

    /// <summary>
    /// Returns true if OutboundRouteBase instances are equal
    /// </summary>
    /// <param name="other">Instance of OutboundRouteBase to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(OutboundRouteBase other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
