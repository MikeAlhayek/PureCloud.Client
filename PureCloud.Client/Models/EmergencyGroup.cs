...
/// </summary>
[DataContract]
public partial class EmergencyGroup : IEquatable<EmergencyGroup>
{
    /// <summary>
    ...
    public EmergencyGroup(string Name = null, WritableDivision Division = null, string Description = null, int? Version = null, bool? Enabled = null, List<EmergencyCallFlow> EmergencyCallFlows = null)
    {
        this.Name = Name;
    ...
    [DataMember(Name = "emergencyCallFlows", EmitDefaultValue = false)]
    public List<EmergencyCallFlow> EmergencyCallFlows { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("  EmergencyCallFlows: ").Append(EmergencyCallFlows).Append("\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as EmergencyGroup);
    }

    /// <summary>
    /// Returns true if EmergencyGroup instances are equal
    /// </summary>
    /// <param name="other">Instance of EmergencyGroup to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(EmergencyGroup other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
        ...
        return true &&
            ...
            (
                this.EmergencyCallFlows == other.EmergencyCallFlows ||
                this.EmergencyCallFlows != null &&
                this.EmergencyCallFlows.SequenceEqual(other.EmergencyCallFlows)
            ) &&
            (
    ...
    public override int GetHashCode()
    {
        ...
        unchecked // Overflow is fine, just wrap
        {
            ...
            if (this.EmergencyCallFlows != null)
            {
                hash = hash * 59 + this.EmergencyCallFlows.GetHashCode();
            }
