...
public partial class EmergencyGroup : IEquatable<EmergencyGroup>
{
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as EmergencyGroup);
    }
    ...
    public bool Equals(EmergencyGroup other)
    {
        ...
        return true &&
            ...
            (
                EmergencyCallFlows == other.EmergencyCallFlows ||
                EmergencyCallFlows != null &&
                EmergencyCallFlows.SequenceEqual(other.EmergencyCallFlows)
            ) &&
            (
    ...
    public override int GetHashCode()
    {
        ...
        unchecked // Overflow is fine, just wrap
        {
            ...
            if (EmergencyCallFlows != null)
            {
                hash = hash * 59 + EmergencyCallFlows.GetHashCode();
            }
