...
/// </summary>
[DataContract]
public partial class PhoneEntityListing : IEquatable<PhoneEntityListing>, IPagedResource<Phone>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="PhoneEntityListing" /> class.
    /// </summary>
    ...
    public PhoneEntityListing(List<Phone> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, long? TotalNumberOfEntities = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public List<Phone> Entities { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class PhoneEntityListing {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as PhoneEntityListing);
    }

    /// <summary>
    /// Returns true if PhoneEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of PhoneEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(PhoneEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
