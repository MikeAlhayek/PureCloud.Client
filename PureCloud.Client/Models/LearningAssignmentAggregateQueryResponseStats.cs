...
public partial class LearningAssignmentAggregateQueryResponseStats : IEquatable<LearningAssignmentAggregateQueryResponseStats>
{
    ...
    public LearningAssignmentAggregateQueryResponseStats(int? Count = null, double? Min = null, double? Max = null, double? Sum = null)
    {
        this.Count = Count;
        this.Min = Min;
        this.Max = Max;
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as LearningAssignmentAggregateQueryResponseStats);
    }
