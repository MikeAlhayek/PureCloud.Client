...
public partial class OrphanRecordingListing : IEquatable<OrphanRecordingListing>, IPagedResource<OrphanRecording>
{
    ...
    public OrphanRecordingListing(List<OrphanRecording> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public List<OrphanRecording> Entities { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class OrphanRecordingListing {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as OrphanRecordingListing);
    }

    /// <summary>
    /// Returns true if OrphanRecordingListing instances are equal
    /// </summary>
    /// <param name="other">Instance of OrphanRecordingListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(OrphanRecordingListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
