...
public partial class JourneyAppEventsNotificationBrowser : IEquatable<JourneyAppEventsNotificationBrowser>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="JourneyAppEventsNotificationBrowser" /> class.
    /// </summary>
    ...
    /// <summary>
    /// Returns true if JourneyAppEventsNotificationBrowser instances are equal
    /// </summary>
    /// <param name="other">Instance of JourneyAppEventsNotificationBrowser to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(JourneyAppEventsNotificationBrowser other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
