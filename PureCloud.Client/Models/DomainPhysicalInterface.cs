...
public partial class DomainPhysicalInterface : IEquatable<DomainPhysicalInterface>
{
    ...
    public DomainPhysicalInterface(string Name = null, Division Division = null, string Description = null, int? Version = null, string EdgeUri = null, string FriendlyName = null, string HardwareAddress = null, string PortLabel = null, DomainPhysicalCapabilities PhysicalCapabilities = null)
    {
        this.Name = Name;
    ...
    /// </summary>
    [JsonPropertyName("physicalCapabilities")]
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as DomainPhysicalInterface);
    }
    ...
    public bool Equals(DomainPhysicalInterface other)
    {
        ...
        return true &&
            ...
            (
                PortLabel == other.PortLabel ||
                PortLabel != null &&
                PortLabel.Equals(other.PortLabel)
            ) &&
            (
                PhysicalCapabilities == other.PhysicalCapabilities ||
                PhysicalCapabilities != null &&
                PhysicalCapabilities.Equals(other.PhysicalCapabilities)
            ) &&
            (
    ...
    public override int GetHashCode()
    {
        ...
        unchecked // Overflow is fine, just wrap
        {
            ...
            if (PortLabel != null)
            {
                hash = hash * 59 + PortLabel.GetHashCode();
            }

            if (PhysicalCapabilities != null)
            {
                hash = hash * 59 + PhysicalCapabilities.GetHashCode();
            }
