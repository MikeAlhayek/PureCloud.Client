...
/// </summary>
[DataContract]
public partial class EdgeEntityListing : IEquatable<EdgeEntityListing>, IPagedResource<Edge>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="EdgeEntityListing" /> class.
    /// </summary>
    ...
    public EdgeEntityListing(List<Edge> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, long? TotalNumberOfEntities = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public List<Edge> Entities { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class EdgeEntityListing {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as EdgeEntityListing);
    }

    /// <summary>
    /// Returns true if EdgeEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of EdgeEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(EdgeEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
