...
public partial class FlowHealthIntentInfo : IEquatable<FlowHealthIntentInfo>
{
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as FlowHealthIntentInfo);
    }
    ...
    public bool Equals(FlowHealthIntentInfo other)
    {
        ...
        return true &&
            ...
            (
                this.LanguageHealth == other.LanguageHealth ||
                this.LanguageHealth != null &&
                this.LanguageHealth.SequenceEqual(other.LanguageHealth)
            ) &&
            (
    ...
    public override int GetHashCode()
    {
        ...
        unchecked // Overflow is fine, just wrap
        {
            ...
            if (this.LanguageHealth != null)
            {
                hash = hash * 59 + this.LanguageHealth.GetHashCode();
            }
