...
public partial class CallbackBasic : IEquatable<CallbackBasic>
{
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as CallbackBasic);
    }

    /// <summary>
    /// Returns true if CallbackBasic instances are equal
    /// </summary>
    /// <param name="other">Instance of CallbackBasic to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(CallbackBasic other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
