...
/// </summary>
[DataContract]
public partial class DocumentVariationResponse : IEquatable<DocumentVariationResponse>
{

    /// <summary>
    /// Initializes a new instance of the <see cref="DocumentVariationResponse" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected DocumentVariationResponse() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="DocumentVariationResponse" /> class.
    /// </summary>
    ...
    public DocumentVariationResponse(AddressableEntityRef DocumentVersion = null, List<DocumentVariationContext> Contexts = null, int? Priority = null, string Name = null, DocumentBodyResponse Body = null)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class DocumentVariationResponse {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as DocumentVariationResponse);
    }

    /// <summary>
    /// Returns true if DocumentVariationResponse instances are equal
    /// </summary>
    /// <param name="other">Instance of DocumentVariationResponse to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(DocumentVariationResponse other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
