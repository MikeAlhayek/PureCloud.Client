...
/// </summary>
[DataContract]
public partial class QueueConversationMessageEventTopicConversationRoutingData : IEquatable<QueueConversationMessageEventTopicConversationRoutingData>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="QueueConversationMessageEventTopicConversationRoutingData" /> class.
    /// </summary>
    ...
    public List<QueueConversationMessageEventTopicUriReference> Skills { get; set; }
    ...
    public List<QueueConversationMessageEventTopicScoredAgent> ScoredAgents { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationMessageEventTopicConversationRoutingData);
    }

    /// <summary>
    /// Returns true if QueueConversationMessageEventTopicConversationRoutingData instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationMessageEventTopicConversationRoutingData to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationMessageEventTopicConversationRoutingData other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
