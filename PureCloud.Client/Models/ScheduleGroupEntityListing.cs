...
/// </summary>
[DataContract]
public partial class ScheduleGroupEntityListing : IEquatable<ScheduleGroupEntityListing>, IPagedResource<ScheduleGroup>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ScheduleGroupEntityListing" /> class.
    /// </summary>
    ...
    public ScheduleGroupEntityListing(List<ScheduleGroup> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, long? TotalNumberOfEntities = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public List<ScheduleGroup> Entities { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as ScheduleGroupEntityListing);
    }

    /// <summary>
    /// Returns true if ScheduleGroupEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of ScheduleGroupEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ScheduleGroupEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
