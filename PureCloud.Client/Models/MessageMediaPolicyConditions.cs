...
public partial class MessageMediaPolicyConditions : IEquatable<MessageMediaPolicyConditions>
{
    ...
    public MessageMediaPolicyConditions(List<User> ForUsers = null, List<string> DateRanges = null, List<Queue> ForQueues = null, List<WrapupCode> WrapupCodes = null, List<Language> Languages = null, TimeAllowed TimeAllowed = null, List<Team> Teams = null, CustomerParticipationEnum? CustomerParticipation = null)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as MessageMediaPolicyConditions);
    }

    /// <summary>
    /// Returns true if MessageMediaPolicyConditions instances are equal
    /// </summary>
    /// <param name="other">Instance of MessageMediaPolicyConditions to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(MessageMediaPolicyConditions other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
