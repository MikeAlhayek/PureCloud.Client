...
/// </summary>
[DataContract]
public partial class ConversationCallbackEventTopicScoredAgent : IEquatable<ConversationCallbackEventTopicScoredAgent>
{
    /// <summary>
    ...
    public ConversationCallbackEventTopicScoredAgent(ConversationCallbackEventTopicUriReference Agent = null, long? Score = null)
    {
        this.Agent = Agent;
        this.Score = Score;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationCallbackEventTopicScoredAgent);
    }

    /// <summary>
    /// Returns true if ConversationCallbackEventTopicScoredAgent instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationCallbackEventTopicScoredAgent to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationCallbackEventTopicScoredAgent other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
