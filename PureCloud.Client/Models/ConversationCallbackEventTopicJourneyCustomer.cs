...
/// </summary>
[DataContract]
public partial class ConversationCallbackEventTopicJourneyCustomer : IEquatable<ConversationCallbackEventTopicJourneyCustomer>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationCallbackEventTopicJourneyCustomer" /> class.
    /// </summary>
    ...
    public ConversationCallbackEventTopicJourneyCustomer(string Id = null, string IdType = null)
    {
        this.Id = Id;
        this.IdType = IdType;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationCallbackEventTopicJourneyCustomer);
    }

    /// <summary>
    /// Returns true if ConversationCallbackEventTopicJourneyCustomer instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationCallbackEventTopicJourneyCustomer to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationCallbackEventTopicJourneyCustomer other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
