...
public partial class ArchitectFlowNotificationFlowVersion : IEquatable<ArchitectFlowNotificationFlowVersion>
{
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ArchitectFlowNotificationFlowVersion);
    }

    /// <summary>
    /// Returns true if ArchitectFlowNotificationFlowVersion instances are equal
    /// </summary>
    /// <param name="other">Instance of ArchitectFlowNotificationFlowVersion to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ArchitectFlowNotificationFlowVersion other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
