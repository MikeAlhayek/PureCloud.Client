...
/// </summary>
[DataContract]
public partial class ConversationEmailEventTopicJourneyContext : IEquatable<ConversationEmailEventTopicJourneyContext>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationEmailEventTopicJourneyContext" /> class.
    /// </summary>
    /// <param name="Customer">Customer.</param>
    /// <param name="CustomerSession">CustomerSession.</param>
    /// <param name="TriggeringAction">TriggeringAction.</param>
    public ConversationEmailEventTopicJourneyContext(ConversationEmailEventTopicJourneyCustomer Customer = null, ConversationEmailEventTopicJourneyCustomerSession CustomerSession = null, ConversationEmailEventTopicJourneyAction TriggeringAction = null)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationEmailEventTopicJourneyContext);
    }

    /// <summary>
    /// Returns true if ConversationEmailEventTopicJourneyContext instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationEmailEventTopicJourneyContext to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationEmailEventTopicJourneyContext other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
