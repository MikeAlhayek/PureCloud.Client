...
/// </summary>
[DataContract]
public partial class V2ConversationMessageTypingEventForWorkflowTopicConversationMessagingToRecipient : IEquatable<V2ConversationMessageTypingEventForWorkflowTopicConversationMessagingToRecipient>
{
    /// <summary>
    /// Gets or Sets IdType
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="V2ConversationMessageTypingEventForWorkflowTopicConversationMessagingToRecipient" /> class.
    /// </summary>
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as V2ConversationMessageTypingEventForWorkflowTopicConversationMessagingToRecipient);
    }

    /// <summary>
    /// Returns true if V2ConversationMessageTypingEventForWorkflowTopicConversationMessagingToRecipient instances are equal
    /// </summary>
    /// <param name="other">Instance of V2ConversationMessageTypingEventForWorkflowTopicConversationMessagingToRecipient to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(V2ConversationMessageTypingEventForWorkflowTopicConversationMessagingToRecipient other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
