...
/// </summary>
[DataContract]
public partial class ConversationCobrowseEventTopicLimit : IEquatable<ConversationCobrowseEventTopicLimit>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationCobrowseEventTopicLimit" /> class.
    /// </summary>
    /// <param name="Key">Key.</param>
    /// <param name="Namespace">Namespace.</param>
    /// <param name="Value">Value.</param>
    /// <param name="Documented">Documented.</param>
    public ConversationCobrowseEventTopicLimit(string Key = null, NamespaceEnum? Namespace = null, long? Value = null, bool? Documented = null)
    {
        this.Key = Key;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ConversationCobrowseEventTopicLimit {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationCobrowseEventTopicLimit);
    }

    /// <summary>
    /// Returns true if ConversationCobrowseEventTopicLimit instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationCobrowseEventTopicLimit to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationCobrowseEventTopicLimit other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
