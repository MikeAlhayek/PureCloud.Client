...
/// </summary>
[DataContract]
public partial class CobrowseConversation : IEquatable<CobrowseConversation>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CobrowseConversation" /> class.
    /// </summary>
    ...
    public CobrowseConversation(string Name = null, List<CobrowseMediaParticipant> Participants = null, List<string> OtherMediaUris = null, List<TransferResponse> RecentTransfers = null, string UtilizationLabelId = null, List<ConversationDivisionMembership> Divisions = null)
    {
        this.Name = Name;
    ...
    public List<CobrowseMediaParticipant> Participants { get; set; }
    ...
    /// <summary>
    /// Returns true if CobrowseConversation instances are equal
    /// </summary>
    /// <param name="other">Instance of CobrowseConversation to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(CobrowseConversation other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
