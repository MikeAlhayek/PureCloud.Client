...
/// </summary>
[DataContract]
public partial class ConversationMessageEventTopicJourneyCustomer : IEquatable<ConversationMessageEventTopicJourneyCustomer>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationMessageEventTopicJourneyCustomer" /> class.
    /// </summary>
    ...
    public ConversationMessageEventTopicJourneyCustomer(string Id = null, string IdType = null)
    {
        this.Id = Id;
        this.IdType = IdType;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationMessageEventTopicJourneyCustomer);
    }

    /// <summary>
    /// Returns true if ConversationMessageEventTopicJourneyCustomer instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationMessageEventTopicJourneyCustomer to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationMessageEventTopicJourneyCustomer other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
