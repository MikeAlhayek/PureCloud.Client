...
/// </summary>
[DataContract]
public partial class ConversationEventTopicScoredAgent : IEquatable<ConversationEventTopicScoredAgent>
{
    /// <summary>
    ...
    public ConversationEventTopicScoredAgent(ConversationEventTopicUriReference Agent = null, long? Score = null)
    {
        this.Agent = Agent;
        this.Score = Score;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationEventTopicScoredAgent);
    }

    /// <summary>
    /// Returns true if ConversationEventTopicScoredAgent instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationEventTopicScoredAgent to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationEventTopicScoredAgent other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
