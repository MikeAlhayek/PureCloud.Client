...
/// </summary>
[DataContract]
public partial class ConversationCobrowseEventTopicJourneyCustomer : IEquatable<ConversationCobrowseEventTopicJourneyCustomer>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationCobrowseEventTopicJourneyCustomer" /> class.
    /// </summary>
    ...
    public ConversationCobrowseEventTopicJourneyCustomer(string Id = null, string IdType = null)
    {
        this.Id = Id;
        this.IdType = IdType;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationCobrowseEventTopicJourneyCustomer);
    }

    /// <summary>
    /// Returns true if ConversationCobrowseEventTopicJourneyCustomer instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationCobrowseEventTopicJourneyCustomer to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationCobrowseEventTopicJourneyCustomer other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
