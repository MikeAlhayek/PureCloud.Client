...
/// </summary>
[DataContract]
public partial class EmailMediaSettings : IEquatable<EmailMediaSettings>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="EmailMediaSettings" /> class.
    /// </summary>
    ...
    public EmailMediaSettings(bool? EnableAutoAnswer = null, int? AlertingTimeoutSeconds = null, ServiceLevel ServiceLevel = null, double? AutoAnswerAlertToneSeconds = null, double? ManualAnswerAlertToneSeconds = null, Dictionary<string, BaseMediaSettings> SubTypeSettings = null)
    {
    ...
    /// <summary>
    /// Returns true if EmailMediaSettings instances are equal
    /// </summary>
    /// <param name="other">Instance of EmailMediaSettings to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(EmailMediaSettings other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
