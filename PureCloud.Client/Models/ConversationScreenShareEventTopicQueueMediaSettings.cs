...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationScreenShareEventTopicQueueMediaSettings" /> class.
    /// </summary>
    ...
    public ConversationScreenShareEventTopicQueueMediaSettings(long? AlertingTimeoutSeconds = null, double? AutoAnswerAlertToneSeconds = null, double? ManualAnswerAlertToneSeconds = null, bool? EnableAutoAnswer = null)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ConversationScreenShareEventTopicQueueMediaSettings {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationScreenShareEventTopicQueueMediaSettings);
    }

    /// <summary>
    /// Returns true if ConversationScreenShareEventTopicQueueMediaSettings instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationScreenShareEventTopicQueueMediaSettings to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationScreenShareEventTopicQueueMediaSettings other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
