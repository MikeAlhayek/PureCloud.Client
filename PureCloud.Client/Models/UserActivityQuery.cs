...
/// </summary>
[DataContract]
public partial class UserActivityQuery : IEquatable<UserActivityQuery>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="UserActivityQuery" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected UserActivityQuery() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="UserActivityQuery" /> class.
    /// </summary>
    ...
    public UserActivityQuery(List<UserActivityQueryMetric> Metrics = null, List<GroupByEnum> GroupBy = null, UserActivityQueryFilter Filter = null, OrderEnum? Order = null)
    {
    ...
    public List<UserActivityQueryMetric> Metrics { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class UserActivityQuery {\n");
    ...
    /// <summary>
    /// Returns true if UserActivityQuery instances are equal
    /// </summary>
    /// <param name="other">Instance of UserActivityQuery to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(UserActivityQuery other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
