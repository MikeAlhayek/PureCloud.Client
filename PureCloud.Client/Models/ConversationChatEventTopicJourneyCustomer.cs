...
/// </summary>
[DataContract]
public partial class ConversationChatEventTopicJourneyCustomer : IEquatable<ConversationChatEventTopicJourneyCustomer>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationChatEventTopicJourneyCustomer" /> class.
    /// </summary>
    ...
    public ConversationChatEventTopicJourneyCustomer(string Id = null, string IdType = null)
    {
        this.Id = Id;
        this.IdType = IdType;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ConversationChatEventTopicJourneyCustomer {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationChatEventTopicJourneyCustomer);
    }

    /// <summary>
    /// Returns true if ConversationChatEventTopicJourneyCustomer instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationChatEventTopicJourneyCustomer to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationChatEventTopicJourneyCustomer other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
