...
/// </summary>
[DataContract]
public partial class QueueConversationEmailEventTopicQueueMediaSettings : IEquatable<QueueConversationEmailEventTopicQueueMediaSettings>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="QueueConversationEmailEventTopicQueueMediaSettings" /> class.
    /// </summary>
    ...
    public QueueConversationEmailEventTopicQueueMediaSettings(long? AlertingTimeoutSeconds = null, double? AutoAnswerAlertToneSeconds = null, double? ManualAnswerAlertToneSeconds = null, bool? EnableAutoAnswer = null)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class QueueConversationEmailEventTopicQueueMediaSettings {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationEmailEventTopicQueueMediaSettings);
    }

    /// <summary>
    /// Returns true if QueueConversationEmailEventTopicQueueMediaSettings instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationEmailEventTopicQueueMediaSettings to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationEmailEventTopicQueueMediaSettings other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
