...
/// </summary>
[DataContract]
public partial class BulkResponseResultNoteEntityBulkEntityErrorEntity : IEquatable<BulkResponseResultNoteEntityBulkEntityErrorEntity>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="BulkResponseResultNoteEntityBulkEntityErrorEntity" /> class.
    /// </summary>
    ...
    public BulkResponseResultNoteEntityBulkEntityErrorEntity(string Id = null, bool? Success = null, Note Entity = null, BulkEntityErrorEntity Error = null)
    {
        this.Id = Id;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class BulkResponseResultNoteEntityBulkEntityErrorEntity {\n");
    ...
    /// <summary>
    /// Returns true if BulkResponseResultNoteEntityBulkEntityErrorEntity instances are equal
    /// </summary>
    /// <param name="other">Instance of BulkResponseResultNoteEntityBulkEntityErrorEntity to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(BulkResponseResultNoteEntityBulkEntityErrorEntity other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
