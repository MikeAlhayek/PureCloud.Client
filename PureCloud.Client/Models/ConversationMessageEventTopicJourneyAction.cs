...
public partial class ConversationMessageEventTopicJourneyAction : IEquatable<ConversationMessageEventTopicJourneyAction>
{
    ...
    public ConversationMessageEventTopicJourneyActionMap ActionMap { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ConversationMessageEventTopicJourneyAction {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationMessageEventTopicJourneyAction);
    }

    /// <summary>
    /// Returns true if ConversationMessageEventTopicJourneyAction instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationMessageEventTopicJourneyAction to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationMessageEventTopicJourneyAction other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
