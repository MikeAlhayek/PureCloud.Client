...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationVideoEventTopicJourneyAction" /> class.
    /// </summary>
    ...
    public ConversationVideoEventTopicJourneyAction(string Id = null, ConversationVideoEventTopicJourneyActionMap ActionMap = null)
    {
        this.Id = Id;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationVideoEventTopicJourneyAction);
    }

    /// <summary>
    /// Returns true if ConversationVideoEventTopicJourneyAction instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationVideoEventTopicJourneyAction to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationVideoEventTopicJourneyAction other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
