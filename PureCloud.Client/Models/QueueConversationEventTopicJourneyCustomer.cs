...
/// </summary>
[DataContract]
public partial class QueueConversationEventTopicJourneyCustomer : IEquatable<QueueConversationEventTopicJourneyCustomer>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="QueueConversationEventTopicJourneyCustomer" /> class.
    /// </summary>
    ...
    public QueueConversationEventTopicJourneyCustomer(string Id = null, string IdType = null)
    {
        this.Id = Id;
        this.IdType = IdType;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class QueueConversationEventTopicJourneyCustomer {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationEventTopicJourneyCustomer);
    }

    /// <summary>
    /// Returns true if QueueConversationEventTopicJourneyCustomer instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationEventTopicJourneyCustomer to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationEventTopicJourneyCustomer other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
