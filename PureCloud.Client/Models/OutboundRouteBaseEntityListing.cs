...
/// </summary>
[DataContract]
public partial class OutboundRouteBaseEntityListing : IEquatable<OutboundRouteBaseEntityListing>, IPagedResource<OutboundRouteBase>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="OutboundRouteBaseEntityListing" /> class.
    /// </summary>
    ...
    public OutboundRouteBaseEntityListing(List<OutboundRouteBase> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, long? TotalNumberOfEntities = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public List<OutboundRouteBase> Entities { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class OutboundRouteBaseEntityListing {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as OutboundRouteBaseEntityListing);
    }

    /// <summary>
    /// Returns true if OutboundRouteBaseEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of OutboundRouteBaseEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(OutboundRouteBaseEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
