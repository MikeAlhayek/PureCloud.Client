...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CursorContactListing" /> class.
    /// </summary>
    ...
    public CursorContactListing(List<ExternalContact> Entities = null, string NextUri = null, string SelfUri = null, string PreviousUri = null, Cursors Cursors = null)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as CursorContactListing);
    }

    /// <summary>
    /// Returns true if CursorContactListing instances are equal
    /// </summary>
    /// <param name="other">Instance of CursorContactListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(CursorContactListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
