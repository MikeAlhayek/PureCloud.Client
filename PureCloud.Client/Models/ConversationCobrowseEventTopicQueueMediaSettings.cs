...
/// </summary>
[DataContract]
public partial class ConversationCobrowseEventTopicQueueMediaSettings : IEquatable<ConversationCobrowseEventTopicQueueMediaSettings>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationCobrowseEventTopicQueueMediaSettings" /> class.
    /// </summary>
    ...
    public ConversationCobrowseEventTopicQueueMediaSettings(long? AlertingTimeoutSeconds = null, double? AutoAnswerAlertToneSeconds = null, double? ManualAnswerAlertToneSeconds = null, bool? EnableAutoAnswer = null)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationCobrowseEventTopicQueueMediaSettings);
    }

    /// <summary>
    /// Returns true if ConversationCobrowseEventTopicQueueMediaSettings instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationCobrowseEventTopicQueueMediaSettings to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationCobrowseEventTopicQueueMediaSettings other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
