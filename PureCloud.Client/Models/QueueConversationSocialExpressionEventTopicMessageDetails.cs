...
/// </summary>
[DataContract]
public partial class QueueConversationSocialExpressionEventTopicMessageDetails : IEquatable<QueueConversationSocialExpressionEventTopicMessageDetails>
{
    /// <summary>
    ...
    public List<QueueConversationSocialExpressionEventTopicMessageMedia> Media { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationSocialExpressionEventTopicMessageDetails);
    }

    /// <summary>
    /// Returns true if QueueConversationSocialExpressionEventTopicMessageDetails instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationSocialExpressionEventTopicMessageDetails to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationSocialExpressionEventTopicMessageDetails other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
