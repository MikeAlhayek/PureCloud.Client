...
/// <summary>
/// ConversationMessageEventTopicLimit
/// </summary>
[DataContract]
public partial class ConversationMessageEventTopicLimit : IEquatable<ConversationMessageEventTopicLimit>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationMessageEventTopicLimit" /> class.
    /// </summary>
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ConversationMessageEventTopicLimit {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationMessageEventTopicLimit);
    }

    /// <summary>
    /// Returns true if ConversationMessageEventTopicLimit instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationMessageEventTopicLimit to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationMessageEventTopicLimit other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
