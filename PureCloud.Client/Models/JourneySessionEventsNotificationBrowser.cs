...
/// </summary>
[DataContract]
public partial class JourneySessionEventsNotificationBrowser : IEquatable<JourneySessionEventsNotificationBrowser>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="JourneySessionEventsNotificationBrowser" /> class.
    /// </summary>
    ...
    public JourneySessionEventsNotificationBrowser(string Family = null, string Version = null, string Lang = null, string Fingerprint = null, long? ViewHeight = null, long? ViewWidth = null, bool? FeaturesFlash = null, bool? FeaturesJava = null, bool? FeaturesPdf = null, bool? FeaturesWebrtc = null)
    {
        this.Family = Family;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class JourneySessionEventsNotificationBrowser {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as JourneySessionEventsNotificationBrowser);
    }

    /// <summary>
    /// Returns true if JourneySessionEventsNotificationBrowser instances are equal
    /// </summary>
    /// <param name="other">Instance of JourneySessionEventsNotificationBrowser to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(JourneySessionEventsNotificationBrowser other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
