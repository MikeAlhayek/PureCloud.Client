...
public partial class WorkitemsQueueEventsNotificationSession : IEquatable<WorkitemsQueueEventsNotificationSession>
{
    ...
    public WorkitemsQueueEventsNotificationSession(TypeEnum? Type = null, Guid? Id = null, StatusEnum? Status = null, string DateSessionStart = null, string DateSessionEnd = null, List<WorkitemsQueueEventsNotificationAssignmentSegment> AssignmentSegments = null)
    {
        this.Type = Type;
        this.Id = Id;
        this.Status = Status;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class WorkitemsQueueEventsNotificationSession {\n");
    ...
    /// <summary>
    /// Returns true if WorkitemsQueueEventsNotificationSession instances are equal
    /// </summary>
    /// <param name="other">Instance of WorkitemsQueueEventsNotificationSession to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(WorkitemsQueueEventsNotificationSession other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
