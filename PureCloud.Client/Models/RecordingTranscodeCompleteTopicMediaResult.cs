...
/// </summary>
[DataContract]
public partial class RecordingTranscodeCompleteTopicMediaResult : IEquatable<RecordingTranscodeCompleteTopicMediaResult>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="RecordingTranscodeCompleteTopicMediaResult" /> class.
    /// </summary>
    /// <param name="ChannelId">ChannelId.</param>
    /// <param name="WaveUri">WaveUri.</param>
    /// <param name="MediaUri">MediaUri.</param>
    /// <param name="WaveformData">WaveformData.</param>
    public RecordingTranscodeCompleteTopicMediaResult(string ChannelId = null, string WaveUri = null, string MediaUri = null, List<double?> WaveformData = null)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as RecordingTranscodeCompleteTopicMediaResult);
    }

    /// <summary>
    /// Returns true if RecordingTranscodeCompleteTopicMediaResult instances are equal
    /// </summary>
    /// <param name="other">Instance of RecordingTranscodeCompleteTopicMediaResult to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(RecordingTranscodeCompleteTopicMediaResult other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
