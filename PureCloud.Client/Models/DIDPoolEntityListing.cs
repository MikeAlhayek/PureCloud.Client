...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="DIDPoolEntityListing" /> class.
    /// </summary>
    ...
    public DIDPoolEntityListing(List<DIDPool> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, long? TotalNumberOfEntities = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class DIDPoolEntityListing {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as DIDPoolEntityListing);
    }

    /// <summary>
    /// Returns true if DIDPoolEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of DIDPoolEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(DIDPoolEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
