...
public partial class GeneralProgramJob : IEquatable<GeneralProgramJob>
{
    ...
    public GeneralProgramJob(StateEnum? State = null, AddressableEntityRef CreatedBy = null, DateTime? DateCreated = null, DateTime? DateModified = null)
    {
        this.State = State;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as GeneralProgramJob);
    }

    /// <summary>
    /// Returns true if GeneralProgramJob instances are equal
    /// </summary>
    /// <param name="other">Instance of GeneralProgramJob to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(GeneralProgramJob other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
