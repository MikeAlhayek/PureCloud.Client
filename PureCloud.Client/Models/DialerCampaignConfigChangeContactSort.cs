...
public partial class DialerCampaignConfigChangeContactSort : IEquatable<DialerCampaignConfigChangeContactSort>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DialerCampaignConfigChangeContactSort" /> class.
    /// </summary>
    /// <param name="FieldName">FieldName.</param>
    /// <param name="Direction">Direction.</param>
    /// <param name="Numeric">Whether that column contains numeric data.</param>
    /// <param name="AdditionalProperties">AdditionalProperties.</param>
    public DialerCampaignConfigChangeContactSort(string FieldName = null, DirectionEnum? Direction = null, bool? Numeric = null, Dictionary<string, object> AdditionalProperties = null)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as DialerCampaignConfigChangeContactSort);
    }

    /// <summary>
    /// Returns true if DialerCampaignConfigChangeContactSort instances are equal
    /// </summary>
    /// <param name="other">Instance of DialerCampaignConfigChangeContactSort to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(DialerCampaignConfigChangeContactSort other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
