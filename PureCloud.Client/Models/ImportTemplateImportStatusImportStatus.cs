...
/// <summary>
/// ImportTemplateImportStatusImportStatus
/// </summary>
[DataContract]
public partial class ImportTemplateImportStatusImportStatus : IEquatable<ImportTemplateImportStatusImportStatus>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ImportTemplateImportStatusImportStatus" /> class.
    /// </summary>
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ImportTemplateImportStatusImportStatus {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ImportTemplateImportStatusImportStatus);
    }

    /// <summary>
    /// Returns true if ImportTemplateImportStatusImportStatus instances are equal
    /// </summary>
    /// <param name="other">Instance of ImportTemplateImportStatusImportStatus to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ImportTemplateImportStatusImportStatus other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
