...
/// </summary>
[DataContract]
public partial class PhoneMetaBaseEntityListing : IEquatable<PhoneMetaBaseEntityListing>, IPagedResource<Metabase>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="PhoneMetaBaseEntityListing" /> class.
    /// </summary>
    ...
    public PhoneMetaBaseEntityListing(List<Metabase> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, long? TotalNumberOfEntities = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as PhoneMetaBaseEntityListing);
    }

    /// <summary>
    /// Returns true if PhoneMetaBaseEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of PhoneMetaBaseEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(PhoneMetaBaseEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
