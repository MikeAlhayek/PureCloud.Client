...
public partial class CustomerStartDetailEventTopicCustomerStartEvent : IEquatable<CustomerStartDetailEventTopicCustomerStartEvent>
{
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as CustomerStartDetailEventTopicCustomerStartEvent);
    }

    /// <summary>
    /// Returns true if CustomerStartDetailEventTopicCustomerStartEvent instances are equal
    /// </summary>
    /// <param name="other">Instance of CustomerStartDetailEventTopicCustomerStartEvent to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(CustomerStartDetailEventTopicCustomerStartEvent other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
