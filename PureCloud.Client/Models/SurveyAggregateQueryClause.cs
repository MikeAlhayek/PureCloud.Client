...
/// </summary>
[DataContract]
public partial class SurveyAggregateQueryClause : IEquatable<SurveyAggregateQueryClause>
{
    /// <summary>
    ...
    protected SurveyAggregateQueryClause() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="SurveyAggregateQueryClause" /> class.
    /// </summary>
    ...
    public override string ToString()
    {
        ...
        sb.Append("class SurveyAggregateQueryClause {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as SurveyAggregateQueryClause);
    }

    /// <summary>
    /// Returns true if SurveyAggregateQueryClause instances are equal
    /// </summary>
    /// <param name="other">Instance of SurveyAggregateQueryClause to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(SurveyAggregateQueryClause other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
