...
public partial class WrapUpCodeReference : IEquatable<WrapUpCodeReference>
{
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as WrapUpCodeReference);
    }

    /// <summary>
    /// Returns true if WrapUpCodeReference instances are equal
    /// </summary>
    /// <param name="other">Instance of WrapUpCodeReference to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(WrapUpCodeReference other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
