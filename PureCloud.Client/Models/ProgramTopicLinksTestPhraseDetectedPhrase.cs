...
/// </summary>
[DataContract]
public partial class ProgramTopicLinksTestPhraseDetectedPhrase : IEquatable<ProgramTopicLinksTestPhraseDetectedPhrase>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ProgramTopicLinksTestPhraseDetectedPhrase" /> class.
    /// </summary>
    /// <param name="FoundPhrase">FoundPhrase.</param>
    /// <param name="Snippet">Snippet.</param>
    /// <param name="Confidence">Confidence.</param>
    public ProgramTopicLinksTestPhraseDetectedPhrase(string FoundPhrase = null, string Snippet = null, long? Confidence = null)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ProgramTopicLinksTestPhraseDetectedPhrase);
    }

    /// <summary>
    /// Returns true if ProgramTopicLinksTestPhraseDetectedPhrase instances are equal
    /// </summary>
    /// <param name="other">Instance of ProgramTopicLinksTestPhraseDetectedPhrase to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ProgramTopicLinksTestPhraseDetectedPhrase other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
