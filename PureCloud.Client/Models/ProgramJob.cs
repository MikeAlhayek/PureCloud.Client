...
public partial class ProgramJob : IEquatable<ProgramJob>
{
    ...
    public ProgramJob(StateEnum? State = null, List<BaseProgramEntity> Programs = null, AddressableEntityRef CreatedBy = null, DateTime? DateCreated = null, DateTime? DateModified = null)
    {
        this.State = State;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ProgramJob);
    }

    /// <summary>
    /// Returns true if ProgramJob instances are equal
    /// </summary>
    /// <param name="other">Instance of ProgramJob to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ProgramJob other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
