...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="JourneyWebActionEventsNotificationBrowser" /> class.
    /// </summary>
    ...
    public JourneyWebActionEventsNotificationBrowser(string Family = null, string Version = null, string Lang = null, string Fingerprint = null, long? ViewHeight = null, long? ViewWidth = null, bool? FeaturesFlash = null, bool? FeaturesJava = null, bool? FeaturesPdf = null, bool? FeaturesWebrtc = null)
    {
        this.Family = Family;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as JourneyWebActionEventsNotificationBrowser);
    }

    /// <summary>
    /// Returns true if JourneyWebActionEventsNotificationBrowser instances are equal
    /// </summary>
    /// <param name="other">Instance of JourneyWebActionEventsNotificationBrowser to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(JourneyWebActionEventsNotificationBrowser other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
