...
/// </summary>
[DataContract]
public partial class ArchitectFlowOutcomeNotificationArchitectOperation : IEquatable<ArchitectFlowOutcomeNotificationArchitectOperation>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ArchitectFlowOutcomeNotificationArchitectOperation" /> class.
    /// </summary>
    ...
    public ArchitectFlowOutcomeNotificationArchitectOperation(string Id = null, bool? Complete = null, ArchitectFlowOutcomeNotificationUser User = null, ArchitectFlowOutcomeNotificationClient Client = null, ActionNameEnum? ActionName = null, ActionStatusEnum? ActionStatus = null, string ErrorMessage = null, string ErrorCode = null, ArchitectFlowOutcomeNotificationErrorMessageParams ErrorMessageParams = null, List<ArchitectFlowOutcomeNotificationErrorDetail> ErrorDetails = null)
    {
        this.Id = Id;
    ...
    public List<ArchitectFlowOutcomeNotificationErrorDetail> ErrorDetails { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ArchitectFlowOutcomeNotificationArchitectOperation);
    }

    /// <summary>
    /// Returns true if ArchitectFlowOutcomeNotificationArchitectOperation instances are equal
    /// </summary>
    /// <param name="other">Instance of ArchitectFlowOutcomeNotificationArchitectOperation to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ArchitectFlowOutcomeNotificationArchitectOperation other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
