...
/// </summary>
[DataContract]
public partial class LineBaseEntityListing : IEquatable<LineBaseEntityListing>, IPagedResource<LineBase>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="LineBaseEntityListing" /> class.
    /// </summary>
    ...
    public LineBaseEntityListing(List<LineBase> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, long? TotalNumberOfEntities = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public List<LineBase> Entities { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class LineBaseEntityListing {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as LineBaseEntityListing);
    }

    /// <summary>
    /// Returns true if LineBaseEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of LineBaseEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(LineBaseEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
