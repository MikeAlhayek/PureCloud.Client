...
/// </summary>
[DataContract]
public partial class ConversationEventTopicScreenshare : IEquatable<ConversationEventTopicScreenshare>
{
    /// <summary>
    /// Gets or Sets State
    /// </summary>
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ConversationEventTopicScreenshare {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationEventTopicScreenshare);
    }

    /// <summary>
    /// Returns true if ConversationEventTopicScreenshare instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationEventTopicScreenshare to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationEventTopicScreenshare other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
