...
public partial class DataTableRowEntityListing : IEquatable<DataTableRowEntityListing>, IPagedResource<Dictionary<string, Object>>
{
    ...
    public override string ToString()
    {
        ...
        sb.Append("class DataTableRowEntityListing {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as DataTableRowEntityListing);
    }

    /// <summary>
    /// Returns true if DataTableRowEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of DataTableRowEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(DataTableRowEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
