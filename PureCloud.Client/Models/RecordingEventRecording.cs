...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="RecordingEventRecording" /> class.
    /// </summary>
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as RecordingEventRecording);
    }

    /// <summary>
    /// Returns true if RecordingEventRecording instances are equal
    /// </summary>
    /// <param name="other">Instance of RecordingEventRecording to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(RecordingEventRecording other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
