...
/// </summary>
[DataContract]
public partial class BulkFetchOrganizationsResponse : IEquatable<BulkFetchOrganizationsResponse>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="BulkFetchOrganizationsResponse" /> class.
    /// </summary>
    ...
    public BulkFetchOrganizationsResponse(List<BulkResponseResultExternalOrganizationEntityBulkEntityErrorEntity> Results = null, int? ErrorCount = null, List<int?> ErrorIndexes = null)
    {
    ...
    public List<BulkResponseResultExternalOrganizationEntityBulkEntityErrorEntity> Results { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as BulkFetchOrganizationsResponse);
    }

    /// <summary>
    /// Returns true if BulkFetchOrganizationsResponse instances are equal
    /// </summary>
    /// <param name="other">Instance of BulkFetchOrganizationsResponse to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(BulkFetchOrganizationsResponse other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
