...
public partial class WebDeployment : IEquatable<WebDeployment>
{
    ...
    public WebDeployment(string Name = null, string Description = null, bool? AllowAllDomains = null, List<string> AllowedDomains = null, SupportedContentReference SupportedContent = null, WebDeploymentFlowEntityRef Flow = null, StatusEnum? Status = null, WebDeploymentConfigurationVersionEntityRef Configuration = null)
    {
        this.Name = Name;
    ...
    /// <summary>
    /// Returns true if WebDeployment instances are equal
    /// </summary>
    /// <param name="other">Instance of WebDeployment to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(WebDeployment other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
