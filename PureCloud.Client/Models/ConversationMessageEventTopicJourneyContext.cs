...
/// </summary>
[DataContract]
public partial class ConversationMessageEventTopicJourneyContext : IEquatable<ConversationMessageEventTopicJourneyContext>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationMessageEventTopicJourneyContext" /> class.
    /// </summary>
    /// <param name="Customer">Customer.</param>
    /// <param name="CustomerSession">CustomerSession.</param>
    /// <param name="TriggeringAction">TriggeringAction.</param>
    public ConversationMessageEventTopicJourneyContext(ConversationMessageEventTopicJourneyCustomer Customer = null, ConversationMessageEventTopicJourneyCustomerSession CustomerSession = null, ConversationMessageEventTopicJourneyAction TriggeringAction = null)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationMessageEventTopicJourneyContext);
    }

    /// <summary>
    /// Returns true if ConversationMessageEventTopicJourneyContext instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationMessageEventTopicJourneyContext to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationMessageEventTopicJourneyContext other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
