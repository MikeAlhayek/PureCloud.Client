...
/// </summary>
[DataContract]
public partial class BenefitAssessmentJob : IEquatable<BenefitAssessmentJob>
{
    /// <summary>
    ...
    public override string ToString()
    {
        ...
        sb.Append("class BenefitAssessmentJob {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as BenefitAssessmentJob);
    }

    /// <summary>
    /// Returns true if BenefitAssessmentJob instances are equal
    /// </summary>
    /// <param name="other">Instance of BenefitAssessmentJob to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(BenefitAssessmentJob other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
