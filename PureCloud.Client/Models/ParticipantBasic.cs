...
public partial class ParticipantBasic : IEquatable<ParticipantBasic>
{
    /// <summary>
    ...
    public List<CallBasic> Calls { get; set; }
    ...
    public List<CallbackBasic> Callbacks { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as ParticipantBasic);
    }

    /// <summary>
    /// Returns true if ParticipantBasic instances are equal
    /// </summary>
    /// <param name="other">Instance of ParticipantBasic to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ParticipantBasic other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
