...
/// </summary>
[DataContract]
public partial class QueueConversationEventTopicJourneyCustomerSession : IEquatable<QueueConversationEventTopicJourneyCustomerSession>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="QueueConversationEventTopicJourneyCustomerSession" /> class.
    /// </summary>
    ...
    public QueueConversationEventTopicJourneyCustomerSession(string Id = null, string Type = null)
    {
        this.Id = Id;
        this.Type = Type;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationEventTopicJourneyCustomerSession);
    }

    /// <summary>
    /// Returns true if QueueConversationEventTopicJourneyCustomerSession instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationEventTopicJourneyCustomerSession to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationEventTopicJourneyCustomerSession other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
