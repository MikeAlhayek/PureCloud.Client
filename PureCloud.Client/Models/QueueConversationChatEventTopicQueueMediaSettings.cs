...
/// <summary>
/// QueueConversationChatEventTopicQueueMediaSettings
/// </summary>

public partial class QueueConversationChatEventTopicQueueMediaSettings : IEquatable<QueueConversationChatEventTopicQueueMediaSettings>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="QueueConversationChatEventTopicQueueMediaSettings" /> class.
    /// </summary>
    ...
    public QueueConversationChatEventTopicQueueMediaSettings(long? AlertingTimeoutSeconds = null, double? AutoAnswerAlertToneSeconds = null, double? ManualAnswerAlertToneSeconds = null, bool? EnableAutoAnswer = null)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class QueueConversationChatEventTopicQueueMediaSettings {\n");
    ...
    /// <summary>
    /// Returns true if QueueConversationChatEventTopicQueueMediaSettings instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationChatEventTopicQueueMediaSettings to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationChatEventTopicQueueMediaSettings other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
