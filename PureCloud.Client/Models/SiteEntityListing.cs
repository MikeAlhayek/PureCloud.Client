...
public partial class SiteEntityListing : IEquatable<SiteEntityListing>, IPagedResource<Site>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SiteEntityListing" /> class.
    /// </summary>
    ...
    public SiteEntityListing(List<Site> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, long? TotalNumberOfEntities = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class SiteEntityListing {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as SiteEntityListing);
    }

    /// <summary>
    /// Returns true if SiteEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of SiteEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(SiteEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
