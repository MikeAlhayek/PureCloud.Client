...
/// </summary>
[DataContract]
public partial class QueueConversationCobrowseEventTopicConversationRoutingData : IEquatable<QueueConversationCobrowseEventTopicConversationRoutingData>
{
    /// <summary>
    ...
    public List<QueueConversationCobrowseEventTopicUriReference> Skills { get; set; }
    ...
    public List<QueueConversationCobrowseEventTopicScoredAgent> ScoredAgents { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationCobrowseEventTopicConversationRoutingData);
    }

    /// <summary>
    /// Returns true if QueueConversationCobrowseEventTopicConversationRoutingData instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationCobrowseEventTopicConversationRoutingData to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationCobrowseEventTopicConversationRoutingData other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
