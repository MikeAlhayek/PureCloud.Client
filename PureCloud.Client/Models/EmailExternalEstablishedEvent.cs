...
/// </summary>
[DataContract]
public partial class EmailExternalEstablishedEvent : IEquatable<EmailExternalEstablishedEvent>
{

    /// <summary>
    /// Initializes a new instance of the <see cref="EmailExternalEstablishedEvent" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected EmailExternalEstablishedEvent() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="EmailExternalEstablishedEvent" /> class.
    /// </summary>
    ...
    /// <param name="IncludeMessage">Indicates that established communication has an initial email. If true, the initial messagesSent value will be initialized to 1..</param>
    ...
    public EmailExternalEstablishedEvent(string EventId = null, DateTime? EventDateTime = null, string ConversationId = null, string CommunicationId = null, string DisplayName = null, bool? IncludeMessage = null, EmailInitialConfiguration InitialConfiguration = null, SourceConfiguration SourceConfiguration = null)
    {
    ...
    /// </summary>
    /// <value>Indicates that established communication has an initial email. If true, the initial messagesSent value will be initialized to 1.</value>
    [DataMember(Name = "includeMessage", EmitDefaultValue = false)]
    ...
    public override string ToString()
    {
        ...
        sb.Append("  IncludeMessage: ").Append(IncludeMessage).Append("\n");
    ...
    /// <summary>
    /// Returns true if EmailExternalEstablishedEvent instances are equal
    /// </summary>
    /// <param name="other">Instance of EmailExternalEstablishedEvent to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(EmailExternalEstablishedEvent other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
