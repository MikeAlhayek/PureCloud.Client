...
public partial class LearningAssignmentStep : IEquatable<LearningAssignmentStep>
{
    ...
    public LearningAssignmentStep(float? CompletionPercentage = null, LearningShareableContentObject ShareableContentObject = null)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as LearningAssignmentStep);
    }

    /// <summary>
    /// Returns true if LearningAssignmentStep instances are equal
    /// </summary>
    /// <param name="other">Instance of LearningAssignmentStep to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(LearningAssignmentStep other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
