...
public partial class EmailRoutingTransferEvent : IEquatable<EmailRoutingTransferEvent>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="EmailRoutingTransferEvent" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected EmailRoutingTransferEvent() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="EmailRoutingTransferEvent" /> class.
    /// </summary>
    ...
    [JsonPropertyName("destinationQueueId")]
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as EmailRoutingTransferEvent);
    }

    /// <summary>
    /// Returns true if EmailRoutingTransferEvent instances are equal
    /// </summary>
    /// <param name="other">Instance of EmailRoutingTransferEvent to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(EmailRoutingTransferEvent other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
