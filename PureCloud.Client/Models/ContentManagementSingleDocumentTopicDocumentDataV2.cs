...
/// </summary>
[DataContract]
public partial class ContentManagementSingleDocumentTopicDocumentDataV2 : IEquatable<ContentManagementSingleDocumentTopicDocumentDataV2>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ContentManagementSingleDocumentTopicDocumentDataV2" /> class.
    /// </summary>
    ...
    /// <summary>
    /// Returns true if ContentManagementSingleDocumentTopicDocumentDataV2 instances are equal
    /// </summary>
    /// <param name="other">Instance of ContentManagementSingleDocumentTopicDocumentDataV2 to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ContentManagementSingleDocumentTopicDocumentDataV2 other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
