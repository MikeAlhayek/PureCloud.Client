...
/// </summary>
[DataContract]
public partial class QueueConversationCobrowseEventTopicJourneyContext : IEquatable<QueueConversationCobrowseEventTopicJourneyContext>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="QueueConversationCobrowseEventTopicJourneyContext" /> class.
    /// </summary>
    /// <param name="Customer">Customer.</param>
    /// <param name="CustomerSession">CustomerSession.</param>
    /// <param name="TriggeringAction">TriggeringAction.</param>
    public QueueConversationCobrowseEventTopicJourneyContext(QueueConversationCobrowseEventTopicJourneyCustomer Customer = null, QueueConversationCobrowseEventTopicJourneyCustomerSession CustomerSession = null, QueueConversationCobrowseEventTopicJourneyAction TriggeringAction = null)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationCobrowseEventTopicJourneyContext);
    }

    /// <summary>
    /// Returns true if QueueConversationCobrowseEventTopicJourneyContext instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationCobrowseEventTopicJourneyContext to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationCobrowseEventTopicJourneyContext other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
