...
public partial class FullDayTimeOffMarker : IEquatable<FullDayTimeOffMarker>
{
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as FullDayTimeOffMarker);
    }

    /// <summary>
    /// Returns true if FullDayTimeOffMarker instances are equal
    /// </summary>
    /// <param name="other">Instance of FullDayTimeOffMarker to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(FullDayTimeOffMarker other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
