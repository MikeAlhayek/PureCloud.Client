...
/// </summary>
[DataContract]
public partial class WorkitemDateBasedRule : IEquatable<WorkitemDateBasedRule>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="WorkitemDateBasedRule" /> class.
    /// </summary>
    ...
    public WorkitemDateBasedRule(string Name = null, TypeEnum? Type = null, WorkitemRuleAction Action = null, WorktypeReference Worktype = null, WorkitemDateBasedCondition Condition = null)
    {
        this.Name = Name;
        this.Type = Type;
        this.Action = Action;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as WorkitemDateBasedRule);
    }

    /// <summary>
    /// Returns true if WorkitemDateBasedRule instances are equal
    /// </summary>
    /// <param name="other">Instance of WorkitemDateBasedRule to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(WorkitemDateBasedRule other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
