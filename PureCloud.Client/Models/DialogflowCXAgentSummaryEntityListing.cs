...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="DialogflowCXAgentSummaryEntityListing" /> class.
    /// </summary>
    ...
    public DialogflowCXAgentSummaryEntityListing(List<DialogflowCXAgentSummary> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class DialogflowCXAgentSummaryEntityListing {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as DialogflowCXAgentSummaryEntityListing);
    }

    /// <summary>
    /// Returns true if DialogflowCXAgentSummaryEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of DialogflowCXAgentSummaryEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(DialogflowCXAgentSummaryEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
