...
public partial class ExtensionPool : IEquatable<ExtensionPool>
{
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ExtensionPool);
    }

    /// <summary>
    /// Returns true if ExtensionPool instances are equal
    /// </summary>
    /// <param name="other">Instance of ExtensionPool to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ExtensionPool other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
        ...
        return true &&
            ...
            (
                this.EndNumber == other.EndNumber ||
                this.EndNumber != null &&
                this.EndNumber.Equals(other.EndNumber)
            ) &&
            (
    ...
    public override int GetHashCode()
    {
        ...
        unchecked // Overflow is fine, just wrap
        {
            ...
            {
                hash = hash * 59 + this.StartNumber.GetHashCode();
            }

            if (this.EndNumber != null)
            {
                hash = hash * 59 + this.EndNumber.GetHashCode();
            }
