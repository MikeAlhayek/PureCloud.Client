...
public partial class GKNDocumentationSearchCriteria : IEquatable<GKNDocumentationSearchCriteria>
{
    ...
    public GKNDocumentationSearchCriteria(string EndValue = null, List<string> Values = null, string StartValue = null, string Value = null, OperatorEnum? Operator = null, List<GKNDocumentationSearchCriteria> Group = null, string DateFormat = null, TypeEnum? Type = null, List<string> Fields = null)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as GKNDocumentationSearchCriteria);
    }

    /// <summary>
    /// Returns true if GKNDocumentationSearchCriteria instances are equal
    /// </summary>
    /// <param name="other">Instance of GKNDocumentationSearchCriteria to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(GKNDocumentationSearchCriteria other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
