...
public partial class QueueConversationMessageEventTopicErrorDetails : IEquatable<QueueConversationMessageEventTopicErrorDetails>
{
    ...
    public QueueConversationMessageEventTopicErrorDetails(long? Status = null, string Code = null, string Message = null, string MessageWithParams = null, Dictionary<string, string> MessageParams = null, string ContextId = null, string Uri = null)
    {
        this.Status = Status;
        this.Code = Code;
