...
/// </summary>
[DataContract]
public partial class RoutingStatusDetailQueryFilter : IEquatable<RoutingStatusDetailQueryFilter>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="RoutingStatusDetailQueryFilter" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected RoutingStatusDetailQueryFilter() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="RoutingStatusDetailQueryFilter" /> class.
    /// </summary>
    ...
    public RoutingStatusDetailQueryFilter(TypeEnum? Type = null, List<RoutingStatusDetailQueryClause> Clauses = null, List<RoutingStatusDetailQueryPredicate> Predicates = null)
    {
        this.Type = Type;
    ...
    public List<RoutingStatusDetailQueryClause> Clauses { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as RoutingStatusDetailQueryFilter);
    }

    /// <summary>
    /// Returns true if RoutingStatusDetailQueryFilter instances are equal
    /// </summary>
    /// <param name="other">Instance of RoutingStatusDetailQueryFilter to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(RoutingStatusDetailQueryFilter other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
