...
public partial class KnowledgeDocumentResponse : IEquatable<KnowledgeDocumentResponse>
{
    ...
    /// <summary>
    /// Returns true if KnowledgeDocumentResponse instances are equal
    /// </summary>
    /// <param name="other">Instance of KnowledgeDocumentResponse to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(KnowledgeDocumentResponse other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
