...
/// </summary>
[DataContract]
public partial class ConversationEmailEventTopicEmailConversation : IEquatable<ConversationEmailEventTopicEmailConversation>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationEmailEventTopicEmailConversation" /> class.
    /// </summary>
    ...
    public ConversationEmailEventTopicEmailConversation(string Id = null, string Name = null, List<ConversationEmailEventTopicEmailMediaParticipant> Participants = null, List<string> OtherMediaUris = null, string Address = null, string UtilizationLabelId = null, List<ConversationEmailEventTopicConversationDivisionMembership> Divisions = null)
    {
        this.Id = Id;
        this.Name = Name;
    ...
    public List<ConversationEmailEventTopicEmailMediaParticipant> Participants { get; set; }
    ...
    public List<ConversationEmailEventTopicConversationDivisionMembership> Divisions { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ConversationEmailEventTopicEmailConversation {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationEmailEventTopicEmailConversation);
    }

    /// <summary>
    /// Returns true if ConversationEmailEventTopicEmailConversation instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationEmailEventTopicEmailConversation to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationEmailEventTopicEmailConversation other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
