...
public partial class QueueConversationMessageEventTopicJourneyCustomer : IEquatable<QueueConversationMessageEventTopicJourneyCustomer>
{
    ...
    public override string ToString()
    {
        ...
        sb.Append("class QueueConversationMessageEventTopicJourneyCustomer {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationMessageEventTopicJourneyCustomer);
    }

    /// <summary>
    /// Returns true if QueueConversationMessageEventTopicJourneyCustomer instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationMessageEventTopicJourneyCustomer to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationMessageEventTopicJourneyCustomer other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
