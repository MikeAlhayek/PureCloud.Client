...
/// </summary>
[DataContract]
public partial class WfmActivityPlanRunJobCompleteTopicErrorBody : IEquatable<WfmActivityPlanRunJobCompleteTopicErrorBody>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="WfmActivityPlanRunJobCompleteTopicErrorBody" /> class.
    /// </summary>
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as WfmActivityPlanRunJobCompleteTopicErrorBody);
    }

    /// <summary>
    /// Returns true if WfmActivityPlanRunJobCompleteTopicErrorBody instances are equal
    /// </summary>
    /// <param name="other">Instance of WfmActivityPlanRunJobCompleteTopicErrorBody to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(WfmActivityPlanRunJobCompleteTopicErrorBody other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
