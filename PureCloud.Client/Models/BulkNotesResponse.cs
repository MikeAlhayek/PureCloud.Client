...
public partial class BulkNotesResponse : IEquatable<BulkNotesResponse>
{
    ...
    public BulkNotesResponse(List<BulkResponseResultNoteNoteBulkEntityErrorNote> Results = null, int? ErrorCount = null, List<int?> ErrorIndexes = null)
    {
    ...
    public List<BulkResponseResultNoteNoteBulkEntityErrorNote> Results { get; set; }
