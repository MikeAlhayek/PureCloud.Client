...
/// </summary>
[DataContract]
public partial class ConversationChatEventTopicWrapup : IEquatable<ConversationChatEventTopicWrapup>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationChatEventTopicWrapup" /> class.
    /// </summary>
    ...
    public ConversationChatEventTopicWrapup(string Code = null, string Notes = null, List<string> Tags = null, long? DurationSeconds = null, DateTime? EndTime = null)
    {
        this.Code = Code;
        this.Notes = Notes;
        this.Tags = Tags;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationChatEventTopicWrapup);
    }

    /// <summary>
    /// Returns true if ConversationChatEventTopicWrapup instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationChatEventTopicWrapup to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationChatEventTopicWrapup other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
