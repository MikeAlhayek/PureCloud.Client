...
/// </summary>
[DataContract]
public partial class ConversationCallEventTopicWrapup : IEquatable<ConversationCallEventTopicWrapup>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationCallEventTopicWrapup" /> class.
    /// </summary>
    ...
    public ConversationCallEventTopicWrapup(string Code = null, string Notes = null, List<string> Tags = null, long? DurationSeconds = null, DateTime? EndTime = null)
    {
        this.Code = Code;
        this.Notes = Notes;
        this.Tags = Tags;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ConversationCallEventTopicWrapup {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationCallEventTopicWrapup);
    }

    /// <summary>
    /// Returns true if ConversationCallEventTopicWrapup instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationCallEventTopicWrapup to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationCallEventTopicWrapup other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
