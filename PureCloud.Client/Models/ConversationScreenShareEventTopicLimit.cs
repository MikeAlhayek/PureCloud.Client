...
/// <summary>
/// ConversationScreenShareEventTopicLimit
/// </summary>
[DataContract]
public partial class ConversationScreenShareEventTopicLimit : IEquatable<ConversationScreenShareEventTopicLimit>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationScreenShareEventTopicLimit" /> class.
    /// </summary>
    /// <param name="Key">Key.</param>
    /// <param name="Namespace">Namespace.</param>
    /// <param name="Value">Value.</param>
    /// <param name="Documented">Documented.</param>
    public ConversationScreenShareEventTopicLimit(string Key = null, NamespaceEnum? Namespace = null, long? Value = null, bool? Documented = null)
    {
        this.Key = Key;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ConversationScreenShareEventTopicLimit {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationScreenShareEventTopicLimit);
    }

    /// <summary>
    /// Returns true if ConversationScreenShareEventTopicLimit instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationScreenShareEventTopicLimit to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationScreenShareEventTopicLimit other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
