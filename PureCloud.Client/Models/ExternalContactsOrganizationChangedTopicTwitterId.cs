...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ExternalContactsOrganizationChangedTopicTwitterId" /> class.
    /// </summary>
    ...
    public ExternalContactsOrganizationChangedTopicTwitterId(string Id = null, string Name = null, string ScreenName = null, bool? Verified = null, string ProfileUrl = null)
    {
        this.Id = Id;
        this.Name = Name;
    ...
    /// <summary>
    /// Returns true if ExternalContactsOrganizationChangedTopicTwitterId instances are equal
    /// </summary>
    /// <param name="other">Instance of ExternalContactsOrganizationChangedTopicTwitterId to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ExternalContactsOrganizationChangedTopicTwitterId other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
