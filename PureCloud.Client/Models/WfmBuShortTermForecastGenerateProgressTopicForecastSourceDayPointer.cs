...
public partial class WfmBuShortTermForecastGenerateProgressTopicForecastSourceDayPointer : IEquatable<WfmBuShortTermForecastGenerateProgressTopicForecastSourceDayPointer>
{
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as WfmBuShortTermForecastGenerateProgressTopicForecastSourceDayPointer);
    }

    /// <summary>
    /// Returns true if WfmBuShortTermForecastGenerateProgressTopicForecastSourceDayPointer instances are equal
    /// </summary>
    /// <param name="other">Instance of WfmBuShortTermForecastGenerateProgressTopicForecastSourceDayPointer to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(WfmBuShortTermForecastGenerateProgressTopicForecastSourceDayPointer other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
