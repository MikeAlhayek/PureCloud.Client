...
public partial class ScheduleGroup : IEquatable<ScheduleGroup>
{
    ...
    [JsonPropertyName("openSchedules")]
    ...
    [JsonPropertyName("closedSchedules")]
    ...
    [JsonPropertyName("holidaySchedules")]
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as ScheduleGroup);
    }
    ...
    public bool Equals(ScheduleGroup other)
    {
        ...
        return true &&
            ...
            (
                OpenSchedules == other.OpenSchedules ||
                OpenSchedules != null &&
                OpenSchedules.SequenceEqual(other.OpenSchedules)
            ) &&
            (
                ClosedSchedules == other.ClosedSchedules ||
                ClosedSchedules != null &&
                ClosedSchedules.SequenceEqual(other.ClosedSchedules)
            ) &&
            (
                HolidaySchedules == other.HolidaySchedules ||
                HolidaySchedules != null &&
                HolidaySchedules.SequenceEqual(other.HolidaySchedules)
            ) &&
            (
    ...
    public override int GetHashCode()
    {
        ...
        unchecked // Overflow is fine, just wrap
        {
            ...
            {
                hash = hash * 59 + OpenSchedules.GetHashCode();
            }

            if (ClosedSchedules != null)
            {
                hash = hash * 59 + ClosedSchedules.GetHashCode();
            }

            if (HolidaySchedules != null)
            {
                hash = hash * 59 + HolidaySchedules.GetHashCode();
            }
