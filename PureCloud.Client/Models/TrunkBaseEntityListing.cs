...
/// </summary>
[DataContract]
public partial class TrunkBaseEntityListing : IEquatable<TrunkBaseEntityListing>, IPagedResource<TrunkBase>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="TrunkBaseEntityListing" /> class.
    /// </summary>
    ...
    public TrunkBaseEntityListing(List<TrunkBase> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, long? TotalNumberOfEntities = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public List<TrunkBase> Entities { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class TrunkBaseEntityListing {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as TrunkBaseEntityListing);
    }

    /// <summary>
    /// Returns true if TrunkBaseEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of TrunkBaseEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(TrunkBaseEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
