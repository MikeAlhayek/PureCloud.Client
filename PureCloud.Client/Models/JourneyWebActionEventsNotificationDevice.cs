...
/// </summary>
[DataContract]
public partial class JourneyWebActionEventsNotificationDevice : IEquatable<JourneyWebActionEventsNotificationDevice>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="JourneyWebActionEventsNotificationDevice" /> class.
    /// </summary>
    ...
    public JourneyWebActionEventsNotificationDevice(string Type = null, bool? IsMobile = null, long? ScreenHeight = null, long? ScreenWidth = null, long? ScreenDensity = null, string Fingerprint = null, string OsFamily = null, string OsVersion = null, CategoryEnum? Category = null, string Manufacturer = null)
    {
        this.Type = Type;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as JourneyWebActionEventsNotificationDevice);
    }

    /// <summary>
    /// Returns true if JourneyWebActionEventsNotificationDevice instances are equal
    /// </summary>
    /// <param name="other">Instance of JourneyWebActionEventsNotificationDevice to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(JourneyWebActionEventsNotificationDevice other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
