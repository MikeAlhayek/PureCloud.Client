...
public partial class CloseButtonStyleProperties : IEquatable<CloseButtonStyleProperties>
{
    ...
    public CloseButtonStyleProperties(string Color = null, float? Opacity = null)
    {
        this.Color = Color;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as CloseButtonStyleProperties);
    }

    /// <summary>
    /// Returns true if CloseButtonStyleProperties instances are equal
    /// </summary>
    /// <param name="other">Instance of CloseButtonStyleProperties to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(CloseButtonStyleProperties other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
