...
/// </summary>
[DataContract]
public partial class TeamActivityQueryFilter : IEquatable<TeamActivityQueryFilter>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="TeamActivityQueryFilter" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected TeamActivityQueryFilter() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="TeamActivityQueryFilter" /> class.
    /// </summary>
    ...
    public TeamActivityQueryFilter(TypeEnum? Type = null, List<TeamActivityQueryClause> Clauses = null, List<TeamActivityQueryPredicate> Predicates = null)
    {
        this.Type = Type;
    ...
    public List<TeamActivityQueryClause> Clauses { get; set; }
    ...
    public List<TeamActivityQueryPredicate> Predicates { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as TeamActivityQueryFilter);
    }

    /// <summary>
    /// Returns true if TeamActivityQueryFilter instances are equal
    /// </summary>
    /// <param name="other">Instance of TeamActivityQueryFilter to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(TeamActivityQueryFilter other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
