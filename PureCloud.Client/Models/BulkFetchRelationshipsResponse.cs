...
public partial class BulkFetchRelationshipsResponse : IEquatable<BulkFetchRelationshipsResponse>
{
    ...
    public BulkFetchRelationshipsResponse(List<BulkResponseResultRelationshipEntityBulkEntityErrorEntity> Results = null, int? ErrorCount = null, List<int?> ErrorIndexes = null)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as BulkFetchRelationshipsResponse);
    }

    /// <summary>
    /// Returns true if BulkFetchRelationshipsResponse instances are equal
    /// </summary>
    /// <param name="other">Instance of BulkFetchRelationshipsResponse to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(BulkFetchRelationshipsResponse other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
