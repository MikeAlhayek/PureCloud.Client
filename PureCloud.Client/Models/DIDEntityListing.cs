...
/// </summary>
[DataContract]
public partial class DIDEntityListing : IEquatable<DIDEntityListing>, IPagedResource<DID>
{
    /// <summary>
    ...
    public DIDEntityListing(List<DID> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, long? TotalNumberOfEntities = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public List<DID> Entities { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as DIDEntityListing);
    }

    /// <summary>
    /// Returns true if DIDEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of DIDEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(DIDEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
