...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class QueueConversationSocialExpressionEventTopicVoicemail :  IEquatable<QueueConversationSocialExpressionEventTopicVoicemail>
    {
        ...
        public QueueConversationSocialExpressionEventTopicVoicemail(string Id = null, UploadStatusEnum? UploadStatus = null)
        {
            this.Id = Id;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationSocialExpressionEventTopicVoicemail);
        }

        /// <summary>
        /// Returns true if QueueConversationSocialExpressionEventTopicVoicemail instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationSocialExpressionEventTopicVoicemail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationSocialExpressionEventTopicVoicemail other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
