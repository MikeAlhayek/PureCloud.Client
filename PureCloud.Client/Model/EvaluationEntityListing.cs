...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class EvaluationEntityListing :  IEquatable<EvaluationEntityListing>, IPagedResource<Evaluation>
    {
        ...
        public EvaluationEntityListing(List<Evaluation> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
        {
        ...
        public List<Evaluation> Entities { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EvaluationEntityListing {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EvaluationEntityListing);
        }

        /// <summary>
        /// Returns true if EvaluationEntityListing instances are equal
        /// </summary>
        /// <param name="other">Instance of EvaluationEntityListing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EvaluationEntityListing other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
