...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RoutingActivityQueryPredicate :  IEquatable<RoutingActivityQueryPredicate>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RoutingActivityQueryPredicate" /> class.
        /// </summary>
        ...
        public RoutingActivityQueryPredicate(TypeEnum? Type = null, DimensionEnum? Dimension = null, OperatorEnum? Operator = null, string Value = null)
        {
            this.Type = Type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RoutingActivityQueryPredicate {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RoutingActivityQueryPredicate);
        }

        /// <summary>
        /// Returns true if RoutingActivityQueryPredicate instances are equal
        /// </summary>
        /// <param name="other">Instance of RoutingActivityQueryPredicate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RoutingActivityQueryPredicate other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
