...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class JourneyAggregationQuery :  IEquatable<JourneyAggregationQuery>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as JourneyAggregationQuery);
        }

        /// <summary>
        /// Returns true if JourneyAggregationQuery instances are equal
        /// </summary>
        /// <param name="other">Instance of JourneyAggregationQuery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JourneyAggregationQuery other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
