...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueueConversationEventTopicVideo :  IEquatable<QueueConversationEventTopicVideo>
    {
        /// <summary>
        /// Gets or Sets State
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationEventTopicVideo);
        }

        /// <summary>
        /// Returns true if QueueConversationEventTopicVideo instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationEventTopicVideo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationEventTopicVideo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
