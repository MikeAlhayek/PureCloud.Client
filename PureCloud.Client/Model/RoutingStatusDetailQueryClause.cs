...
public partial class RoutingStatusDetailQueryClause : IEquatable<RoutingStatusDetailQueryClause>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="RoutingStatusDetailQueryClause" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected RoutingStatusDetailQueryClause() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="RoutingStatusDetailQueryClause" /> class.
    /// </summary>
    ...
    public RoutingStatusDetailQueryClause(TypeEnum? Type = null, List<RoutingStatusDetailQueryPredicate> Predicates = null)
    {
        this.Type = Type;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class RoutingStatusDetailQueryClause {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as RoutingStatusDetailQueryClause);
    }

    /// <summary>
    /// Returns true if RoutingStatusDetailQueryClause instances are equal
    /// </summary>
    /// <param name="other">Instance of RoutingStatusDetailQueryClause to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(RoutingStatusDetailQueryClause other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
