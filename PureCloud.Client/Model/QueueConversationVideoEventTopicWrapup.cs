...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueueConversationVideoEventTopicWrapup :  IEquatable<QueueConversationVideoEventTopicWrapup>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueConversationVideoEventTopicWrapup" /> class.
        /// </summary>
        ...
        public QueueConversationVideoEventTopicWrapup(string Code = null, string Notes = null, List<string> Tags = null, long? DurationSeconds = null, DateTime? EndTime = null)
        {
            this.Code = Code;
            this.Notes = Notes;
            this.Tags = Tags;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QueueConversationVideoEventTopicWrapup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationVideoEventTopicWrapup);
        }

        /// <summary>
        /// Returns true if QueueConversationVideoEventTopicWrapup instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationVideoEventTopicWrapup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationVideoEventTopicWrapup other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
