...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class QueueConversationCallbackEventTopicJourneyCustomerSession :  IEquatable<QueueConversationCallbackEventTopicJourneyCustomerSession>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QueueConversationCallbackEventTopicJourneyCustomerSession {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationCallbackEventTopicJourneyCustomerSession);
        }

        /// <summary>
        /// Returns true if QueueConversationCallbackEventTopicJourneyCustomerSession instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationCallbackEventTopicJourneyCustomerSession to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationCallbackEventTopicJourneyCustomerSession other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
