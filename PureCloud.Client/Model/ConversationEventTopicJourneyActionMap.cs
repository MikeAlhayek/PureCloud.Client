...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationEventTopicJourneyActionMap :  IEquatable<ConversationEventTopicJourneyActionMap>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationEventTopicJourneyActionMap" /> class.
        /// </summary>
        ...
        public ConversationEventTopicJourneyActionMap(string Id = null, long? Version = null)
        {
            this.Id = Id;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationEventTopicJourneyActionMap);
        }

        /// <summary>
        /// Returns true if ConversationEventTopicJourneyActionMap instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationEventTopicJourneyActionMap to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationEventTopicJourneyActionMap other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
