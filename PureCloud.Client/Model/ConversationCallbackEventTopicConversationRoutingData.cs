...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationCallbackEventTopicConversationRoutingData :  IEquatable<ConversationCallbackEventTopicConversationRoutingData>
    {
        /// <summary>
        ...
        public ConversationCallbackEventTopicConversationRoutingData(ConversationCallbackEventTopicUriReference Queue = null, ConversationCallbackEventTopicUriReference Language = null, long? Priority = null, List<ConversationCallbackEventTopicUriReference> Skills = null, List<ConversationCallbackEventTopicScoredAgent> ScoredAgents = null)
        {
            this.Queue = Queue;
        ...
        public ConversationCallbackEventTopicUriReference Language { get; set; }
        ...
        public List<ConversationCallbackEventTopicUriReference> Skills { get; set; }
        ...
        public List<ConversationCallbackEventTopicScoredAgent> ScoredAgents { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationCallbackEventTopicConversationRoutingData);
        }

        /// <summary>
        /// Returns true if ConversationCallbackEventTopicConversationRoutingData instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationCallbackEventTopicConversationRoutingData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationCallbackEventTopicConversationRoutingData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
