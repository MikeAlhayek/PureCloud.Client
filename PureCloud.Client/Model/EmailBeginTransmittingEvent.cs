...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmailBeginTransmittingEvent :  IEquatable<EmailBeginTransmittingEvent>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="EmailBeginTransmittingEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EmailBeginTransmittingEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailBeginTransmittingEvent" /> class.
        /// </summary>
        ...
        public EmailBeginTransmittingEvent(string EventId = null, DateTime? EventDateTime = null, string ConversationId = null, string CommunicationId = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmailBeginTransmittingEvent {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EmailBeginTransmittingEvent);
        }

        /// <summary>
        /// Returns true if EmailBeginTransmittingEvent instances are equal
        /// </summary>
        /// <param name="other">Instance of EmailBeginTransmittingEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailBeginTransmittingEvent other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
