...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserRecordingEntityListing :  IEquatable<UserRecordingEntityListing>, IPagedResource<UserRecording>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserRecordingEntityListing" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserRecordingEntityListing {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UserRecordingEntityListing);
        }

        /// <summary>
        /// Returns true if UserRecordingEntityListing instances are equal
        /// </summary>
        /// <param name="other">Instance of UserRecordingEntityListing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserRecordingEntityListing other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
