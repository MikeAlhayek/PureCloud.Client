...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AgentStateUserFilter : IEquatable<AgentStateUserFilter>
    {
        /// <summary>
        ...
        protected AgentStateUserFilter() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentStateUserFilter" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AgentStateUserFilter {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AgentStateUserFilter);
        }

        /// <summary>
        /// Returns true if AgentStateUserFilter instances are equal
        /// </summary>
        /// <param name="other">Instance of AgentStateUserFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AgentStateUserFilter other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
