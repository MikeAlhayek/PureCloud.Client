...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationScreenShareEventTopicConversationRoutingData :  IEquatable<ConversationScreenShareEventTopicConversationRoutingData>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationScreenShareEventTopicConversationRoutingData" /> class.
        /// </summary>
        ...
        public ConversationScreenShareEventTopicUriReference Language { get; set; }
        ...
        public List<ConversationScreenShareEventTopicUriReference> Skills { get; set; }
        ...
        public List<ConversationScreenShareEventTopicScoredAgent> ScoredAgents { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationScreenShareEventTopicConversationRoutingData);
        }

        /// <summary>
        /// Returns true if ConversationScreenShareEventTopicConversationRoutingData instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationScreenShareEventTopicConversationRoutingData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationScreenShareEventTopicConversationRoutingData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
