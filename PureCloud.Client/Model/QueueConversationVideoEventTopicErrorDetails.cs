...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueueConversationVideoEventTopicErrorDetails :  IEquatable<QueueConversationVideoEventTopicErrorDetails>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueConversationVideoEventTopicErrorDetails" /> class.
        /// </summary>
        ...
        public QueueConversationVideoEventTopicErrorDetails(long? Status = null, string Code = null, string Message = null, string MessageWithParams = null, Dictionary<string, string> MessageParams = null, string ContextId = null, string Uri = null)
        {
            this.Status = Status;
            this.Code = Code;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationVideoEventTopicErrorDetails);
        }

        /// <summary>
        /// Returns true if QueueConversationVideoEventTopicErrorDetails instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationVideoEventTopicErrorDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationVideoEventTopicErrorDetails other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
