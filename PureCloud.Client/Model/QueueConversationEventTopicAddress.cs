...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueueConversationEventTopicAddress :  IEquatable<QueueConversationEventTopicAddress>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueConversationEventTopicAddress" /> class.
        /// </summary>
        ...
        public QueueConversationEventTopicAddress(string Name = null, string NameRaw = null, string AddressNormalized = null, string AddressRaw = null, string AddressDisplayable = null)
        {
            this.Name = Name;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationEventTopicAddress);
        }

        /// <summary>
        /// Returns true if QueueConversationEventTopicAddress instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationEventTopicAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationEventTopicAddress other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
