...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TranscriptAggregateQueryFilter :  IEquatable<TranscriptAggregateQueryFilter>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TranscriptAggregateQueryFilter" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TranscriptAggregateQueryFilter() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TranscriptAggregateQueryFilter" /> class.
        /// </summary>
        ...
        public TranscriptAggregateQueryFilter(TypeEnum? Type = null, List<TranscriptAggregateQueryClause> Clauses = null, List<TranscriptAggregateQueryPredicate> Predicates = null)
        {
            this.Type = Type;
        ...
        public List<TranscriptAggregateQueryClause> Clauses { get; set; }
        ...
        /// <summary>
        /// Returns true if TranscriptAggregateQueryFilter instances are equal
        /// </summary>
        /// <param name="other">Instance of TranscriptAggregateQueryFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranscriptAggregateQueryFilter other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
