...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationEmailEventTopicJourneyAction :  IEquatable<ConversationEmailEventTopicJourneyAction>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationEmailEventTopicJourneyAction" /> class.
        /// </summary>
        ...
        public ConversationEmailEventTopicJourneyAction(string Id = null, ConversationEmailEventTopicJourneyActionMap ActionMap = null)
        {
            this.Id = Id;
        ...
        /// <summary>
        /// Returns true if ConversationEmailEventTopicJourneyAction instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationEmailEventTopicJourneyAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationEmailEventTopicJourneyAction other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
