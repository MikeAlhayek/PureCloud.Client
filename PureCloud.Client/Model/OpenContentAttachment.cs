...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OpenContentAttachment :  IEquatable<OpenContentAttachment>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenContentAttachment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OpenContentAttachment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenContentAttachment" /> class.
        /// </summary>
        /// <param name="Id">Provider specific ID for attachment. For example, middleware media UUID..</param>
        /// <param name="MediaType">The type of attachment this instance represents. (required).</param>
        /// <param name="Url">URL of the attachment. (required).</param>
        /// <param name="Mime">Attachment mime type (https://www.iana.org/assignments/media-types/media-types.xhtml). (required).</param>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as OpenContentAttachment);
        }

        /// <summary>
        /// Returns true if OpenContentAttachment instances are equal
        /// </summary>
        /// <param name="other">Instance of OpenContentAttachment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OpenContentAttachment other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
