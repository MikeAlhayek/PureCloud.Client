...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FlowExecutionAggregationQuery :  IEquatable<FlowExecutionAggregationQuery>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FlowExecutionAggregationQuery" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FlowExecutionAggregationQuery() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FlowExecutionAggregationQuery" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FlowExecutionAggregationQuery {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FlowExecutionAggregationQuery);
        }

        /// <summary>
        /// Returns true if FlowExecutionAggregationQuery instances are equal
        /// </summary>
        /// <param name="other">Instance of FlowExecutionAggregationQuery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlowExecutionAggregationQuery other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
