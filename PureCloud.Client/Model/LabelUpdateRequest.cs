...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class LabelUpdateRequest :  IEquatable<LabelUpdateRequest>
    {
        ...
        public LabelUpdateRequest(string Name = null, string Color = null, string ExternalId = null)
        {
            this.Name = Name;
            this.Color = Color;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LabelUpdateRequest);
        }

        /// <summary>
        /// Returns true if LabelUpdateRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of LabelUpdateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LabelUpdateRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
