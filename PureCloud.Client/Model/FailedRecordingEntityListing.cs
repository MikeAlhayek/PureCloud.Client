...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class FailedRecordingEntityListing :  IEquatable<FailedRecordingEntityListing>, IPagedResource<RecordingJobFailedRecording>
    {
        ...
        public FailedRecordingEntityListing(List<RecordingJobFailedRecording> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FailedRecordingEntityListing);
        }

        /// <summary>
        /// Returns true if FailedRecordingEntityListing instances are equal
        /// </summary>
        /// <param name="other">Instance of FailedRecordingEntityListing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FailedRecordingEntityListing other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
