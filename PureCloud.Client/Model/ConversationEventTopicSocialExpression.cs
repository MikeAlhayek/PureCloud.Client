...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationEventTopicSocialExpression :  IEquatable<ConversationEventTopicSocialExpression>
    {
        /// <summary>
        /// Gets or Sets State
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationEventTopicSocialExpression);
        }

        /// <summary>
        /// Returns true if ConversationEventTopicSocialExpression instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationEventTopicSocialExpression to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationEventTopicSocialExpression other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
