...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TeamSearchCriteria :  IEquatable<TeamSearchCriteria>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamSearchCriteria" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TeamSearchCriteria() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamSearchCriteria" /> class.
        /// </summary>
        ...
        public TeamSearchCriteria(string EndValue = null, List<string> Values = null, string StartValue = null, string Value = null, OperatorEnum? Operator = null, List<TeamSearchCriteria> Group = null, string DateFormat = null, List<string> Fields = null, TypeEnum? Type = null)
        {
        ...
        public List<TeamSearchCriteria> Group { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TeamSearchCriteria);
        }

        /// <summary>
        /// Returns true if TeamSearchCriteria instances are equal
        /// </summary>
        /// <param name="other">Instance of TeamSearchCriteria to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TeamSearchCriteria other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
