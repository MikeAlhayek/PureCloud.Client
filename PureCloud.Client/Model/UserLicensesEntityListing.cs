...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class UserLicensesEntityListing :  IEquatable<UserLicensesEntityListing>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UserLicensesEntityListing);
        }

        /// <summary>
        /// Returns true if UserLicensesEntityListing instances are equal
        /// </summary>
        /// <param name="other">Instance of UserLicensesEntityListing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserLicensesEntityListing other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
