...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class KnowledgeDocument :  IEquatable<KnowledgeDocument>
    {
        /// <summary>
        ...
        public KnowledgeDocument(string Name = null, LanguageCodeEnum? LanguageCode = null, TypeEnum? Type = null, DocumentFaq Faq = null, List<KnowledgeCategory> Categories = null, string ExternalUrl = null, DocumentArticle Article = null)
        {
            this.Name = Name;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as KnowledgeDocument);
        }

        /// <summary>
        /// Returns true if KnowledgeDocument instances are equal
        /// </summary>
        /// <param name="other">Instance of KnowledgeDocument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KnowledgeDocument other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
