...
/// </summary>
[DataContract]
public partial class ExternalContactsRelationshipChangedTopicExternalOrganization : IEquatable<ExternalContactsRelationshipChangedTopicExternalOrganization>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ExternalContactsRelationshipChangedTopicExternalOrganization" /> class.
    /// </summary>
    ...
    public ExternalContactsRelationshipChangedTopicExternalOrganization(string Id = null, ExternalContactsRelationshipChangedTopicDivision Division = null, string Name = null, string CompanyType = null, string Industry = null, string PrimaryContactId = null, ExternalContactsRelationshipChangedTopicContactAddress Address = null, ExternalContactsRelationshipChangedTopicPhoneNumber PhoneNumber = null, ExternalContactsRelationshipChangedTopicPhoneNumber FaxNumber = null, long? EmployeeCount = null, long? Revenue = null, List<string> Tags = null, List<string> Websites = null, List<ExternalContactsRelationshipChangedTopicTicker> Tickers = null, ExternalContactsRelationshipChangedTopicTwitterId TwitterId = null, string ExternalSystemUrl = null, Dictionary<string, Object> CustomFields = null, DateTime? CreateDate = null, DateTime? ModifyDate = null)
    {
        this.Id = Id;
    ...
    public List<ExternalContactsRelationshipChangedTopicTicker> Tickers { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ExternalContactsRelationshipChangedTopicExternalOrganization);
    }

    /// <summary>
    /// Returns true if ExternalContactsRelationshipChangedTopicExternalOrganization instances are equal
    /// </summary>
    /// <param name="other">Instance of ExternalContactsRelationshipChangedTopicExternalOrganization to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ExternalContactsRelationshipChangedTopicExternalOrganization other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
