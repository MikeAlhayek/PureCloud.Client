...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UsersSearchResponse :  IEquatable<UsersSearchResponse>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="UsersSearchResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UsersSearchResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UsersSearchResponse" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UsersSearchResponse);
        }

        /// <summary>
        /// Returns true if UsersSearchResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of UsersSearchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsersSearchResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
