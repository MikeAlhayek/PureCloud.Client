...
/// </summary>
[DataContract]
public partial class WorkitemsQueueEventsNotificationWorkitem : IEquatable<WorkitemsQueueEventsNotificationWorkitem>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="WorkitemsQueueEventsNotificationWorkitem" /> class.
    /// </summary>
    ...
    public List<WorkitemsQueueEventsNotificationDelta> Changes { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as WorkitemsQueueEventsNotificationWorkitem);
    }

    /// <summary>
    /// Returns true if WorkitemsQueueEventsNotificationWorkitem instances are equal
    /// </summary>
    /// <param name="other">Instance of WorkitemsQueueEventsNotificationWorkitem to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(WorkitemsQueueEventsNotificationWorkitem other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
