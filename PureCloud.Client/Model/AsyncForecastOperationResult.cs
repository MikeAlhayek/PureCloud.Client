...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class AsyncForecastOperationResult : IEquatable<AsyncForecastOperationResult>
    {
        ...
        /// <summary>
        /// Returns true if AsyncForecastOperationResult instances are equal
        /// </summary>
        /// <param name="other">Instance of AsyncForecastOperationResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AsyncForecastOperationResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
