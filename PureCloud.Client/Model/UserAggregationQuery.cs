...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserAggregationQuery :  IEquatable<UserAggregationQuery>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserAggregationQuery" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UserAggregationQuery() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UserAggregationQuery" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UserAggregationQuery);
        }

        /// <summary>
        /// Returns true if UserAggregationQuery instances are equal
        /// </summary>
        /// <param name="other">Instance of UserAggregationQuery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserAggregationQuery other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
