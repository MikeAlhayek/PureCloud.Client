...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class LearningAssignmentAggregateQueryResponseMetric :  IEquatable<LearningAssignmentAggregateQueryResponseMetric>
    {
        ...
        public LearningAssignmentAggregateQueryResponseMetric(MetricEnum? Metric = null, LearningAssignmentAggregateQueryResponseStats Stats = null)
        {
            this.Metric = Metric;
            this.Stats = Stats;
        ...
        /// <summary>
        /// Returns true if LearningAssignmentAggregateQueryResponseMetric instances are equal
        /// </summary>
        /// <param name="other">Instance of LearningAssignmentAggregateQueryResponseMetric to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LearningAssignmentAggregateQueryResponseMetric other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
