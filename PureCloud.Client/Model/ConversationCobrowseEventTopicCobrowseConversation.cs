...
/// </summary>
[DataContract]
public partial class ConversationCobrowseEventTopicCobrowseConversation : IEquatable<ConversationCobrowseEventTopicCobrowseConversation>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationCobrowseEventTopicCobrowseConversation" /> class.
    /// </summary>
    ...
    public List<ConversationCobrowseEventTopicCobrowseMediaParticipant> Participants { get; set; }
    ...
    public List<ConversationCobrowseEventTopicConversationDivisionMembership> Divisions { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationCobrowseEventTopicCobrowseConversation);
    }

    /// <summary>
    /// Returns true if ConversationCobrowseEventTopicCobrowseConversation instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationCobrowseEventTopicCobrowseConversation to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationCobrowseEventTopicCobrowseConversation other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
