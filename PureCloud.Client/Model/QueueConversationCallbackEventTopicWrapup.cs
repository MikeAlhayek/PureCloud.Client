...
/// </summary>
[DataContract]
public partial class QueueConversationCallbackEventTopicWrapup : IEquatable<QueueConversationCallbackEventTopicWrapup>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="QueueConversationCallbackEventTopicWrapup" /> class.
    /// </summary>
    ...
    public QueueConversationCallbackEventTopicWrapup(string Code = null, string Notes = null, List<string> Tags = null, long? DurationSeconds = null, DateTime? EndTime = null)
    {
        this.Code = Code;
        this.Notes = Notes;
        this.Tags = Tags;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class QueueConversationCallbackEventTopicWrapup {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationCallbackEventTopicWrapup);
    }

    /// <summary>
    /// Returns true if QueueConversationCallbackEventTopicWrapup instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationCallbackEventTopicWrapup to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationCallbackEventTopicWrapup other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
