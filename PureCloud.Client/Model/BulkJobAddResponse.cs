...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkJobAddResponse" /> class.
        /// </summary>
        ...
        public BulkJobAddResponse(List<BulkJobAddResult> Results = null, int? ErrorCount = null, List<int?> ErrorIndexes = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BulkJobAddResponse);
        }

        /// <summary>
        /// Returns true if BulkJobAddResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of BulkJobAddResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkJobAddResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
