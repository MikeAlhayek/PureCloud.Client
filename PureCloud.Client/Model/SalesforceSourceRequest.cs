...
/// </summary>
[DataContract]
public partial class SalesforceSourceRequest : IEquatable<SalesforceSourceRequest>
{

    /// <summary>
    /// Initializes a new instance of the <see cref="SalesforceSourceRequest" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected SalesforceSourceRequest() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="SalesforceSourceRequest" /> class.
    /// </summary>
    ...
    public SalesforceSourceRequest(string Name = null, string IntegrationId = null, int? SchedulePeriod = null, SalesforceSettings Settings = null)
    {
        this.Name = Name;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as SalesforceSourceRequest);
    }

    /// <summary>
    /// Returns true if SalesforceSourceRequest instances are equal
    /// </summary>
    /// <param name="other">Instance of SalesforceSourceRequest to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(SalesforceSourceRequest other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
