...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BulkEntityErrorContactEnrichRequest : IEquatable<BulkEntityErrorContactEnrichRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkEntityErrorContactEnrichRequest" /> class.
        /// </summary>
        ...
        public BulkEntityErrorContactEnrichRequest(string Code = null, string Message = null, int? Status = null, bool? Retryable = null, List<BulkErrorDetail> Details = null, ContactEnrichRequest Entity = null)
        {
            this.Code = Code;
        ...
        public ContactEnrichRequest Entity { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BulkEntityErrorContactEnrichRequest);
        }

        /// <summary>
        /// Returns true if BulkEntityErrorContactEnrichRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of BulkEntityErrorContactEnrichRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkEntityErrorContactEnrichRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
