...
public partial class EncryptionKeyEntityListing : IEquatable<EncryptionKeyEntityListing>, IPagedResource<EncryptionKey>
{
    ...
    public override string ToString()
    {
        ...
        sb.Append("class EncryptionKeyEntityListing {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as EncryptionKeyEntityListing);
    }

    /// <summary>
    /// Returns true if EncryptionKeyEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of EncryptionKeyEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(EncryptionKeyEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
