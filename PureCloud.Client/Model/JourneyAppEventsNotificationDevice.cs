...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class JourneyAppEventsNotificationDevice :  IEquatable<JourneyAppEventsNotificationDevice>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JourneyAppEventsNotificationDevice" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as JourneyAppEventsNotificationDevice);
        }

        /// <summary>
        /// Returns true if JourneyAppEventsNotificationDevice instances are equal
        /// </summary>
        /// <param name="other">Instance of JourneyAppEventsNotificationDevice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JourneyAppEventsNotificationDevice other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
