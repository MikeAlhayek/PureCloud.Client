...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationEmailEventTopicQueueMediaSettings :  IEquatable<ConversationEmailEventTopicQueueMediaSettings>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationEmailEventTopicQueueMediaSettings" /> class.
        /// </summary>
        ...
        public ConversationEmailEventTopicQueueMediaSettings(long? AlertingTimeoutSeconds = null, double? AutoAnswerAlertToneSeconds = null, double? ManualAnswerAlertToneSeconds = null, bool? EnableAutoAnswer = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConversationEmailEventTopicQueueMediaSettings {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationEmailEventTopicQueueMediaSettings);
        }

        /// <summary>
        /// Returns true if ConversationEmailEventTopicQueueMediaSettings instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationEmailEventTopicQueueMediaSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationEmailEventTopicQueueMediaSettings other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
