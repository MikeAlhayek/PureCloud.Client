...
/// </summary>
[DataContract]
public partial class SkillGroupRoutingCondition : IEquatable<SkillGroupRoutingCondition>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SkillGroupRoutingCondition" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected SkillGroupRoutingCondition() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="SkillGroupRoutingCondition" /> class.
    /// </summary>
    ...
    public SkillGroupRoutingCondition(string RoutingSkill = null, ComparatorEnum? Comparator = null, int? Proficiency = null, List<SkillGroupCondition> ChildConditions = null)
    {
    ...
    /// <summary>
    /// Returns true if SkillGroupRoutingCondition instances are equal
    /// </summary>
    /// <param name="other">Instance of SkillGroupRoutingCondition to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(SkillGroupRoutingCondition other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
