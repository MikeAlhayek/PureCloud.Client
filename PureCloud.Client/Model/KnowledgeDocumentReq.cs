...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class KnowledgeDocumentReq :  IEquatable<KnowledgeDocumentReq>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="KnowledgeDocumentReq" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KnowledgeDocumentReq() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KnowledgeDocumentReq" /> class.
        /// </summary>
        ...
        public KnowledgeDocumentReq(string Title = null, bool? Visible = null, List<KnowledgeDocumentAlternative> Alternatives = null, string CategoryId = null, List<string> LabelIds = null, string ExternalId = null, string ExternalUrl = null)
        {
            this.Title = Title;
        ...
        /// <summary>
        /// Returns true if KnowledgeDocumentReq instances are equal
        /// </summary>
        /// <param name="other">Instance of KnowledgeDocumentReq to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KnowledgeDocumentReq other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
