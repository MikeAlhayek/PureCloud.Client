...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExternalContactsOrganizationChangedTopicPhoneNumber" /> class.
        /// </summary>
        ...
        public ExternalContactsOrganizationChangedTopicPhoneNumber(string Display = null, long? Extension = null, bool? AcceptsSMS = null, string UserInput = null, string E164 = null, string CountryCode = null, string NormalizationCountryCode = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ExternalContactsOrganizationChangedTopicPhoneNumber);
        }

        /// <summary>
        /// Returns true if ExternalContactsOrganizationChangedTopicPhoneNumber instances are equal
        /// </summary>
        /// <param name="other">Instance of ExternalContactsOrganizationChangedTopicPhoneNumber to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExternalContactsOrganizationChangedTopicPhoneNumber other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
