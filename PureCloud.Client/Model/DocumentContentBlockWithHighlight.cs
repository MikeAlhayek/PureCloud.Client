...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentContentBlockWithHighlight :  IEquatable<DocumentContentBlockWithHighlight>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentContentBlockWithHighlight" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DocumentContentBlockWithHighlight() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentContentBlockWithHighlight" /> class.
        /// </summary>
        ...
        public DocumentContentBlockWithHighlight(TypeEnum? Type = null, DocumentText Text = null, DocumentBodyImage Image = null, DocumentBodyVideo Video = null, DocumentContentHighlightIndex AnswerHighlight = null)
        {
            this.Type = Type;
            this.Text = Text;
            this.Image = Image;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DocumentContentBlockWithHighlight);
        }

        /// <summary>
        /// Returns true if DocumentContentBlockWithHighlight instances are equal
        /// </summary>
        /// <param name="other">Instance of DocumentContentBlockWithHighlight to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentContentBlockWithHighlight other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
