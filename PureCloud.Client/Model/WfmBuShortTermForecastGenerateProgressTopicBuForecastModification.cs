...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class WfmBuShortTermForecastGenerateProgressTopicBuForecastModification :  IEquatable<WfmBuShortTermForecastGenerateProgressTopicBuForecastModification>
    {
        ...
        public List<WfmBuShortTermForecastGenerateProgressTopicModificationIntervalOffsetValue> SecondaryValues { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as WfmBuShortTermForecastGenerateProgressTopicBuForecastModification);
        }

        /// <summary>
        /// Returns true if WfmBuShortTermForecastGenerateProgressTopicBuForecastModification instances are equal
        /// </summary>
        /// <param name="other">Instance of WfmBuShortTermForecastGenerateProgressTopicBuForecastModification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WfmBuShortTermForecastGenerateProgressTopicBuForecastModification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
