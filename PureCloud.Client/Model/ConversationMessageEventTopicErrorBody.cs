...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationMessageEventTopicErrorBody :  IEquatable<ConversationMessageEventTopicErrorBody>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationMessageEventTopicErrorBody" /> class.
        /// </summary>
        ...
        public List<ConversationMessageEventTopicDetail> Details { get; set; }
        ...
        public List<ConversationMessageEventTopicErrorBody> Errors { get; set; }
        ...
        public ConversationMessageEventTopicLimit Limit { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationMessageEventTopicErrorBody);
        }

        /// <summary>
        /// Returns true if ConversationMessageEventTopicErrorBody instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationMessageEventTopicErrorBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationMessageEventTopicErrorBody other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
