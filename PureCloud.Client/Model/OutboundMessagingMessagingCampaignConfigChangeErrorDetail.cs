...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class OutboundMessagingMessagingCampaignConfigChangeErrorDetail :  IEquatable<OutboundMessagingMessagingCampaignConfigChangeErrorDetail>
    {
        ...
        /// <summary>
        /// Returns true if OutboundMessagingMessagingCampaignConfigChangeErrorDetail instances are equal
        /// </summary>
        /// <param name="other">Instance of OutboundMessagingMessagingCampaignConfigChangeErrorDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OutboundMessagingMessagingCampaignConfigChangeErrorDetail other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
