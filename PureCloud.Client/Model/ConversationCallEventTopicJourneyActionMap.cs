...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationCallEventTopicJourneyActionMap :  IEquatable<ConversationCallEventTopicJourneyActionMap>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationCallEventTopicJourneyActionMap" /> class.
        /// </summary>
        ...
        public ConversationCallEventTopicJourneyActionMap(string Id = null, long? Version = null)
        {
            this.Id = Id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConversationCallEventTopicJourneyActionMap {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationCallEventTopicJourneyActionMap);
        }

        /// <summary>
        /// Returns true if ConversationCallEventTopicJourneyActionMap instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationCallEventTopicJourneyActionMap to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationCallEventTopicJourneyActionMap other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
