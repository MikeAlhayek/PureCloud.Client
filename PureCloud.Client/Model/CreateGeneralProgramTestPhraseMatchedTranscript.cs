...
public partial class CreateGeneralProgramTestPhraseMatchedTranscript : IEquatable<CreateGeneralProgramTestPhraseMatchedTranscript>
{
    ...
    public override string ToString()
    {
        ...
        sb.Append("class CreateGeneralProgramTestPhraseMatchedTranscript {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as CreateGeneralProgramTestPhraseMatchedTranscript);
    }

    /// <summary>
    /// Returns true if CreateGeneralProgramTestPhraseMatchedTranscript instances are equal
    /// </summary>
    /// <param name="other">Instance of CreateGeneralProgramTestPhraseMatchedTranscript to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(CreateGeneralProgramTestPhraseMatchedTranscript other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
