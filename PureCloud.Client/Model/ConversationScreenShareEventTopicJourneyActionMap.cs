...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationScreenShareEventTopicJourneyActionMap :  IEquatable<ConversationScreenShareEventTopicJourneyActionMap>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationScreenShareEventTopicJourneyActionMap" /> class.
        /// </summary>
        ...
        public ConversationScreenShareEventTopicJourneyActionMap(string Id = null, long? Version = null)
        {
            this.Id = Id;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationScreenShareEventTopicJourneyActionMap);
        }

        /// <summary>
        /// Returns true if ConversationScreenShareEventTopicJourneyActionMap instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationScreenShareEventTopicJourneyActionMap to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationScreenShareEventTopicJourneyActionMap other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
