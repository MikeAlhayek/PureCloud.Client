...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OutboundMessagingEmailCampaignConfigChangeFromEmailAddress :  IEquatable<OutboundMessagingEmailCampaignConfigChangeFromEmailAddress>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OutboundMessagingEmailCampaignConfigChangeFromEmailAddress" /> class.
        /// </summary>
        ...
        public OutboundMessagingEmailCampaignConfigChangeFromEmailAddress(string FriendlyName = null, string LocalPart = null, OutboundMessagingEmailCampaignConfigChangeUriReference Domain = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as OutboundMessagingEmailCampaignConfigChangeFromEmailAddress);
        }

        /// <summary>
        /// Returns true if OutboundMessagingEmailCampaignConfigChangeFromEmailAddress instances are equal
        /// </summary>
        /// <param name="other">Instance of OutboundMessagingEmailCampaignConfigChangeFromEmailAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OutboundMessagingEmailCampaignConfigChangeFromEmailAddress other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
