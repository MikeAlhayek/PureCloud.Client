...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueueConversationMessageEventTopicMessageConversation :  IEquatable<QueueConversationMessageEventTopicMessageConversation>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueConversationMessageEventTopicMessageConversation" /> class.
        /// </summary>
        ...
        public QueueConversationMessageEventTopicMessageConversation(string Id = null, string Name = null, List<QueueConversationMessageEventTopicMessageMediaParticipant> Participants = null, List<string> OtherMediaUris = null, string Address = null, string UtilizationLabelId = null, List<QueueConversationMessageEventTopicConversationDivisionMembership> Divisions = null)
        {
            this.Id = Id;
            this.Name = Name;
        ...
        public List<QueueConversationMessageEventTopicMessageMediaParticipant> Participants { get; set; }
        ...
        public List<QueueConversationMessageEventTopicConversationDivisionMembership> Divisions { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationMessageEventTopicMessageConversation);
        }

        /// <summary>
        /// Returns true if QueueConversationMessageEventTopicMessageConversation instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationMessageEventTopicMessageConversation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationMessageEventTopicMessageConversation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
