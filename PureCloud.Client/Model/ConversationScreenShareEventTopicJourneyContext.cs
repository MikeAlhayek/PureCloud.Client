...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationScreenShareEventTopicJourneyContext :  IEquatable<ConversationScreenShareEventTopicJourneyContext>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationScreenShareEventTopicJourneyContext" /> class.
        /// </summary>
        /// <param name="Customer">Customer.</param>
        /// <param name="CustomerSession">CustomerSession.</param>
        /// <param name="TriggeringAction">TriggeringAction.</param>
        public ConversationScreenShareEventTopicJourneyContext(ConversationScreenShareEventTopicJourneyCustomer Customer = null, ConversationScreenShareEventTopicJourneyCustomerSession CustomerSession = null, ConversationScreenShareEventTopicJourneyAction TriggeringAction = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationScreenShareEventTopicJourneyContext);
        }

        /// <summary>
        /// Returns true if ConversationScreenShareEventTopicJourneyContext instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationScreenShareEventTopicJourneyContext to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationScreenShareEventTopicJourneyContext other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
