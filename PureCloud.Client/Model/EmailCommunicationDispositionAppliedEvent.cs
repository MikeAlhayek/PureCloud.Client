...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class EmailCommunicationDispositionAppliedEvent :  IEquatable<EmailCommunicationDispositionAppliedEvent>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailCommunicationDispositionAppliedEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EmailCommunicationDispositionAppliedEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailCommunicationDispositionAppliedEvent" /> class.
        /// </summary>
        ...
        public EmailCommunicationDispositionAppliedEvent(string EventId = null, DateTime? EventDateTime = null, string ConversationId = null, string CommunicationId = null, string Code = null, string Notes = null, List<string> Tags = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EmailCommunicationDispositionAppliedEvent);
        }

        /// <summary>
        /// Returns true if EmailCommunicationDispositionAppliedEvent instances are equal
        /// </summary>
        /// <param name="other">Instance of EmailCommunicationDispositionAppliedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailCommunicationDispositionAppliedEvent other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
