...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueueConversationCallEventTopicConversationRoutingData :  IEquatable<QueueConversationCallEventTopicConversationRoutingData>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueConversationCallEventTopicConversationRoutingData" /> class.
        /// </summary>
        ...
        public QueueConversationCallEventTopicConversationRoutingData(QueueConversationCallEventTopicUriReference Queue = null, QueueConversationCallEventTopicUriReference Language = null, long? Priority = null, List<QueueConversationCallEventTopicUriReference> Skills = null, List<QueueConversationCallEventTopicScoredAgent> ScoredAgents = null)
        {
            this.Queue = Queue;
        ...
        public List<QueueConversationCallEventTopicUriReference> Skills { get; set; }
        ...
        public List<QueueConversationCallEventTopicScoredAgent> ScoredAgents { get; set; }
        ...
        /// <summary>
        /// Returns true if QueueConversationCallEventTopicConversationRoutingData instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationCallEventTopicConversationRoutingData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationCallEventTopicConversationRoutingData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
