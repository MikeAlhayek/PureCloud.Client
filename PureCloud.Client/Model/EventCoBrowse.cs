...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EventCoBrowse :  IEquatable<EventCoBrowse>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EventCoBrowse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EventCoBrowse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EventCoBrowse" /> class.
        /// </summary>
        ...
        public EventCoBrowse(TypeEnum? Type = null, string SessionId = null, string SessionJoinToken = null)
        {
            this.Type = Type;
        ...
        /// <summary>
        /// Returns true if EventCoBrowse instances are equal
        /// </summary>
        /// <param name="other">Instance of EventCoBrowse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventCoBrowse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
