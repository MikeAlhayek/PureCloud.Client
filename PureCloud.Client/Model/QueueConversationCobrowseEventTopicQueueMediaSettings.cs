...
{
    /// <summary>
    /// QueueConversationCobrowseEventTopicQueueMediaSettings
    /// </summary>
    [DataContract]
    public partial class QueueConversationCobrowseEventTopicQueueMediaSettings :  IEquatable<QueueConversationCobrowseEventTopicQueueMediaSettings>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueConversationCobrowseEventTopicQueueMediaSettings" /> class.
        /// </summary>
        ...
        public QueueConversationCobrowseEventTopicQueueMediaSettings(long? AlertingTimeoutSeconds = null, double? AutoAnswerAlertToneSeconds = null, double? ManualAnswerAlertToneSeconds = null, bool? EnableAutoAnswer = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QueueConversationCobrowseEventTopicQueueMediaSettings {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationCobrowseEventTopicQueueMediaSettings);
        }

        /// <summary>
        /// Returns true if QueueConversationCobrowseEventTopicQueueMediaSettings instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationCobrowseEventTopicQueueMediaSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationCobrowseEventTopicQueueMediaSettings other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
