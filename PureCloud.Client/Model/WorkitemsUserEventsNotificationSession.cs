...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WorkitemsUserEventsNotificationSession :  IEquatable<WorkitemsUserEventsNotificationSession>
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkitemsUserEventsNotificationSession" /> class.
        /// </summary>
        ...
        public List<WorkitemsUserEventsNotificationAssignmentSegment> AssignmentSegments { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as WorkitemsUserEventsNotificationSession);
        }

        /// <summary>
        /// Returns true if WorkitemsUserEventsNotificationSession instances are equal
        /// </summary>
        /// <param name="other">Instance of WorkitemsUserEventsNotificationSession to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkitemsUserEventsNotificationSession other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
