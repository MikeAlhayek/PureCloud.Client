...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueConversationCallEventTopicJourneyActionMap" /> class.
        /// </summary>
        ...
        public QueueConversationCallEventTopicJourneyActionMap(string Id = null, long? Version = null)
        {
            this.Id = Id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QueueConversationCallEventTopicJourneyActionMap {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationCallEventTopicJourneyActionMap);
        }

        /// <summary>
        /// Returns true if QueueConversationCallEventTopicJourneyActionMap instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationCallEventTopicJourneyActionMap to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationCallEventTopicJourneyActionMap other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
