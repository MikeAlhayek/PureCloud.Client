...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomerInteractionCenter :  IEquatable<CustomerInteractionCenter>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerInteractionCenter" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Returns true if CustomerInteractionCenter instances are equal
        /// </summary>
        /// <param name="other">Instance of CustomerInteractionCenter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomerInteractionCenter other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
