...
/// </summary>
[DataContract]
public partial class ActionAggregateQueryFilter : IEquatable<ActionAggregateQueryFilter>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ActionAggregateQueryFilter" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected ActionAggregateQueryFilter() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="ActionAggregateQueryFilter" /> class.
    /// </summary>
    ...
    public ActionAggregateQueryFilter(TypeEnum? Type = null, List<ActionAggregateQueryClause> Clauses = null, List<ActionAggregateQueryPredicate> Predicates = null)
    {
        this.Type = Type;
    ...
    public List<ActionAggregateQueryClause> Clauses { get; set; }
    ...
    public List<ActionAggregateQueryPredicate> Predicates { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ActionAggregateQueryFilter {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ActionAggregateQueryFilter);
    }

    /// <summary>
    /// Returns true if ActionAggregateQueryFilter instances are equal
    /// </summary>
    /// <param name="other">Instance of ActionAggregateQueryFilter to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ActionAggregateQueryFilter other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
