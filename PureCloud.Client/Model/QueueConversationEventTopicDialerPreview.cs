...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueConversationEventTopicDialerPreview" /> class.
        /// </summary>
        ...
        public QueueConversationEventTopicDialerPreview(string Id = null, string ContactId = null, string ContactListId = null, string CampaignId = null, List<QueueConversationEventTopicPhoneNumberColumn> PhoneNumberColumns = null)
        {
            this.Id = Id;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationEventTopicDialerPreview);
        }

        /// <summary>
        /// Returns true if QueueConversationEventTopicDialerPreview instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationEventTopicDialerPreview to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationEventTopicDialerPreview other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
