...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueueConversationSocialExpressionEventTopicAttachment :  IEquatable<QueueConversationSocialExpressionEventTopicAttachment>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueConversationSocialExpressionEventTopicAttachment" /> class.
        /// </summary>
        ...
        public QueueConversationSocialExpressionEventTopicAttachment(string AttachmentId = null, string Name = null, string ContentUri = null, string ContentType = null, long? ContentLength = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationSocialExpressionEventTopicAttachment);
        }

        /// <summary>
        /// Returns true if QueueConversationSocialExpressionEventTopicAttachment instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationSocialExpressionEventTopicAttachment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationSocialExpressionEventTopicAttachment other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
