...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class EmailMessagePreview :  IEquatable<EmailMessagePreview>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailMessagePreview" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EmailMessagePreview() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailMessagePreview" /> class.
        /// </summary>
        ...
        /// <param name="TextBodyPreview">A truncated version of the textBody.</param>
        ...
        public EmailMessagePreview(string Name = null, List<EmailAddress> To = null, List<EmailAddress> Cc = null, List<EmailAddress> Bcc = null, EmailAddress From = null, EmailAddress ReplyTo = null, string Subject = null, List<Attachment> Attachments = null, string TextBodyPreview = null, DateTime? Time = null, bool? HistoryIncluded = null, StateEnum? State = null, DraftTypeEnum? DraftType = null)
        {
            this.Name = Name;
            this.To = To;
            this.Cc = Cc;
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TextBodyPreview: ").Append(TextBodyPreview).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EmailMessagePreview);
        }

        /// <summary>
        /// Returns true if EmailMessagePreview instances are equal
        /// </summary>
        /// <param name="other">Instance of EmailMessagePreview to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailMessagePreview other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return true &&
                ...
                (
                    this.TextBodyPreview == other.TextBodyPreview ||
                    this.TextBodyPreview != null &&
                    this.TextBodyPreview.Equals(other.TextBodyPreview)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TextBodyPreview != null)
                    hash = hash * 59 + this.TextBodyPreview.GetHashCode();
