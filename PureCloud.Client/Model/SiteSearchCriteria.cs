...
public partial class SiteSearchCriteria : IEquatable<SiteSearchCriteria>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SiteSearchCriteria" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected SiteSearchCriteria() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="SiteSearchCriteria" /> class.
    /// </summary>
    ...
    public override string ToString()
    {
        ...
        sb.Append("class SiteSearchCriteria {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as SiteSearchCriteria);
    }

    /// <summary>
    /// Returns true if SiteSearchCriteria instances are equal
    /// </summary>
    /// <param name="other">Instance of SiteSearchCriteria to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(SiteSearchCriteria other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
