...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueueConversationCobrowseEventTopicScoredAgent :  IEquatable<QueueConversationCobrowseEventTopicScoredAgent>
    {
        /// <summary>
        ...
        public QueueConversationCobrowseEventTopicUriReference Agent { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationCobrowseEventTopicScoredAgent);
        }

        /// <summary>
        /// Returns true if QueueConversationCobrowseEventTopicScoredAgent instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationCobrowseEventTopicScoredAgent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationCobrowseEventTopicScoredAgent other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
