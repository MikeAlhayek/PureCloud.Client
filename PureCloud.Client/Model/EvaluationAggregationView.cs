...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EvaluationAggregationView :  IEquatable<EvaluationAggregationView>
    {
        /// <summary>
        /// Target metric name
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EvaluationAggregationView" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EvaluationAggregationView() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EvaluationAggregationView" /> class.
        /// </summary>
        ...
        public EvaluationAggregationView(TargetEnum? Target = null, string Name = null, FunctionEnum? Function = null, AggregationRange Range = null)
        {
            this.Target = Target;
            this.Name = Name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EvaluationAggregationView {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EvaluationAggregationView);
        }

        /// <summary>
        /// Returns true if EvaluationAggregationView instances are equal
        /// </summary>
        /// <param name="other">Instance of EvaluationAggregationView to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EvaluationAggregationView other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
