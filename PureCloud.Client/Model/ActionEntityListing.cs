...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class ActionEntityListing : IEquatable<ActionEntityListing>, IPagedResource<PureCloudPlatform.Client.V2.Model.Action>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActionEntityListing {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ActionEntityListing);
        }

        /// <summary>
        /// Returns true if ActionEntityListing instances are equal
        /// </summary>
        /// <param name="other">Instance of ActionEntityListing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActionEntityListing other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
