...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ScheduleUploadProcessingResponse :  IEquatable<ScheduleUploadProcessingResponse>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ScheduleUploadProcessingResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ScheduleUploadProcessingResponse);
        }

        /// <summary>
        /// Returns true if ScheduleUploadProcessingResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ScheduleUploadProcessingResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScheduleUploadProcessingResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
