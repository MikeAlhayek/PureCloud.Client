...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PerformancePredictionRecalculationUploadResponse :  IEquatable<PerformancePredictionRecalculationUploadResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PerformancePredictionRecalculationUploadResponse" /> class.
        /// </summary>
        ...
        public PerformancePredictionRecalculationUploadResponse(string UploadKey = null, string Url = null, Dictionary<string, string> Headers = null, PerformancePredictionUploadSchema UploadBodySchema = null)
        {
        ...
        public PerformancePredictionUploadSchema UploadBodySchema { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PerformancePredictionRecalculationUploadResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PerformancePredictionRecalculationUploadResponse);
        }

        /// <summary>
        /// Returns true if PerformancePredictionRecalculationUploadResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PerformancePredictionRecalculationUploadResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PerformancePredictionRecalculationUploadResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
