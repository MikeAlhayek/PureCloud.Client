...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WorkitemsUserEventsNotificationAssignmentSegment :  IEquatable<WorkitemsUserEventsNotificationAssignmentSegment>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkitemsUserEventsNotificationAssignmentSegment" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WorkitemsUserEventsNotificationAssignmentSegment {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as WorkitemsUserEventsNotificationAssignmentSegment);
        }

        /// <summary>
        /// Returns true if WorkitemsUserEventsNotificationAssignmentSegment instances are equal
        /// </summary>
        /// <param name="other">Instance of WorkitemsUserEventsNotificationAssignmentSegment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkitemsUserEventsNotificationAssignmentSegment other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
