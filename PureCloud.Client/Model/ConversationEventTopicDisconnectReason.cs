...
/// </summary>
[DataContract]
public partial class ConversationEventTopicDisconnectReason : IEquatable<ConversationEventTopicDisconnectReason>
{
    /// <summary>
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ConversationEventTopicDisconnectReason {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationEventTopicDisconnectReason);
    }

    /// <summary>
    /// Returns true if ConversationEventTopicDisconnectReason instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationEventTopicDisconnectReason to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationEventTopicDisconnectReason other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
