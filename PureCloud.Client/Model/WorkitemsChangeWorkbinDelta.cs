...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkitemsChangeWorkbinDelta" /> class.
        /// </summary>
        /// <param name="Version">Version.</param>
        /// <param name="ModifiedBy">modifiedBy.</param>
        /// <param name="Delta">The changes that originated this version.</param>
        public WorkitemsChangeWorkbinDelta(int? Version = null, UserReference ModifiedBy = null, WorkbinDelta Delta = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as WorkitemsChangeWorkbinDelta);
        }

        /// <summary>
        /// Returns true if WorkitemsChangeWorkbinDelta instances are equal
        /// </summary>
        /// <param name="other">Instance of WorkitemsChangeWorkbinDelta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkitemsChangeWorkbinDelta other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
