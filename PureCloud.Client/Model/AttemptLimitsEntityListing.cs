...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class AttemptLimitsEntityListing : IEquatable<AttemptLimitsEntityListing>, IPagedResource<AttemptLimits>
    {
        ...
        public AttemptLimitsEntityListing(List<AttemptLimits> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
        {
        ...
        public List<AttemptLimits> Entities { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AttemptLimitsEntityListing {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AttemptLimitsEntityListing);
        }

        /// <summary>
        /// Returns true if AttemptLimitsEntityListing instances are equal
        /// </summary>
        /// <param name="other">Instance of AttemptLimitsEntityListing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AttemptLimitsEntityListing other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
