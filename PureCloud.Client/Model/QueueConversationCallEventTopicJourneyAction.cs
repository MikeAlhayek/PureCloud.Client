...
/// </summary>
[DataContract]
public partial class QueueConversationCallEventTopicJourneyAction : IEquatable<QueueConversationCallEventTopicJourneyAction>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="QueueConversationCallEventTopicJourneyAction" /> class.
    /// </summary>
    ...
    public QueueConversationCallEventTopicJourneyAction(string Id = null, QueueConversationCallEventTopicJourneyActionMap ActionMap = null)
    {
        this.Id = Id;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationCallEventTopicJourneyAction);
    }

    /// <summary>
    /// Returns true if QueueConversationCallEventTopicJourneyAction instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationCallEventTopicJourneyAction to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationCallEventTopicJourneyAction other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
