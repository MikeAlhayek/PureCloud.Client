...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NoteListing :  IEquatable<NoteListing>, IPagedResource<Note>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NoteListing" /> class.
        /// </summary>
        ...
        public NoteListing(List<Note> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, bool? PartialResults = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as NoteListing);
        }

        /// <summary>
        /// Returns true if NoteListing instances are equal
        /// </summary>
        /// <param name="other">Instance of NoteListing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NoteListing other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
