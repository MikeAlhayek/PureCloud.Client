...
/// </summary>
[DataContract]
public partial class QueueConversationSocialExpressionEventTopicTransferResponse : IEquatable<QueueConversationSocialExpressionEventTopicTransferResponse>
{
    /// <summary>
    /// Gets or Sets State
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="QueueConversationSocialExpressionEventTopicTransferResponse" /> class.
    /// </summary>
    ...
    public QueueConversationSocialExpressionEventTopicTransferResponse(string Id = null, StateEnum? State = null, DateTime? DateIssued = null, QueueConversationSocialExpressionEventTopicTransferInitiator Initiator = null, QueueConversationSocialExpressionEventTopicTransferModifedBy ModifiedBy = null, QueueConversationSocialExpressionEventTopicTransferDestination Destination = null, TransferTypeEnum? TransferType = null)
    {
        this.Id = Id;
        this.State = State;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationSocialExpressionEventTopicTransferResponse);
    }

    /// <summary>
    /// Returns true if QueueConversationSocialExpressionEventTopicTransferResponse instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationSocialExpressionEventTopicTransferResponse to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationSocialExpressionEventTopicTransferResponse other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
