...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class JourneyAppEventsNotificationSegmentAssignmentMessage :  IEquatable<JourneyAppEventsNotificationSegmentAssignmentMessage>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as JourneyAppEventsNotificationSegmentAssignmentMessage);
        }

        /// <summary>
        /// Returns true if JourneyAppEventsNotificationSegmentAssignmentMessage instances are equal
        /// </summary>
        /// <param name="other">Instance of JourneyAppEventsNotificationSegmentAssignmentMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JourneyAppEventsNotificationSegmentAssignmentMessage other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
