...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ActionAggregationQuery : IEquatable<ActionAggregationQuery>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ActionAggregationQuery" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ActionAggregationQuery() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ActionAggregationQuery" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActionAggregationQuery {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ActionAggregationQuery);
        }

        /// <summary>
        /// Returns true if ActionAggregationQuery instances are equal
        /// </summary>
        /// <param name="other">Instance of ActionAggregationQuery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActionAggregationQuery other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
