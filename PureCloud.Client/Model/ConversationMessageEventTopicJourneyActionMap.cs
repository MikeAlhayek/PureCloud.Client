...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationMessageEventTopicJourneyActionMap :  IEquatable<ConversationMessageEventTopicJourneyActionMap>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationMessageEventTopicJourneyActionMap" /> class.
        /// </summary>
        ...
        public ConversationMessageEventTopicJourneyActionMap(string Id = null, long? Version = null)
        {
            this.Id = Id;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationMessageEventTopicJourneyActionMap);
        }

        /// <summary>
        /// Returns true if ConversationMessageEventTopicJourneyActionMap instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationMessageEventTopicJourneyActionMap to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationMessageEventTopicJourneyActionMap other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
