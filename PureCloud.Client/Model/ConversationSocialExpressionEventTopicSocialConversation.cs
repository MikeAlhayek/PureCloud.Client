...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationSocialExpressionEventTopicSocialConversation" /> class.
    /// </summary>
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ConversationSocialExpressionEventTopicSocialConversation {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationSocialExpressionEventTopicSocialConversation);
    }

    /// <summary>
    /// Returns true if ConversationSocialExpressionEventTopicSocialConversation instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationSocialExpressionEventTopicSocialConversation to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationSocialExpressionEventTopicSocialConversation other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
