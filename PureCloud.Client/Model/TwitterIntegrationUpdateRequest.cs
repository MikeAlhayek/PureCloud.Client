...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TwitterIntegrationUpdateRequest :  IEquatable<TwitterIntegrationUpdateRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TwitterIntegrationUpdateRequest" /> class.
        /// </summary>
        /// <param name="Name">The name of the Twitter messaging integration..</param>
        ...
        /// <param name="SignupCode">The authorization code returned from the signup flow to request access tokens later on.</param>
        /// <param name="CodeChallenge">The codeChallenge used during the signup flow.</param>
        /// <param name="RedirectUri">The redirectUri used during the signup flow.</param>
        public TwitterIntegrationUpdateRequest(string Name = null, SupportedContentReference SupportedContent = null, MessagingSettingRequestReference MessagingSetting = null, string SignupCode = null, string CodeChallenge = null, string RedirectUri = null)
        {
            this.Name = Name;
        ...
        /// </summary>
        /// <value>The name of the Twitter messaging integration.</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TwitterIntegrationUpdateRequest);
        }

        /// <summary>
        /// Returns true if TwitterIntegrationUpdateRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of TwitterIntegrationUpdateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TwitterIntegrationUpdateRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
