...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FlowActivityData :  IEquatable<FlowActivityData>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FlowActivityData" /> class.
        /// </summary>
        ...
        public FlowActivityData(Dictionary<string, string> Group = null, List<FlowActivityMetricValue> Data = null, bool? Truncated = null, List<FlowActivityEntityData> Entities = null)
        {
            this.Group = Group;
            this.Data = Data;
        ...
        public List<FlowActivityMetricValue> Data { get; set; }
        ...
        public List<FlowActivityEntityData> Entities { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FlowActivityData);
        }

        /// <summary>
        /// Returns true if FlowActivityData instances are equal
        /// </summary>
        /// <param name="other">Instance of FlowActivityData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlowActivityData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
