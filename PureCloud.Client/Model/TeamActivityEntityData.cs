...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TeamActivityEntityData :  IEquatable<TeamActivityEntityData>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="TeamActivityEntityData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TeamActivityEntityData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamActivityEntityData" /> class.
        /// </summary>
        ...
        public TeamActivityEntityData(DateTime? ActivityDate = null, string OrganizationPresenceId = null, DateTime? PresenceDate = null, string QueueId = null, string QueueMembershipStatus = null, string RoutingStatus = null, DateTime? RoutingStatusDate = null, string SystemPresence = null, string TeamId = null, string UserId = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TeamActivityEntityData);
        }

        /// <summary>
        /// Returns true if TeamActivityEntityData instances are equal
        /// </summary>
        /// <param name="other">Instance of TeamActivityEntityData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TeamActivityEntityData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
