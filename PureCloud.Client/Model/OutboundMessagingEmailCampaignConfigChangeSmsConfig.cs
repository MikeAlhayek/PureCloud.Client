...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OutboundMessagingEmailCampaignConfigChangeSmsConfig" /> class.
        /// </summary>
        ...
        public OutboundMessagingEmailCampaignConfigChangeSmsConfig(string MessageColumn = null, string PhoneColumn = null, OutboundMessagingEmailCampaignConfigChangeSmsPhoneNumberRef SenderSmsPhoneNumber = null, OutboundMessagingEmailCampaignConfigChangeResponseRef ContentTemplate = null)
        {
        ...
        /// <summary>
        /// Returns true if OutboundMessagingEmailCampaignConfigChangeSmsConfig instances are equal
        /// </summary>
        /// <param name="other">Instance of OutboundMessagingEmailCampaignConfigChangeSmsConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OutboundMessagingEmailCampaignConfigChangeSmsConfig other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
