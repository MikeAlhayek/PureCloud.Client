...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessagingHoldUpdatedEvent :  IEquatable<MessagingHoldUpdatedEvent>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="MessagingHoldUpdatedEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MessagingHoldUpdatedEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessagingHoldUpdatedEvent" /> class.
        /// </summary>
        ...
        public MessagingHoldUpdatedEvent(string EventId = null, DateTime? EventDateTime = null, string ConversationId = null, string CommunicationId = null, bool? Held = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MessagingHoldUpdatedEvent {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MessagingHoldUpdatedEvent);
        }

        /// <summary>
        /// Returns true if MessagingHoldUpdatedEvent instances are equal
        /// </summary>
        /// <param name="other">Instance of MessagingHoldUpdatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessagingHoldUpdatedEvent other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
