...
{
    /// <summary>
    /// ConversationCallbackEventTopicLimit
    /// </summary>
    [DataContract]
    public partial class ConversationCallbackEventTopicLimit :  IEquatable<ConversationCallbackEventTopicLimit>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationCallbackEventTopicLimit" /> class.
        /// </summary>
        /// <param name="Key">Key.</param>
        /// <param name="Namespace">Namespace.</param>
        /// <param name="Value">Value.</param>
        /// <param name="Documented">Documented.</param>
        public ConversationCallbackEventTopicLimit(string Key = null, NamespaceEnum? Namespace = null, long? Value = null, bool? Documented = null)
        {
            this.Key = Key;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConversationCallbackEventTopicLimit {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationCallbackEventTopicLimit);
        }

        /// <summary>
        /// Returns true if ConversationCallbackEventTopicLimit instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationCallbackEventTopicLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationCallbackEventTopicLimit other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
