...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactDetailEventTopicContactUpdateEvent :  IEquatable<ContactDetailEventTopicContactUpdateEvent>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactDetailEventTopicContactUpdateEvent" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactDetailEventTopicContactUpdateEvent {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ContactDetailEventTopicContactUpdateEvent);
        }

        /// <summary>
        /// Returns true if ContactDetailEventTopicContactUpdateEvent instances are equal
        /// </summary>
        /// <param name="other">Instance of ContactDetailEventTopicContactUpdateEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactDetailEventTopicContactUpdateEvent other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
