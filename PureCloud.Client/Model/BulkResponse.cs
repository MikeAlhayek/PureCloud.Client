...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BulkResponse : IEquatable<BulkResponse>
    {
        /// <summary>
        ...
        public BulkResponse(List<BulkResult> Results = null, int? ErrorCount = null, List<int?> ErrorIndexes = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BulkResponse);
        }

        /// <summary>
        /// Returns true if BulkResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of BulkResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
