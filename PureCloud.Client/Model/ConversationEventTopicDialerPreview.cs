...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class ConversationEventTopicDialerPreview :  IEquatable<ConversationEventTopicDialerPreview>
    {
        ...
        public ConversationEventTopicDialerPreview(string Id = null, string ContactId = null, string ContactListId = null, string CampaignId = null, List<ConversationEventTopicPhoneNumberColumn> PhoneNumberColumns = null)
        {
            this.Id = Id;
        ...
        /// <summary>
        /// Returns true if ConversationEventTopicDialerPreview instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationEventTopicDialerPreview to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationEventTopicDialerPreview other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
