...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageSticker :  IEquatable<MessageSticker>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MessageSticker);
        }

        /// <summary>
        /// Returns true if MessageSticker instances are equal
        /// </summary>
        /// <param name="other">Instance of MessageSticker to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageSticker other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
