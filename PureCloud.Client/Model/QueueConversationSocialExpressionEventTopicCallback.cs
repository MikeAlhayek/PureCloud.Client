...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class QueueConversationSocialExpressionEventTopicCallback :  IEquatable<QueueConversationSocialExpressionEventTopicCallback>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationSocialExpressionEventTopicCallback);
        }

        /// <summary>
        /// Returns true if QueueConversationSocialExpressionEventTopicCallback instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationSocialExpressionEventTopicCallback to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationSocialExpressionEventTopicCallback other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
