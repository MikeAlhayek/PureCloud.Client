...
/// </summary>
[DataContract]
public partial class OpenDataIngestionRuleVersionResponse : IEquatable<OpenDataIngestionRuleVersionResponse>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="OpenDataIngestionRuleVersionResponse" /> class.
    /// </summary>
    ...
    public OpenDataIngestionRuleVersionResponse(string Id = null, string Name = null, string Description = null, StatusEnum? Status = null, int? Version = null, DomainEntityRef ExternalSource = null)
    {
        this.Id = Id;
        this.Name = Name;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as OpenDataIngestionRuleVersionResponse);
    }

    /// <summary>
    /// Returns true if OpenDataIngestionRuleVersionResponse instances are equal
    /// </summary>
    /// <param name="other">Instance of OpenDataIngestionRuleVersionResponse to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(OpenDataIngestionRuleVersionResponse other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
