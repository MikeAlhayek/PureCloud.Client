...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class ConversationEventTopicCall :  IEquatable<ConversationEventTopicCall>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationEventTopicCall);
        }

        /// <summary>
        /// Returns true if ConversationEventTopicCall instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationEventTopicCall to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationEventTopicCall other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
