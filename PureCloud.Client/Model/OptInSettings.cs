...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OptInSettings :  IEquatable<OptInSettings>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="OptInSettings" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OptInSettings() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OptInSettings" /> class.
        /// </summary>
        ...
        public OptInSettings(List<string> Keyword = null, ComplianceResponse Response = null)
        {
        ...
        /// <summary>
        /// Returns true if OptInSettings instances are equal
        /// </summary>
        /// <param name="other">Instance of OptInSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptInSettings other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
