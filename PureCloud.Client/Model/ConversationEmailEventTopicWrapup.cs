...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationEmailEventTopicWrapup :  IEquatable<ConversationEmailEventTopicWrapup>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationEmailEventTopicWrapup" /> class.
        /// </summary>
        ...
        public ConversationEmailEventTopicWrapup(string Code = null, string Notes = null, List<string> Tags = null, long? DurationSeconds = null, DateTime? EndTime = null)
        {
            this.Code = Code;
            this.Notes = Notes;
            this.Tags = Tags;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConversationEmailEventTopicWrapup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationEmailEventTopicWrapup);
        }

        /// <summary>
        /// Returns true if ConversationEmailEventTopicWrapup instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationEmailEventTopicWrapup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationEmailEventTopicWrapup other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
