...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserAggregateQueryFilter :  IEquatable<UserAggregateQueryFilter>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserAggregateQueryFilter" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UserAggregateQueryFilter() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UserAggregateQueryFilter" /> class.
        /// </summary>
        ...
        public UserAggregateQueryFilter(TypeEnum? Type = null, List<UserAggregateQueryClause> Clauses = null, List<UserAggregateQueryPredicate> Predicates = null)
        {
            this.Type = Type;
        ...
        public List<UserAggregateQueryClause> Clauses { get; set; }
        ...
        public List<UserAggregateQueryPredicate> Predicates { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserAggregateQueryFilter {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UserAggregateQueryFilter);
        }

        /// <summary>
        /// Returns true if UserAggregateQueryFilter instances are equal
        /// </summary>
        /// <param name="other">Instance of UserAggregateQueryFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserAggregateQueryFilter other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
