...
public partial class WebMessagingButtonResponse : IEquatable<WebMessagingButtonResponse>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="WebMessagingButtonResponse" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected WebMessagingButtonResponse() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="WebMessagingButtonResponse" /> class.
    /// </summary>
    ...
    /// <summary>
    /// Returns true if WebMessagingButtonResponse instances are equal
    /// </summary>
    /// <param name="other">Instance of WebMessagingButtonResponse to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(WebMessagingButtonResponse other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
