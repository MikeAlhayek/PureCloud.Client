...
/// </summary>
[DataContract]
public partial class PhoneTransferEvent : IEquatable<PhoneTransferEvent>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PhoneTransferEvent" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected PhoneTransferEvent() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="PhoneTransferEvent" /> class.
    /// </summary>
    ...
    /// <param name="DestinationPhoneNumber">The desired destination phone number that the object communication should be transferred to. (required).</param>
    public PhoneTransferEvent(string EventId = null, DateTime? EventDateTime = null, string ConversationId = null, TransferTypeEnum? TransferType = null, string CommandId = null, string InitiatingCommunicationId = null, string TargetCommunicationId = null, string ObjectCommunicationId = null, string DestinationPhoneNumber = null)
    {
    ...
    /// </summary>
    /// <value>The desired destination phone number that the object communication should be transferred to.</value>
    [DataMember(Name = "destinationPhoneNumber", EmitDefaultValue = false)]
    ...
    public override string ToString()
    {
        ...
        sb.Append("  DestinationPhoneNumber: ").Append(DestinationPhoneNumber).Append("\n");
        sb.Append("}\n");
        return sb.ToString();
    }
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as PhoneTransferEvent);
    }

    /// <summary>
    /// Returns true if PhoneTransferEvent instances are equal
    /// </summary>
    /// <param name="other">Instance of PhoneTransferEvent to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(PhoneTransferEvent other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
        ...
        return true &&
            ...
            (
                this.DestinationPhoneNumber == other.DestinationPhoneNumber ||
                this.DestinationPhoneNumber != null &&
                this.DestinationPhoneNumber.Equals(other.DestinationPhoneNumber)
            );
    }
    ...
    public override int GetHashCode()
    {
        ...
        unchecked // Overflow is fine, just wrap
        {
            ...
            if (this.DestinationPhoneNumber != null)
            {
                hash = hash * 59 + this.DestinationPhoneNumber.GetHashCode();
            }
