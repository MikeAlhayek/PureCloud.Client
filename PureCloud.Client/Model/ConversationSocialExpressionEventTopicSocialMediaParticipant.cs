...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class ConversationSocialExpressionEventTopicSocialMediaParticipant :  IEquatable<ConversationSocialExpressionEventTopicSocialMediaParticipant>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationSocialExpressionEventTopicSocialMediaParticipant);
        }

        /// <summary>
        /// Returns true if ConversationSocialExpressionEventTopicSocialMediaParticipant instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationSocialExpressionEventTopicSocialMediaParticipant to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationSocialExpressionEventTopicSocialMediaParticipant other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
