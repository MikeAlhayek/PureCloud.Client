...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentManagementSingleDocumentTopicLockData" /> class.
        /// </summary>
        /// <param name="LockedBy">LockedBy.</param>
        /// <param name="DateCreated">DateCreated.</param>
        /// <param name="DateExpires">DateExpires.</param>
        public ContentManagementSingleDocumentTopicLockData(ContentManagementSingleDocumentTopicUserData LockedBy = null, DateTime? DateCreated = null, DateTime? DateExpires = null)
        {
        ...
        /// <summary>
        /// Returns true if ContentManagementSingleDocumentTopicLockData instances are equal
        /// </summary>
        /// <param name="other">Instance of ContentManagementSingleDocumentTopicLockData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContentManagementSingleDocumentTopicLockData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
