...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueueConversationScreenShareEventTopicErrorBody :  IEquatable<QueueConversationScreenShareEventTopicErrorBody>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueConversationScreenShareEventTopicErrorBody" /> class.
        /// </summary>
        ...
        public List<QueueConversationScreenShareEventTopicDetail> Details { get; set; }
        ...
        /// <summary>
        /// Returns true if QueueConversationScreenShareEventTopicErrorBody instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationScreenShareEventTopicErrorBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationScreenShareEventTopicErrorBody other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
