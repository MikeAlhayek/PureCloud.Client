...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ArchitectFlowOutcomeNotificationUser" /> class.
    /// </summary>
    /// <param name="Id">The ID of the user..</param>
    /// <param name="Name">The name of the user, if available..</param>
    /// <param name="HomeOrg">HomeOrg.</param>
    public ArchitectFlowOutcomeNotificationUser(string Id = null, string Name = null, ArchitectFlowOutcomeNotificationHomeOrganization HomeOrg = null)
    {
        this.Id = Id;
        this.Name = Name;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ArchitectFlowOutcomeNotificationUser);
    }

    /// <summary>
    /// Returns true if ArchitectFlowOutcomeNotificationUser instances are equal
    /// </summary>
    /// <param name="other">Instance of ArchitectFlowOutcomeNotificationUser to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ArchitectFlowOutcomeNotificationUser other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
