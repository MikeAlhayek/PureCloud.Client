...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueueConversationVideoEventTopicDialerPreview :  IEquatable<QueueConversationVideoEventTopicDialerPreview>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueConversationVideoEventTopicDialerPreview" /> class.
        /// </summary>
        ...
        public QueueConversationVideoEventTopicDialerPreview(string Id = null, string ContactId = null, string ContactListId = null, string CampaignId = null, List<QueueConversationVideoEventTopicPhoneNumberColumn> PhoneNumberColumns = null)
        {
            this.Id = Id;
        ...
        public List<QueueConversationVideoEventTopicPhoneNumberColumn> PhoneNumberColumns { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationVideoEventTopicDialerPreview);
        }

        /// <summary>
        /// Returns true if QueueConversationVideoEventTopicDialerPreview instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationVideoEventTopicDialerPreview to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationVideoEventTopicDialerPreview other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
