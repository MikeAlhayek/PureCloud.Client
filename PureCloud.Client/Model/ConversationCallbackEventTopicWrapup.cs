...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationCallbackEventTopicWrapup :  IEquatable<ConversationCallbackEventTopicWrapup>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationCallbackEventTopicWrapup" /> class.
        /// </summary>
        ...
        public ConversationCallbackEventTopicWrapup(string Code = null, string Notes = null, List<string> Tags = null, long? DurationSeconds = null, DateTime? EndTime = null)
        {
            this.Code = Code;
            this.Notes = Notes;
            this.Tags = Tags;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConversationCallbackEventTopicWrapup {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationCallbackEventTopicWrapup);
        }

        /// <summary>
        /// Returns true if ConversationCallbackEventTopicWrapup instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationCallbackEventTopicWrapup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationCallbackEventTopicWrapup other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
