...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class ConversationCallbackEventTopicVoicemail :  IEquatable<ConversationCallbackEventTopicVoicemail>
    {
        ...
        public ConversationCallbackEventTopicVoicemail(string Id = null, UploadStatusEnum? UploadStatus = null)
        {
            this.Id = Id;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationCallbackEventTopicVoicemail);
        }

        /// <summary>
        /// Returns true if ConversationCallbackEventTopicVoicemail instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationCallbackEventTopicVoicemail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationCallbackEventTopicVoicemail other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
