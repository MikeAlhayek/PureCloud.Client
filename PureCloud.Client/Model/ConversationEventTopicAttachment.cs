...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationEventTopicAttachment" /> class.
    /// </summary>
    ...
    public ConversationEventTopicAttachment(string AttachmentId = null, string Name = null, string ContentUri = null, string ContentType = null, long? ContentLength = null)
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ConversationEventTopicAttachment {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationEventTopicAttachment);
    }

    /// <summary>
    /// Returns true if ConversationEventTopicAttachment instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationEventTopicAttachment to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationEventTopicAttachment other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
