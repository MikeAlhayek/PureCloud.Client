...
/// </summary>
[DataContract]
public partial class FlowAggregateQueryFilter : IEquatable<FlowAggregateQueryFilter>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="FlowAggregateQueryFilter" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected FlowAggregateQueryFilter() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="FlowAggregateQueryFilter" /> class.
    /// </summary>
    ...
    public FlowAggregateQueryFilter(TypeEnum? Type = null, List<FlowAggregateQueryClause> Clauses = null, List<FlowAggregateQueryPredicate> Predicates = null)
    {
        this.Type = Type;
    ...
    public List<FlowAggregateQueryClause> Clauses { get; set; }
    ...
    public List<FlowAggregateQueryPredicate> Predicates { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class FlowAggregateQueryFilter {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as FlowAggregateQueryFilter);
    }

    /// <summary>
    /// Returns true if FlowAggregateQueryFilter instances are equal
    /// </summary>
    /// <param name="other">Instance of FlowAggregateQueryFilter to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(FlowAggregateQueryFilter other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
