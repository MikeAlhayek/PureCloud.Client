...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2ConversationMessageTypingEventForWorkflowTopicConversationMessagingFromRecipient :  IEquatable<V2ConversationMessageTypingEventForWorkflowTopicConversationMessagingFromRecipient>
    {
        /// <summary>
        /// Gets or Sets IdType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="V2ConversationMessageTypingEventForWorkflowTopicConversationMessagingFromRecipient" /> class.
        /// </summary>
        ...
        public List<V2ConversationMessageTypingEventForWorkflowTopicConversationRecipientAdditionalIdentifier> AdditionalIds { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2ConversationMessageTypingEventForWorkflowTopicConversationMessagingFromRecipient);
        }

        /// <summary>
        /// Returns true if V2ConversationMessageTypingEventForWorkflowTopicConversationMessagingFromRecipient instances are equal
        /// </summary>
        /// <param name="other">Instance of V2ConversationMessageTypingEventForWorkflowTopicConversationMessagingFromRecipient to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2ConversationMessageTypingEventForWorkflowTopicConversationMessagingFromRecipient other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
