...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NluDomainListing :  IEquatable<NluDomainListing>, IPagedResource<NluDomain>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NluDomainListing" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NluDomainListing {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as NluDomainListing);
        }

        /// <summary>
        /// Returns true if NluDomainListing instances are equal
        /// </summary>
        /// <param name="other">Instance of NluDomainListing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NluDomainListing other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
