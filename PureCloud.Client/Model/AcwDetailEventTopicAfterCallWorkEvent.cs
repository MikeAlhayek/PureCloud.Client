...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AcwDetailEventTopicAfterCallWorkEvent : IEquatable<AcwDetailEventTopicAfterCallWorkEvent>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AcwDetailEventTopicAfterCallWorkEvent);
        }

        /// <summary>
        /// Returns true if AcwDetailEventTopicAfterCallWorkEvent instances are equal
        /// </summary>
        /// <param name="other">Instance of AcwDetailEventTopicAfterCallWorkEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AcwDetailEventTopicAfterCallWorkEvent other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
