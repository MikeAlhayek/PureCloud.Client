...
{
    /// <summary>
    /// QueueConversationCobrowseEventTopicLimit
    /// </summary>
    [DataContract]
    public partial class QueueConversationCobrowseEventTopicLimit :  IEquatable<QueueConversationCobrowseEventTopicLimit>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueConversationCobrowseEventTopicLimit" /> class.
        /// </summary>
        /// <param name="Key">Key.</param>
        /// <param name="Namespace">Namespace.</param>
        /// <param name="Value">Value.</param>
        /// <param name="Documented">Documented.</param>
        public QueueConversationCobrowseEventTopicLimit(string Key = null, NamespaceEnum? Namespace = null, long? Value = null, bool? Documented = null)
        {
            this.Key = Key;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QueueConversationCobrowseEventTopicLimit {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationCobrowseEventTopicLimit);
        }

        /// <summary>
        /// Returns true if QueueConversationCobrowseEventTopicLimit instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationCobrowseEventTopicLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationCobrowseEventTopicLimit other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
