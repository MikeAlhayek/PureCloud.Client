...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationMessageEventTopicMessageConversation :  IEquatable<ConversationMessageEventTopicMessageConversation>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationMessageEventTopicMessageConversation" /> class.
        /// </summary>
        ...
        public List<ConversationMessageEventTopicMessageMediaParticipant> Participants { get; set; }
        ...
        public List<ConversationMessageEventTopicConversationDivisionMembership> Divisions { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationMessageEventTopicMessageConversation);
        }

        /// <summary>
        /// Returns true if ConversationMessageEventTopicMessageConversation instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationMessageEventTopicMessageConversation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationMessageEventTopicMessageConversation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
