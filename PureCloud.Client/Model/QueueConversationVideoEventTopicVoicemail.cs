...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueueConversationVideoEventTopicVoicemail :  IEquatable<QueueConversationVideoEventTopicVoicemail>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueConversationVideoEventTopicVoicemail" /> class.
        /// </summary>
        /// <param name="Id">The voicemail id.</param>
        /// <param name="UploadStatus">current state of the voicemail upload.</param>
        public QueueConversationVideoEventTopicVoicemail(string Id = null, UploadStatusEnum? UploadStatus = null)
        {
            this.Id = Id;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationVideoEventTopicVoicemail);
        }

        /// <summary>
        /// Returns true if QueueConversationVideoEventTopicVoicemail instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationVideoEventTopicVoicemail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationVideoEventTopicVoicemail other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
