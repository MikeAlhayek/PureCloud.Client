...
/// </summary>
[DataContract]
public partial class GKNDocumentationSearchResponse : IEquatable<GKNDocumentationSearchResponse>
{

    /// <summary>
    /// Initializes a new instance of the <see cref="GKNDocumentationSearchResponse" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected GKNDocumentationSearchResponse() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="GKNDocumentationSearchResponse" /> class.
    /// </summary>
    ...
    public GKNDocumentationSearchResponse(long? Total = null, int? PageCount = null, int? PageSize = null, int? PageNumber = null, string PreviousPage = null, string CurrentPage = null, string NextPage = null, List<string> Types = null, List<GKNDocumentationResult> Results = null)
    {
        this.Total = Total;
    ...
    public List<GKNDocumentationResult> Results { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as GKNDocumentationSearchResponse);
    }

    /// <summary>
    /// Returns true if GKNDocumentationSearchResponse instances are equal
    /// </summary>
    /// <param name="other">Instance of GKNDocumentationSearchResponse to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(GKNDocumentationSearchResponse other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
