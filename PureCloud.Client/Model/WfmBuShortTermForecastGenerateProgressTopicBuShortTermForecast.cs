...
/// </summary>
[DataContract]
public partial class WfmBuShortTermForecastGenerateProgressTopicBuShortTermForecast : IEquatable<WfmBuShortTermForecastGenerateProgressTopicBuShortTermForecast>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="WfmBuShortTermForecastGenerateProgressTopicBuShortTermForecast" /> class.
    /// </summary>
    ...
    public List<WfmBuShortTermForecastGenerateProgressTopicForecastSourceDayPointer> SourceDays { get; set; }
    ...
    public List<WfmBuShortTermForecastGenerateProgressTopicBuForecastModification> Modifications { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as WfmBuShortTermForecastGenerateProgressTopicBuShortTermForecast);
    }

    /// <summary>
    /// Returns true if WfmBuShortTermForecastGenerateProgressTopicBuShortTermForecast instances are equal
    /// </summary>
    /// <param name="other">Instance of WfmBuShortTermForecastGenerateProgressTopicBuShortTermForecast to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(WfmBuShortTermForecastGenerateProgressTopicBuShortTermForecast other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
