...
/// </summary>
[DataContract]
public partial class ConversationChatEventTopicLimit : IEquatable<ConversationChatEventTopicLimit>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ConversationChatEventTopicLimit" /> class.
    /// </summary>
    /// <param name="Key">Key.</param>
    /// <param name="Namespace">Namespace.</param>
    /// <param name="Value">Value.</param>
    /// <param name="Documented">Documented.</param>
    public ConversationChatEventTopicLimit(string Key = null, NamespaceEnum? Namespace = null, long? Value = null, bool? Documented = null)
    {
        this.Key = Key;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ConversationChatEventTopicLimit {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as ConversationChatEventTopicLimit);
    }

    /// <summary>
    /// Returns true if ConversationChatEventTopicLimit instances are equal
    /// </summary>
    /// <param name="other">Instance of ConversationChatEventTopicLimit to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConversationChatEventTopicLimit other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
