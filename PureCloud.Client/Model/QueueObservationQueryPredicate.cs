...
/// </summary>
[DataContract]
public partial class QueueObservationQueryPredicate : IEquatable<QueueObservationQueryPredicate>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="QueueObservationQueryPredicate" /> class.
    /// </summary>
    ...
    public QueueObservationQueryPredicate(TypeEnum? Type = null, DimensionEnum? Dimension = null, OperatorEnum? Operator = null, string Value = null, NumericRange Range = null)
    {
        this.Type = Type;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class QueueObservationQueryPredicate {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueObservationQueryPredicate);
    }

    /// <summary>
    /// Returns true if QueueObservationQueryPredicate instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueObservationQueryPredicate to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueObservationQueryPredicate other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
