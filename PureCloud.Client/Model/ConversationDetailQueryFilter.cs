...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationDetailQueryFilter :  IEquatable<ConversationDetailQueryFilter>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationDetailQueryFilter" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConversationDetailQueryFilter() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationDetailQueryFilter" /> class.
        /// </summary>
        ...
        public ConversationDetailQueryFilter(TypeEnum? Type = null, List<ConversationDetailQueryClause> Clauses = null, List<ConversationDetailQueryPredicate> Predicates = null)
        {
            this.Type = Type;
        ...
        public List<ConversationDetailQueryClause> Clauses { get; set; }
        ...
        public List<ConversationDetailQueryPredicate> Predicates { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationDetailQueryFilter);
        }

        /// <summary>
        /// Returns true if ConversationDetailQueryFilter instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationDetailQueryFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationDetailQueryFilter other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
