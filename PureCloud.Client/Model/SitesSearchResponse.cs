...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SitesSearchResponse :  IEquatable<SitesSearchResponse>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="SitesSearchResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SitesSearchResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SitesSearchResponse" /> class.
        /// </summary>
        ...
        public SitesSearchResponse(long? Total = null, int? PageCount = null, int? PageSize = null, int? PageNumber = null, string PreviousPage = null, string CurrentPage = null, string NextPage = null, List<string> Types = null, List<Site> Results = null)
        {
            this.Total = Total;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SitesSearchResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SitesSearchResponse);
        }

        /// <summary>
        /// Returns true if SitesSearchResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of SitesSearchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SitesSearchResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
