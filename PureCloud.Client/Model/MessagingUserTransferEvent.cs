...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessagingUserTransferEvent :  IEquatable<MessagingUserTransferEvent>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessagingUserTransferEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MessagingUserTransferEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessagingUserTransferEvent" /> class.
        /// </summary>
        ...
        public MessagingUserTransferEvent(string EventId = null, DateTime? EventDateTime = null, string ConversationId = null, TransferTypeEnum? TransferType = null, string CommandId = null, string InitiatingCommunicationId = null, string TargetCommunicationId = null, string ObjectCommunicationId = null, string DestinationUserId = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MessagingUserTransferEvent {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MessagingUserTransferEvent);
        }

        /// <summary>
        /// Returns true if MessagingUserTransferEvent instances are equal
        /// </summary>
        /// <param name="other">Instance of MessagingUserTransferEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessagingUserTransferEvent other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
