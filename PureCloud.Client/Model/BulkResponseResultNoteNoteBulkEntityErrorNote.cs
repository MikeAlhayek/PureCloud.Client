...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BulkResponseResultNoteNoteBulkEntityErrorNote : IEquatable<BulkResponseResultNoteNoteBulkEntityErrorNote>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkResponseResultNoteNoteBulkEntityErrorNote" /> class.
        /// </summary>
        ...
        public BulkResponseResultNoteNoteBulkEntityErrorNote(string Id = null, bool? Success = null, Note Entity = null, BulkEntityErrorNote Error = null)
        {
            this.Id = Id;
        ...
        public BulkEntityErrorNote Error { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BulkResponseResultNoteNoteBulkEntityErrorNote);
        }

        /// <summary>
        /// Returns true if BulkResponseResultNoteNoteBulkEntityErrorNote instances are equal
        /// </summary>
        /// <param name="other">Instance of BulkResponseResultNoteNoteBulkEntityErrorNote to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkResponseResultNoteNoteBulkEntityErrorNote other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
