...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ChatConversation :  IEquatable<ChatConversation>
    {
        /// <summary>
        ...
        public ChatConversation(string Name = null, List<ChatMediaParticipant> Participants = null, List<string> OtherMediaUris = null, List<TransferResponse> RecentTransfers = null, string UtilizationLabelId = null, List<ConversationDivisionMembership> Divisions = null)
        {
            this.Name = Name;
        ...
        public List<ChatMediaParticipant> Participants { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ChatConversation);
        }

        /// <summary>
        /// Returns true if ChatConversation instances are equal
        /// </summary>
        /// <param name="other">Instance of ChatConversation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChatConversation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
