...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BulkResponseResultExternalOrganizationEntityBulkEntityErrorEntity : IEquatable<BulkResponseResultExternalOrganizationEntityBulkEntityErrorEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkResponseResultExternalOrganizationEntityBulkEntityErrorEntity" /> class.
        /// </summary>
        ...
        public BulkResponseResultExternalOrganizationEntityBulkEntityErrorEntity(string Id = null, bool? Success = null, ExternalOrganization Entity = null, BulkEntityErrorEntity Error = null)
        {
            this.Id = Id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BulkResponseResultExternalOrganizationEntityBulkEntityErrorEntity {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BulkResponseResultExternalOrganizationEntityBulkEntityErrorEntity);
        }

        /// <summary>
        /// Returns true if BulkResponseResultExternalOrganizationEntityBulkEntityErrorEntity instances are equal
        /// </summary>
        /// <param name="other">Instance of BulkResponseResultExternalOrganizationEntityBulkEntityErrorEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkResponseResultExternalOrganizationEntityBulkEntityErrorEntity other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
