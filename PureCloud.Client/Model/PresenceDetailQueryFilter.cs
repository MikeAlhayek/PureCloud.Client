...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class PresenceDetailQueryFilter :  IEquatable<PresenceDetailQueryFilter>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PresenceDetailQueryFilter);
        }

        /// <summary>
        /// Returns true if PresenceDetailQueryFilter instances are equal
        /// </summary>
        /// <param name="other">Instance of PresenceDetailQueryFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PresenceDetailQueryFilter other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
