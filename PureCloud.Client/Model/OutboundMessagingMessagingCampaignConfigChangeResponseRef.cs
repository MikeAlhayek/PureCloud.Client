...
public partial class OutboundMessagingMessagingCampaignConfigChangeResponseRef : IEquatable<OutboundMessagingMessagingCampaignConfigChangeResponseRef>
{
    ...
    public override string ToString()
    {
        ...
        sb.Append("class OutboundMessagingMessagingCampaignConfigChangeResponseRef {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as OutboundMessagingMessagingCampaignConfigChangeResponseRef);
    }

    /// <summary>
    /// Returns true if OutboundMessagingMessagingCampaignConfigChangeResponseRef instances are equal
    /// </summary>
    /// <param name="other">Instance of OutboundMessagingMessagingCampaignConfigChangeResponseRef to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(OutboundMessagingMessagingCampaignConfigChangeResponseRef other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
