...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class QueueConversationVideoEventTopicDisconnectReason :  IEquatable<QueueConversationVideoEventTopicDisconnectReason>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QueueConversationVideoEventTopicDisconnectReason {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationVideoEventTopicDisconnectReason);
        }

        /// <summary>
        /// Returns true if QueueConversationVideoEventTopicDisconnectReason instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationVideoEventTopicDisconnectReason to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationVideoEventTopicDisconnectReason other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
