...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OutboundMessagingEmailCampaignProgressEventCampaignProgress" /> class.
        /// </summary>
        ...
        public OutboundMessagingEmailCampaignProgressEventCampaignProgress(OutboundMessagingEmailCampaignProgressEventUriReference Campaign = null, double? NumberOfContactsCalled = null, double? NumberOfContactsMessaged = null, double? TotalNumberOfContacts = null, long? Percentage = null, Dictionary<string, long?> NumberOfContactsSkipped = null, Dictionary<string, Object> AdditionalProperties = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as OutboundMessagingEmailCampaignProgressEventCampaignProgress);
        }

        /// <summary>
        /// Returns true if OutboundMessagingEmailCampaignProgressEventCampaignProgress instances are equal
        /// </summary>
        /// <param name="other">Instance of OutboundMessagingEmailCampaignProgressEventCampaignProgress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OutboundMessagingEmailCampaignProgressEventCampaignProgress other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
