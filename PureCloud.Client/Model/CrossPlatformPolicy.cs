...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CrossPlatformPolicy :  IEquatable<CrossPlatformPolicy>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossPlatformPolicy" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CrossPlatformPolicy);
        }

        /// <summary>
        /// Returns true if CrossPlatformPolicy instances are equal
        /// </summary>
        /// <param name="other">Instance of CrossPlatformPolicy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrossPlatformPolicy other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
