...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class ConversationEventTopicCobrowse :  IEquatable<ConversationEventTopicCobrowse>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationEventTopicCobrowse);
        }

        /// <summary>
        /// Returns true if ConversationEventTopicCobrowse instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationEventTopicCobrowse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationEventTopicCobrowse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
