...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FaxTopicLockData :  IEquatable<FaxTopicLockData>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FaxTopicLockData" /> class.
        /// </summary>
        /// <param name="LockedBy">LockedBy.</param>
        /// <param name="DateCreated">DateCreated.</param>
        /// <param name="DateExpires">DateExpires.</param>
        public FaxTopicLockData(FaxTopicUserData LockedBy = null, DateTime? DateCreated = null, DateTime? DateExpires = null)
        {
        ...
        public FaxTopicUserData LockedBy { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FaxTopicLockData {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FaxTopicLockData);
        }

        /// <summary>
        /// Returns true if FaxTopicLockData instances are equal
        /// </summary>
        /// <param name="other">Instance of FaxTopicLockData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FaxTopicLockData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
