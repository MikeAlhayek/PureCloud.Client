...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageConversation :  IEquatable<MessageConversation>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageConversation" /> class.
        /// </summary>
        ...
        public MessageConversation(string Name = null, List<MessageMediaParticipant> Participants = null, List<string> OtherMediaUris = null, List<TransferResponse> RecentTransfers = null, string UtilizationLabelId = null, List<ConversationDivisionMembership> Divisions = null)
        {
            this.Name = Name;
        ...
        public List<MessageMediaParticipant> Participants { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MessageConversation);
        }

        /// <summary>
        /// Returns true if MessageConversation instances are equal
        /// </summary>
        /// <param name="other">Instance of MessageConversation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageConversation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
