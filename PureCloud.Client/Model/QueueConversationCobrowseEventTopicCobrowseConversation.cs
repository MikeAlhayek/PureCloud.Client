...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueueConversationCobrowseEventTopicCobrowseConversation :  IEquatable<QueueConversationCobrowseEventTopicCobrowseConversation>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueConversationCobrowseEventTopicCobrowseConversation" /> class.
        /// </summary>
        ...
        public List<QueueConversationCobrowseEventTopicCobrowseMediaParticipant> Participants { get; set; }
        ...
        public List<QueueConversationCobrowseEventTopicConversationDivisionMembership> Divisions { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationCobrowseEventTopicCobrowseConversation);
        }

        /// <summary>
        /// Returns true if QueueConversationCobrowseEventTopicCobrowseConversation instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationCobrowseEventTopicCobrowseConversation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationCobrowseEventTopicCobrowseConversation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
