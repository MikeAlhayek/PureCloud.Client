...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ScoredAgent :  IEquatable<ScoredAgent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScoredAgent" /> class.
        /// </summary>
        /// <param name="Agent">The agent.</param>
        /// <param name="Score">Agent&#39;s score for the current conversation, from 0 - 100, higher being better.</param>
        public ScoredAgent(DomainEntityRef Agent = null, int? Score = null)
        {
            this.Agent = Agent;
            this.Score = Score;
        ...
        /// <summary>
        /// Returns true if ScoredAgent instances are equal
        /// </summary>
        /// <param name="other">Instance of ScoredAgent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScoredAgent other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
