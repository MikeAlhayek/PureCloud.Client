...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationVideoEventTopicJourneyContext :  IEquatable<ConversationVideoEventTopicJourneyContext>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationVideoEventTopicJourneyContext" /> class.
        /// </summary>
        /// <param name="Customer">Customer.</param>
        /// <param name="CustomerSession">CustomerSession.</param>
        /// <param name="TriggeringAction">TriggeringAction.</param>
        public ConversationVideoEventTopicJourneyContext(ConversationVideoEventTopicJourneyCustomer Customer = null, ConversationVideoEventTopicJourneyCustomerSession CustomerSession = null, ConversationVideoEventTopicJourneyAction TriggeringAction = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationVideoEventTopicJourneyContext);
        }

        /// <summary>
        /// Returns true if ConversationVideoEventTopicJourneyContext instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationVideoEventTopicJourneyContext to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationVideoEventTopicJourneyContext other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
