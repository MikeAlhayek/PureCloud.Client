...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BulkResponseResultVoidEntityBulkEntityErrorEntity : IEquatable<BulkResponseResultVoidEntityBulkEntityErrorEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkResponseResultVoidEntityBulkEntityErrorEntity" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BulkResponseResultVoidEntityBulkEntityErrorEntity {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BulkResponseResultVoidEntityBulkEntityErrorEntity);
        }

        /// <summary>
        /// Returns true if BulkResponseResultVoidEntityBulkEntityErrorEntity instances are equal
        /// </summary>
        /// <param name="other">Instance of BulkResponseResultVoidEntityBulkEntityErrorEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkResponseResultVoidEntityBulkEntityErrorEntity other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
