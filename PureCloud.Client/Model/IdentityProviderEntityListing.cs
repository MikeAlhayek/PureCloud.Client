...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class IdentityProviderEntityListing :  IEquatable<IdentityProviderEntityListing>, IPagedResource<SAMLProvider>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdentityProviderEntityListing {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as IdentityProviderEntityListing);
        }

        /// <summary>
        /// Returns true if IdentityProviderEntityListing instances are equal
        /// </summary>
        /// <param name="other">Instance of IdentityProviderEntityListing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityProviderEntityListing other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
