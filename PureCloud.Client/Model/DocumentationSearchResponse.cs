...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentationSearchResponse :  IEquatable<DocumentationSearchResponse>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentationSearchResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DocumentationSearchResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentationSearchResponse" /> class.
        /// </summary>
        ...
        public DocumentationSearchResponse(long? Total = null, int? PageCount = null, int? PageSize = null, int? PageNumber = null, string PreviousPage = null, string CurrentPage = null, string NextPage = null, List<string> Types = null, List<DocumentationResult> Results = null)
        {
            this.Total = Total;
        ...
        public List<DocumentationResult> Results { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DocumentationSearchResponse);
        }

        /// <summary>
        /// Returns true if DocumentationSearchResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of DocumentationSearchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentationSearchResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
