...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserObservationQueryFilter :  IEquatable<UserObservationQueryFilter>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserObservationQueryFilter" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UserObservationQueryFilter() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UserObservationQueryFilter" /> class.
        /// </summary>
        ...
        public UserObservationQueryFilter(TypeEnum? Type = null, List<UserObservationQueryClause> Clauses = null, List<UserObservationQueryPredicate> Predicates = null)
        {
            this.Type = Type;
        ...
        public List<UserObservationQueryClause> Clauses { get; set; }
        ...
        public List<UserObservationQueryPredicate> Predicates { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UserObservationQueryFilter);
        }

        /// <summary>
        /// Returns true if UserObservationQueryFilter instances are equal
        /// </summary>
        /// <param name="other">Instance of UserObservationQueryFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserObservationQueryFilter other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
