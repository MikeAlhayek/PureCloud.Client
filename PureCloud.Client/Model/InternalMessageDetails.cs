...
/// </summary>
[DataContract]
public partial class InternalMessageDetails : IEquatable<InternalMessageDetails>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="InternalMessageDetails" /> class.
    /// </summary>
    ...
    public InternalMessageDetails(string MessageId = null, DateTime? MessageTime = null)
    {
    ...
    /// <summary>
    /// Returns true if InternalMessageDetails instances are equal
    /// </summary>
    /// <param name="other">Instance of InternalMessageDetails to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(InternalMessageDetails other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
