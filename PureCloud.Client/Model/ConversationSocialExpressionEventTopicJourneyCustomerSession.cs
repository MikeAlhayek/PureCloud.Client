...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationSocialExpressionEventTopicJourneyCustomerSession" /> class.
        /// </summary>
        ...
        public ConversationSocialExpressionEventTopicJourneyCustomerSession(string Id = null, string Type = null)
        {
            this.Id = Id;
            this.Type = Type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConversationSocialExpressionEventTopicJourneyCustomerSession {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationSocialExpressionEventTopicJourneyCustomerSession);
        }

        /// <summary>
        /// Returns true if ConversationSocialExpressionEventTopicJourneyCustomerSession instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationSocialExpressionEventTopicJourneyCustomerSession to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationSocialExpressionEventTopicJourneyCustomerSession other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
