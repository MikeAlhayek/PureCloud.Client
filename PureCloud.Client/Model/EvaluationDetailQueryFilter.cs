...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EvaluationDetailQueryFilter :  IEquatable<EvaluationDetailQueryFilter>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EvaluationDetailQueryFilter" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EvaluationDetailQueryFilter() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EvaluationDetailQueryFilter" /> class.
        /// </summary>
        ...
        public EvaluationDetailQueryFilter(TypeEnum? Type = null, List<EvaluationDetailQueryClause> Clauses = null, List<EvaluationDetailQueryPredicate> Predicates = null)
        {
            this.Type = Type;
        ...
        public List<EvaluationDetailQueryClause> Clauses { get; set; }
        ...
        public List<EvaluationDetailQueryPredicate> Predicates { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EvaluationDetailQueryFilter);
        }

        /// <summary>
        /// Returns true if EvaluationDetailQueryFilter instances are equal
        /// </summary>
        /// <param name="other">Instance of EvaluationDetailQueryFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EvaluationDetailQueryFilter other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
