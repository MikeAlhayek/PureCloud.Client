...
/// </summary>
[DataContract]
public partial class SegmentDetailQueryFilter : IEquatable<SegmentDetailQueryFilter>
{
    /// <summary>
    ...
    protected SegmentDetailQueryFilter() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="SegmentDetailQueryFilter" /> class.
    /// </summary>
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as SegmentDetailQueryFilter);
    }

    /// <summary>
    /// Returns true if SegmentDetailQueryFilter instances are equal
    /// </summary>
    /// <param name="other">Instance of SegmentDetailQueryFilter to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(SegmentDetailQueryFilter other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
