...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class JourneyWebEventsNotificationMktCampaign :  IEquatable<JourneyWebEventsNotificationMktCampaign>
    {
        ...
        public JourneyWebEventsNotificationMktCampaign(string Content = null, string Medium = null, string Name = null, string Source = null, string Term = null, string ClickId = null, string Network = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as JourneyWebEventsNotificationMktCampaign);
        }

        /// <summary>
        /// Returns true if JourneyWebEventsNotificationMktCampaign instances are equal
        /// </summary>
        /// <param name="other">Instance of JourneyWebEventsNotificationMktCampaign to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JourneyWebEventsNotificationMktCampaign other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
