...
/// </summary>
[DataContract]
public partial class BulkRelationshipsResponse : IEquatable<BulkRelationshipsResponse>
{
    /// <summary>
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as BulkRelationshipsResponse);
    }

    /// <summary>
    /// Returns true if BulkRelationshipsResponse instances are equal
    /// </summary>
    /// <param name="other">Instance of BulkRelationshipsResponse to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(BulkRelationshipsResponse other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
