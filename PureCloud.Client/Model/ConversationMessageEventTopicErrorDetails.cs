...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationMessageEventTopicErrorDetails :  IEquatable<ConversationMessageEventTopicErrorDetails>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationMessageEventTopicErrorDetails" /> class.
        /// </summary>
        ...
        public ConversationMessageEventTopicErrorDetails(long? Status = null, string Code = null, string Message = null, string MessageWithParams = null, Dictionary<string, string> MessageParams = null, string ContextId = null, string Uri = null)
        {
            this.Status = Status;
            this.Code = Code;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConversationMessageEventTopicErrorDetails {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationMessageEventTopicErrorDetails);
        }

        /// <summary>
        /// Returns true if ConversationMessageEventTopicErrorDetails instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationMessageEventTopicErrorDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationMessageEventTopicErrorDetails other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
