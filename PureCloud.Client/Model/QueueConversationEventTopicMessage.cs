...
public partial class QueueConversationEventTopicMessage : IEquatable<QueueConversationEventTopicMessage>
{
    ...
    public List<QueueConversationEventTopicMessageDetails> Messages { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationEventTopicMessage);
    }

    /// <summary>
    /// Returns true if QueueConversationEventTopicMessage instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationEventTopicMessage to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationEventTopicMessage other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
