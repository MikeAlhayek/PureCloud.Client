...
/// </summary>
[DataContract]
public partial class QueueConversationEmailEventTopicAttachment : IEquatable<QueueConversationEmailEventTopicAttachment>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="QueueConversationEmailEventTopicAttachment" /> class.
    /// </summary>
    ...
    public QueueConversationEmailEventTopicAttachment(string AttachmentId = null, string Name = null, string ContentUri = null, string ContentType = null, long? ContentLength = null)
    {
    ...
    /// <summary>
    /// Returns true if QueueConversationEmailEventTopicAttachment instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationEmailEventTopicAttachment to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationEmailEventTopicAttachment other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
