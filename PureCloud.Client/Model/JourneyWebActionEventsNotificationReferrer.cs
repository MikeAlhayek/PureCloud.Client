...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class JourneyWebActionEventsNotificationReferrer :  IEquatable<JourneyWebActionEventsNotificationReferrer>
    {
        ...
        public JourneyWebActionEventsNotificationReferrer(string Url = null, string Domain = null, string Hostname = null, string Keywords = null, string Pathname = null, string QueryString = null, string Fragment = null, string Name = null, MediumEnum? Medium = null)
        {
            this.Url = Url;
            this.Domain = Domain;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as JourneyWebActionEventsNotificationReferrer);
        }

        /// <summary>
        /// Returns true if JourneyWebActionEventsNotificationReferrer instances are equal
        /// </summary>
        /// <param name="other">Instance of JourneyWebActionEventsNotificationReferrer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JourneyWebActionEventsNotificationReferrer other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
