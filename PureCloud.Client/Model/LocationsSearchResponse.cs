...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class LocationsSearchResponse :  IEquatable<LocationsSearchResponse>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LocationsSearchResponse);
        }

        /// <summary>
        /// Returns true if LocationsSearchResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of LocationsSearchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LocationsSearchResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
