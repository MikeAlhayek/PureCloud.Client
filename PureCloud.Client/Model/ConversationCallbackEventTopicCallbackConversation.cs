...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationCallbackEventTopicCallbackConversation :  IEquatable<ConversationCallbackEventTopicCallbackConversation>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationCallbackEventTopicCallbackConversation" /> class.
        /// </summary>
        ...
        public List<ConversationCallbackEventTopicCallbackMediaParticipant> Participants { get; set; }
        ...
        public List<ConversationCallbackEventTopicConversationDivisionMembership> Divisions { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationCallbackEventTopicCallbackConversation);
        }

        /// <summary>
        /// Returns true if ConversationCallbackEventTopicCallbackConversation instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationCallbackEventTopicCallbackConversation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationCallbackEventTopicCallbackConversation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
