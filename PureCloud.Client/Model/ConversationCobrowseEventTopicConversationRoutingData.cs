...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationCobrowseEventTopicConversationRoutingData :  IEquatable<ConversationCobrowseEventTopicConversationRoutingData>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationCobrowseEventTopicConversationRoutingData" /> class.
        /// </summary>
        ...
        public ConversationCobrowseEventTopicConversationRoutingData(ConversationCobrowseEventTopicUriReference Queue = null, ConversationCobrowseEventTopicUriReference Language = null, long? Priority = null, List<ConversationCobrowseEventTopicUriReference> Skills = null, List<ConversationCobrowseEventTopicScoredAgent> ScoredAgents = null)
        {
            this.Queue = Queue;
        ...
        public ConversationCobrowseEventTopicUriReference Language { get; set; }
        ...
        public List<ConversationCobrowseEventTopicUriReference> Skills { get; set; }
        ...
        public List<ConversationCobrowseEventTopicScoredAgent> ScoredAgents { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationCobrowseEventTopicConversationRoutingData);
        }

        /// <summary>
        /// Returns true if ConversationCobrowseEventTopicConversationRoutingData instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationCobrowseEventTopicConversationRoutingData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationCobrowseEventTopicConversationRoutingData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
