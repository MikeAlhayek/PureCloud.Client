...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RequiredLocalDateRange :  IEquatable<RequiredLocalDateRange>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="RequiredLocalDateRange" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RequiredLocalDateRange() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RequiredLocalDateRange" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RequiredLocalDateRange {\n");
        ...
        /// <summary>
        /// Returns true if RequiredLocalDateRange instances are equal
        /// </summary>
        /// <param name="other">Instance of RequiredLocalDateRange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RequiredLocalDateRange other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
