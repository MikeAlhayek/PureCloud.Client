...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class BuTimeOffLimitListing :  IEquatable<BuTimeOffLimitListing>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BuTimeOffLimitListing {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BuTimeOffLimitListing);
        }

        /// <summary>
        /// Returns true if BuTimeOffLimitListing instances are equal
        /// </summary>
        /// <param name="other">Instance of BuTimeOffLimitListing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BuTimeOffLimitListing other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
