...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TeamsSearchResponse :  IEquatable<TeamsSearchResponse>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="TeamsSearchResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TeamsSearchResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamsSearchResponse" /> class.
        /// </summary>
        ...
        public TeamsSearchResponse(long? Total = null, int? PageCount = null, int? PageSize = null, int? PageNumber = null, string PreviousPage = null, string CurrentPage = null, string NextPage = null, List<string> Types = null, List<Team> Results = null)
        {
            this.Total = Total;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TeamsSearchResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TeamsSearchResponse);
        }

        /// <summary>
        /// Returns true if TeamsSearchResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of TeamsSearchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TeamsSearchResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
