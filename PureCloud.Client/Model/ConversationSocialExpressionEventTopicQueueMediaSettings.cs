...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationSocialExpressionEventTopicQueueMediaSettings :  IEquatable<ConversationSocialExpressionEventTopicQueueMediaSettings>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationSocialExpressionEventTopicQueueMediaSettings" /> class.
        /// </summary>
        ...
        public ConversationSocialExpressionEventTopicQueueMediaSettings(long? AlertingTimeoutSeconds = null, double? AutoAnswerAlertToneSeconds = null, double? ManualAnswerAlertToneSeconds = null, bool? EnableAutoAnswer = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConversationSocialExpressionEventTopicQueueMediaSettings {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationSocialExpressionEventTopicQueueMediaSettings);
        }

        /// <summary>
        /// Returns true if ConversationSocialExpressionEventTopicQueueMediaSettings instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationSocialExpressionEventTopicQueueMediaSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationSocialExpressionEventTopicQueueMediaSettings other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
