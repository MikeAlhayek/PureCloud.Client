...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OutboundMessagingMessagingCampaignProgressEventCampaignProgress :  IEquatable<OutboundMessagingMessagingCampaignProgressEventCampaignProgress>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OutboundMessagingMessagingCampaignProgressEventCampaignProgress" /> class.
        /// </summary>
        ...
        public OutboundMessagingMessagingCampaignProgressEventCampaignProgress(OutboundMessagingMessagingCampaignProgressEventUriReference Campaign = null, double? NumberOfContactsCalled = null, double? NumberOfContactsMessaged = null, double? TotalNumberOfContacts = null, long? Percentage = null, Dictionary<string, long?> NumberOfContactsSkipped = null, Dictionary<string, Object> AdditionalProperties = null)
        {
        ...
        public OutboundMessagingMessagingCampaignProgressEventUriReference Campaign { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as OutboundMessagingMessagingCampaignProgressEventCampaignProgress);
        }

        /// <summary>
        /// Returns true if OutboundMessagingMessagingCampaignProgressEventCampaignProgress instances are equal
        /// </summary>
        /// <param name="other">Instance of OutboundMessagingMessagingCampaignProgressEventCampaignProgress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OutboundMessagingMessagingCampaignProgressEventCampaignProgress other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
