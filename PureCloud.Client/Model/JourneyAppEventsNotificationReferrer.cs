...
/// </summary>
[DataContract]
public partial class JourneyAppEventsNotificationReferrer : IEquatable<JourneyAppEventsNotificationReferrer>
{
    /// <summary>
    /// Gets or Sets Medium
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="JourneyAppEventsNotificationReferrer" /> class.
    /// </summary>
    ...
    public JourneyAppEventsNotificationReferrer(string Url = null, string Domain = null, string Hostname = null, string Keywords = null, string Pathname = null, string QueryString = null, string Fragment = null, string Name = null, MediumEnum? Medium = null)
    {
        this.Url = Url;
        this.Domain = Domain;
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as JourneyAppEventsNotificationReferrer);
    }

    /// <summary>
    /// Returns true if JourneyAppEventsNotificationReferrer instances are equal
    /// </summary>
    /// <param name="other">Instance of JourneyAppEventsNotificationReferrer to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(JourneyAppEventsNotificationReferrer other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
