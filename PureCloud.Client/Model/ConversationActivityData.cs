...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationActivityData :  IEquatable<ConversationActivityData>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationActivityData" /> class.
        /// </summary>
        ...
        public ConversationActivityData(Dictionary<string, string> Group = null, List<ConversationActivityMetricValue> Data = null, bool? Truncated = null, List<ConversationActivityEntityData> Entities = null)
        {
            this.Group = Group;
            this.Data = Data;
        ...
        public List<ConversationActivityMetricValue> Data { get; set; }
        ...
        public List<ConversationActivityEntityData> Entities { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationActivityData);
        }

        /// <summary>
        /// Returns true if ConversationActivityData instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationActivityData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationActivityData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
