...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class QueueConversationMessageEventTopicJourneyCustomerSession :  IEquatable<QueueConversationMessageEventTopicJourneyCustomerSession>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationMessageEventTopicJourneyCustomerSession);
        }

        /// <summary>
        /// Returns true if QueueConversationMessageEventTopicJourneyCustomerSession instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationMessageEventTopicJourneyCustomerSession to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationMessageEventTopicJourneyCustomerSession other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
