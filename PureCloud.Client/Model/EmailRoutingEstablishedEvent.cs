...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmailRoutingEstablishedEvent :  IEquatable<EmailRoutingEstablishedEvent>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="EmailRoutingEstablishedEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EmailRoutingEstablishedEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailRoutingEstablishedEvent" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EmailRoutingEstablishedEvent);
        }

        /// <summary>
        /// Returns true if EmailRoutingEstablishedEvent instances are equal
        /// </summary>
        /// <param name="other">Instance of EmailRoutingEstablishedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailRoutingEstablishedEvent other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
