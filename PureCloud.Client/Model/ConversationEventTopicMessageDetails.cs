...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationEventTopicMessageDetails :  IEquatable<ConversationEventTopicMessageDetails>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationEventTopicMessageDetails);
        }

        /// <summary>
        /// Returns true if ConversationEventTopicMessageDetails instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationEventTopicMessageDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationEventTopicMessageDetails other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
