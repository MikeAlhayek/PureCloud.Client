...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FaxStatus :  IEquatable<FaxStatus>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FaxStatus);
        }

        /// <summary>
        /// Returns true if FaxStatus instances are equal
        /// </summary>
        /// <param name="other">Instance of FaxStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FaxStatus other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
