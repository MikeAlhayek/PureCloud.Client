...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueueConversationSocialExpressionEventTopicVideo :  IEquatable<QueueConversationSocialExpressionEventTopicVideo>
    {
        /// <summary>
        /// Gets or Sets State
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationSocialExpressionEventTopicVideo);
        }

        /// <summary>
        /// Returns true if QueueConversationSocialExpressionEventTopicVideo instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationSocialExpressionEventTopicVideo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationSocialExpressionEventTopicVideo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
