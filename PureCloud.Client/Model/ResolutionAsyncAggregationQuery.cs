...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResolutionAsyncAggregationQuery :  IEquatable<ResolutionAsyncAggregationQuery>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResolutionAsyncAggregationQuery" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResolutionAsyncAggregationQuery() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResolutionAsyncAggregationQuery" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResolutionAsyncAggregationQuery {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ResolutionAsyncAggregationQuery);
        }

        /// <summary>
        /// Returns true if ResolutionAsyncAggregationQuery instances are equal
        /// </summary>
        /// <param name="other">Instance of ResolutionAsyncAggregationQuery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResolutionAsyncAggregationQuery other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
