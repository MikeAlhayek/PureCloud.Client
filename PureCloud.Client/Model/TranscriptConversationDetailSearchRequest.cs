...
public partial class TranscriptConversationDetailSearchRequest : IEquatable<TranscriptConversationDetailSearchRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="TranscriptConversationDetailSearchRequest" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected TranscriptConversationDetailSearchRequest() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="TranscriptConversationDetailSearchRequest" /> class.
    /// </summary>
    ...
    public TranscriptConversationDetailSearchRequest(SortOrderEnum? SortOrder = null, string SortBy = null, int? PageSize = null, int? PageNumber = null, List<SearchSort> Sort = null, List<string> Types = null, List<TranscriptConversationDetailSearchCriteria> Query = null)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as TranscriptConversationDetailSearchRequest);
    }

    /// <summary>
    /// Returns true if TranscriptConversationDetailSearchRequest instances are equal
    /// </summary>
    /// <param name="other">Instance of TranscriptConversationDetailSearchRequest to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(TranscriptConversationDetailSearchRequest other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
