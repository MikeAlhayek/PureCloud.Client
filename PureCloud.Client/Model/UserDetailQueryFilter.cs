...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserDetailQueryFilter :  IEquatable<UserDetailQueryFilter>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserDetailQueryFilter" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UserDetailQueryFilter() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UserDetailQueryFilter" /> class.
        /// </summary>
        ...
        public UserDetailQueryFilter(TypeEnum? Type = null, List<UserDetailQueryClause> Clauses = null, List<UserDetailQueryPredicate> Predicates = null)
        {
            this.Type = Type;
        ...
        public List<UserDetailQueryClause> Clauses { get; set; }
        ...
        public List<UserDetailQueryPredicate> Predicates { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserDetailQueryFilter {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UserDetailQueryFilter);
        }

        /// <summary>
        /// Returns true if UserDetailQueryFilter instances are equal
        /// </summary>
        /// <param name="other">Instance of UserDetailQueryFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserDetailQueryFilter other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
