...
/// </summary>
[DataContract]
public partial class QueueConversationMessageEventTopicJourneyActionMap : IEquatable<QueueConversationMessageEventTopicJourneyActionMap>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="QueueConversationMessageEventTopicJourneyActionMap" /> class.
    /// </summary>
    ...
    public override string ToString()
    {
        ...
        sb.Append("class QueueConversationMessageEventTopicJourneyActionMap {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationMessageEventTopicJourneyActionMap);
    }

    /// <summary>
    /// Returns true if QueueConversationMessageEventTopicJourneyActionMap instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationMessageEventTopicJourneyActionMap to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationMessageEventTopicJourneyActionMap other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
