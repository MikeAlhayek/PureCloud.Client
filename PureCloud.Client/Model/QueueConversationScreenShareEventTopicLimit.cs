...
/// </summary>
[DataContract]
public partial class QueueConversationScreenShareEventTopicLimit : IEquatable<QueueConversationScreenShareEventTopicLimit>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="QueueConversationScreenShareEventTopicLimit" /> class.
    /// </summary>
    /// <param name="Key">Key.</param>
    /// <param name="Namespace">Namespace.</param>
    /// <param name="Value">Value.</param>
    /// <param name="Documented">Documented.</param>
    public QueueConversationScreenShareEventTopicLimit(string Key = null, NamespaceEnum? Namespace = null, long? Value = null, bool? Documented = null)
    {
        this.Key = Key;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class QueueConversationScreenShareEventTopicLimit {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationScreenShareEventTopicLimit);
    }

    /// <summary>
    /// Returns true if QueueConversationScreenShareEventTopicLimit instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationScreenShareEventTopicLimit to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationScreenShareEventTopicLimit other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
