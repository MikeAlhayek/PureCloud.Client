...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationQueueMediaSettings :  IEquatable<ConversationQueueMediaSettings>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationQueueMediaSettings" /> class.
        /// </summary>
        ...
        public ConversationQueueMediaSettings(int? AlertingTimeoutSeconds = null, double? AutoAnswerAlertToneSeconds = null, double? ManualAnswerAlertToneSeconds = null, bool? EnableAutoAnswer = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationQueueMediaSettings);
        }

        /// <summary>
        /// Returns true if ConversationQueueMediaSettings instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationQueueMediaSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationQueueMediaSettings other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
