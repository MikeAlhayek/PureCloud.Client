...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueueConversationVideoEventTopicJourneyCustomerSession :  IEquatable<QueueConversationVideoEventTopicJourneyCustomerSession>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QueueConversationVideoEventTopicJourneyCustomerSession {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationVideoEventTopicJourneyCustomerSession);
        }

        /// <summary>
        /// Returns true if QueueConversationVideoEventTopicJourneyCustomerSession instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationVideoEventTopicJourneyCustomerSession to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationVideoEventTopicJourneyCustomerSession other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
