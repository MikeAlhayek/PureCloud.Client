...
/// </summary>
[DataContract]
public partial class QueueObservationQueryFilter : IEquatable<QueueObservationQueryFilter>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="QueueObservationQueryFilter" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected QueueObservationQueryFilter() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="QueueObservationQueryFilter" /> class.
    /// </summary>
    ...
    public QueueObservationQueryFilter(TypeEnum? Type = null, List<QueueObservationQueryClause> Clauses = null, List<QueueObservationQueryPredicate> Predicates = null)
    {
        this.Type = Type;
    ...
    public List<QueueObservationQueryClause> Clauses { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class QueueObservationQueryFilter {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueObservationQueryFilter);
    }

    /// <summary>
    /// Returns true if QueueObservationQueryFilter instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueObservationQueryFilter to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueObservationQueryFilter other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
