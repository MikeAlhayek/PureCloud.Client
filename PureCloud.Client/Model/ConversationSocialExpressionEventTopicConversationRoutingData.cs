...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationSocialExpressionEventTopicConversationRoutingData :  IEquatable<ConversationSocialExpressionEventTopicConversationRoutingData>
    {
        /// <summary>
        ...
        public List<ConversationSocialExpressionEventTopicUriReference> Skills { get; set; }
        ...
        public List<ConversationSocialExpressionEventTopicScoredAgent> ScoredAgents { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationSocialExpressionEventTopicConversationRoutingData);
        }

        /// <summary>
        /// Returns true if ConversationSocialExpressionEventTopicConversationRoutingData instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationSocialExpressionEventTopicConversationRoutingData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationSocialExpressionEventTopicConversationRoutingData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
