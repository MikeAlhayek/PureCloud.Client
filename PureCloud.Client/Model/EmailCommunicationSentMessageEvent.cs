...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmailCommunicationSentMessageEvent :  IEquatable<EmailCommunicationSentMessageEvent>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="EmailCommunicationSentMessageEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EmailCommunicationSentMessageEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailCommunicationSentMessageEvent" /> class.
        /// </summary>
        ...
        public EmailCommunicationSentMessageEvent(string EventId = null, DateTime? EventDateTime = null, string ConversationId = null, string CommunicationId = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmailCommunicationSentMessageEvent {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EmailCommunicationSentMessageEvent);
        }

        /// <summary>
        /// Returns true if EmailCommunicationSentMessageEvent instances are equal
        /// </summary>
        /// <param name="other">Instance of EmailCommunicationSentMessageEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailCommunicationSentMessageEvent other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
