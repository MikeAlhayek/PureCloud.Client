...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SAMLProvider :  IEquatable<SAMLProvider>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SAMLProvider);
        }

        /// <summary>
        /// Returns true if SAMLProvider instances are equal
        /// </summary>
        /// <param name="other">Instance of SAMLProvider to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SAMLProvider other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
