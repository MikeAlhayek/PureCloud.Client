...
/// </summary>
[DataContract]
public partial class QueueConversationVideoEventTopicCall : IEquatable<QueueConversationVideoEventTopicCall>
{
    /// <summary>
    /// Gets or Sets State
    /// </summary>
    ...
    public QueueConversationVideoEventTopicAddress Other { get; set; }
    ...
    public List<QueueConversationVideoEventTopicDisconnectReason> DisconnectReasons { get; set; }
    ...
    public QueueConversationVideoEventTopicFaxStatus FaxStatus { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as QueueConversationVideoEventTopicCall);
    }

    /// <summary>
    /// Returns true if QueueConversationVideoEventTopicCall instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationVideoEventTopicCall to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationVideoEventTopicCall other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
