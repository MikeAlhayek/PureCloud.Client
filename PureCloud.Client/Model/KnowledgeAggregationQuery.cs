...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class KnowledgeAggregationQuery :  IEquatable<KnowledgeAggregationQuery>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KnowledgeAggregationQuery" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KnowledgeAggregationQuery() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KnowledgeAggregationQuery" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as KnowledgeAggregationQuery);
        }

        /// <summary>
        /// Returns true if KnowledgeAggregationQuery instances are equal
        /// </summary>
        /// <param name="other">Instance of KnowledgeAggregationQuery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KnowledgeAggregationQuery other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
