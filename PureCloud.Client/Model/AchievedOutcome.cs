...
public partial class AchievedOutcome : IEquatable<AchievedOutcome>
{
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as AchievedOutcome);
    }

    /// <summary>
    /// Returns true if AchievedOutcome instances are equal
    /// </summary>
    /// <param name="other">Instance of AchievedOutcome to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(AchievedOutcome other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
