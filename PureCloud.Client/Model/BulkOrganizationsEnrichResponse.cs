...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BulkOrganizationsEnrichResponse : IEquatable<BulkOrganizationsEnrichResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkOrganizationsEnrichResponse" /> class.
        /// </summary>
        ...
        public BulkOrganizationsEnrichResponse(List<BulkResponseResultExternalOrganizationExternalOrganizationEnrichRequestBulkEntityErrorExternalOrganizationEnrichRequest> Results = null, int? ErrorCount = null, List<int?> ErrorIndexes = null)
        {
        ...
        public List<BulkResponseResultExternalOrganizationExternalOrganizationEnrichRequestBulkEntityErrorExternalOrganizationEnrichRequest> Results { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BulkOrganizationsEnrichResponse);
        }

        /// <summary>
        /// Returns true if BulkOrganizationsEnrichResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of BulkOrganizationsEnrichResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkOrganizationsEnrichResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
