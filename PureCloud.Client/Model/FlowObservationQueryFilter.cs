...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FlowObservationQueryFilter :  IEquatable<FlowObservationQueryFilter>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FlowObservationQueryFilter" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FlowObservationQueryFilter() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FlowObservationQueryFilter" /> class.
        /// </summary>
        ...
        public FlowObservationQueryFilter(TypeEnum? Type = null, List<FlowObservationQueryClause> Clauses = null, List<FlowObservationQueryPredicate> Predicates = null)
        {
            this.Type = Type;
        ...
        public List<FlowObservationQueryClause> Clauses { get; set; }
        ...
        public List<FlowObservationQueryPredicate> Predicates { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FlowObservationQueryFilter {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FlowObservationQueryFilter);
        }

        /// <summary>
        /// Returns true if FlowObservationQueryFilter instances are equal
        /// </summary>
        /// <param name="other">Instance of FlowObservationQueryFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlowObservationQueryFilter other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
