...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class EdgeLogsJob :  IEquatable<EdgeLogsJob>
    {
        ...
        public EdgeLogsJob(string Name = null, Division Division = null, string Description = null, int? Version = null, List<EdgeLogsJobFile> Files = null)
        {
            this.Name = Name;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EdgeLogsJob);
        }

        /// <summary>
        /// Returns true if EdgeLogsJob instances are equal
        /// </summary>
        /// <param name="other">Instance of EdgeLogsJob to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdgeLogsJob other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
