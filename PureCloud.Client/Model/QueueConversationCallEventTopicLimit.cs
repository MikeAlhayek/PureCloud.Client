...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueueConversationCallEventTopicLimit :  IEquatable<QueueConversationCallEventTopicLimit>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueConversationCallEventTopicLimit" /> class.
        /// </summary>
        /// <param name="Key">Key.</param>
        /// <param name="Namespace">Namespace.</param>
        /// <param name="Value">Value.</param>
        /// <param name="Documented">Documented.</param>
        public QueueConversationCallEventTopicLimit(string Key = null, NamespaceEnum? Namespace = null, long? Value = null, bool? Documented = null)
        {
            this.Key = Key;
        ...
        /// <summary>
        /// Returns true if QueueConversationCallEventTopicLimit instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationCallEventTopicLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationCallEventTopicLimit other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
