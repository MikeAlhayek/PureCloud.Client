...
/// </summary>
[DataContract]
public partial class UserAggregateQueryPredicate : IEquatable<UserAggregateQueryPredicate>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="UserAggregateQueryPredicate" /> class.
    /// </summary>
    ...
    public UserAggregateQueryPredicate(TypeEnum? Type = null, DimensionEnum? Dimension = null, OperatorEnum? Operator = null, string Value = null, NumericRange Range = null)
    {
        this.Type = Type;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class UserAggregateQueryPredicate {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as UserAggregateQueryPredicate);
    }

    /// <summary>
    /// Returns true if UserAggregateQueryPredicate instances are equal
    /// </summary>
    /// <param name="other">Instance of UserAggregateQueryPredicate to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(UserAggregateQueryPredicate other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
