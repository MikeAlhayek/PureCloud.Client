...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class QueueConversationSocialExpressionEventTopicScoredAgent :  IEquatable<QueueConversationSocialExpressionEventTopicScoredAgent>
    {
        ...
        public QueueConversationSocialExpressionEventTopicScoredAgent(QueueConversationSocialExpressionEventTopicUriReference Agent = null, long? Score = null)
        {
            this.Agent = Agent;
            this.Score = Score;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationSocialExpressionEventTopicScoredAgent);
        }

        /// <summary>
        /// Returns true if QueueConversationSocialExpressionEventTopicScoredAgent instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationSocialExpressionEventTopicScoredAgent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationSocialExpressionEventTopicScoredAgent other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
