...
/// </summary>
[DataContract]
public partial class BulkEntityErrorRelationship : IEquatable<BulkEntityErrorRelationship>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="BulkEntityErrorRelationship" /> class.
    /// </summary>
    ...
    public BulkEntityErrorRelationship(string Code = null, string Message = null, int? Status = null, bool? Retryable = null, List<BulkErrorDetail> Details = null, Relationship Entity = null)
    {
        this.Code = Code;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class BulkEntityErrorRelationship {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as BulkEntityErrorRelationship);
    }

    /// <summary>
    /// Returns true if BulkEntityErrorRelationship instances are equal
    /// </summary>
    /// <param name="other">Instance of BulkEntityErrorRelationship to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(BulkEntityErrorRelationship other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
