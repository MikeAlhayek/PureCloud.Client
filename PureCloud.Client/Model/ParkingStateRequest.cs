...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class ParkingStateRequest :  IEquatable<ParkingStateRequest>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ParkingStateRequest);
        }

        /// <summary>
        /// Returns true if ParkingStateRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of ParkingStateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ParkingStateRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
