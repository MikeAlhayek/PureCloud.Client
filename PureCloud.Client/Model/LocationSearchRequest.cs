...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LocationSearchRequest :  IEquatable<LocationSearchRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LocationSearchRequest" /> class.
        /// </summary>
        ...
        public LocationSearchRequest(SortOrderEnum? SortOrder = null, string SortBy = null, int? PageSize = null, int? PageNumber = null, List<SearchSort> Sort = null, List<string> Expand = null, List<LocationSearchCriteria> Query = null)
        {
        ...
        public List<LocationSearchCriteria> Query { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LocationSearchRequest);
        }

        /// <summary>
        /// Returns true if LocationSearchRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of LocationSearchRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LocationSearchRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
