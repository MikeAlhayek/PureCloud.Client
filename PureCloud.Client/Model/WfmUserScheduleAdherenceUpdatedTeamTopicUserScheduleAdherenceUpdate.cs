...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class WfmUserScheduleAdherenceUpdatedTeamTopicUserScheduleAdherenceUpdate :  IEquatable<WfmUserScheduleAdherenceUpdatedTeamTopicUserScheduleAdherenceUpdate>
    {
        ...
        /// <summary>
        /// Returns true if WfmUserScheduleAdherenceUpdatedTeamTopicUserScheduleAdherenceUpdate instances are equal
        /// </summary>
        /// <param name="other">Instance of WfmUserScheduleAdherenceUpdatedTeamTopicUserScheduleAdherenceUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WfmUserScheduleAdherenceUpdatedTeamTopicUserScheduleAdherenceUpdate other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
