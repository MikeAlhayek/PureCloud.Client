...
public partial class AgentCopilotAggregateQueryPredicate : IEquatable<AgentCopilotAggregateQueryPredicate>
{
    ...
    public AgentCopilotAggregateQueryPredicate(TypeEnum? Type = null, DimensionEnum? Dimension = null, OperatorEnum? Operator = null, string Value = null, NumericRange Range = null)
    {
        this.Type = Type;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class AgentCopilotAggregateQueryPredicate {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as AgentCopilotAggregateQueryPredicate);
    }

    /// <summary>
    /// Returns true if AgentCopilotAggregateQueryPredicate instances are equal
    /// </summary>
    /// <param name="other">Instance of AgentCopilotAggregateQueryPredicate to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(AgentCopilotAggregateQueryPredicate other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
