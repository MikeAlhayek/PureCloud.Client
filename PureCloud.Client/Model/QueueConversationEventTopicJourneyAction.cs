...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueueConversationEventTopicJourneyAction :  IEquatable<QueueConversationEventTopicJourneyAction>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueConversationEventTopicJourneyAction" /> class.
        /// </summary>
        ...
        public QueueConversationEventTopicJourneyAction(string Id = null, QueueConversationEventTopicJourneyActionMap ActionMap = null)
        {
            this.Id = Id;
        ...
        public QueueConversationEventTopicJourneyActionMap ActionMap { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueueConversationEventTopicJourneyAction);
        }

        /// <summary>
        /// Returns true if QueueConversationEventTopicJourneyAction instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationEventTopicJourneyAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationEventTopicJourneyAction other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
