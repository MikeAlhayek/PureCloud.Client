...
/// </summary>
[DataContract]
public partial class BulkResponseResultExternalContactContactEnrichRequestBulkEntityErrorContactEnrichRequest : IEquatable<BulkResponseResultExternalContactContactEnrichRequestBulkEntityErrorContactEnrichRequest>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="BulkResponseResultExternalContactContactEnrichRequestBulkEntityErrorContactEnrichRequest" /> class.
    /// </summary>
    ...
    public BulkResponseResultExternalContactContactEnrichRequestBulkEntityErrorContactEnrichRequest(string Id = null, bool? Success = null, ExternalContact Entity = null, BulkEntityErrorContactEnrichRequest Error = null)
    {
        this.Id = Id;
    ...
    public BulkEntityErrorContactEnrichRequest Error { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return this.Equals(obj as BulkResponseResultExternalContactContactEnrichRequestBulkEntityErrorContactEnrichRequest);
    }

    /// <summary>
    /// Returns true if BulkResponseResultExternalContactContactEnrichRequestBulkEntityErrorContactEnrichRequest instances are equal
    /// </summary>
    /// <param name="other">Instance of BulkResponseResultExternalContactContactEnrichRequestBulkEntityErrorContactEnrichRequest to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(BulkResponseResultExternalContactContactEnrichRequestBulkEntityErrorContactEnrichRequest other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
