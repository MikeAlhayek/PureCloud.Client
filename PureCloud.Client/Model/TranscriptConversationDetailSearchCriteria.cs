...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TranscriptConversationDetailSearchCriteria :  IEquatable<TranscriptConversationDetailSearchCriteria>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TranscriptConversationDetailSearchCriteria" /> class.
        /// </summary>
        ...
        public TranscriptConversationDetailSearchCriteria(string EndValue = null, List<string> Values = null, string StartValue = null, string Value = null, OperatorEnum? Operator = null, List<TranscriptConversationDetailSearchCriteria> Group = null, string DateFormat = null, List<string> Fields = null, TypeEnum? Type = null)
        {
        ...
        public List<TranscriptConversationDetailSearchCriteria> Group { get; set; }
        ...
        /// <summary>
        /// Returns true if TranscriptConversationDetailSearchCriteria instances are equal
        /// </summary>
        /// <param name="other">Instance of TranscriptConversationDetailSearchCriteria to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranscriptConversationDetailSearchCriteria other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
