...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CursorOrganizationListing :  IEquatable<CursorOrganizationListing>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CursorOrganizationListing" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CursorOrganizationListing);
        }

        /// <summary>
        /// Returns true if CursorOrganizationListing instances are equal
        /// </summary>
        /// <param name="other">Instance of CursorOrganizationListing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CursorOrganizationListing other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
