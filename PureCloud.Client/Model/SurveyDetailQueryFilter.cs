...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SurveyDetailQueryFilter :  IEquatable<SurveyDetailQueryFilter>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SurveyDetailQueryFilter" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SurveyDetailQueryFilter() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SurveyDetailQueryFilter" /> class.
        /// </summary>
        ...
        public SurveyDetailQueryFilter(TypeEnum? Type = null, List<SurveyDetailQueryClause> Clauses = null, List<SurveyDetailQueryPredicate> Predicates = null)
        {
            this.Type = Type;
        ...
        public List<SurveyDetailQueryClause> Clauses { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SurveyDetailQueryFilter);
        }

        /// <summary>
        /// Returns true if SurveyDetailQueryFilter instances are equal
        /// </summary>
        /// <param name="other">Instance of SurveyDetailQueryFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SurveyDetailQueryFilter other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
