...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class MessagingEndTransferEvent :  IEquatable<MessagingEndTransferEvent>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessagingEndTransferEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MessagingEndTransferEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessagingEndTransferEvent" /> class.
        /// </summary>
        ...
        public MessagingEndTransferEvent(string EventId = null, DateTime? EventDateTime = null, string ConversationId = null, string CommandId = null, FinalStateEnum? FinalState = null, string ObjectCommunicationId = null)
        {
        ...
        /// <summary>
        /// Returns true if MessagingEndTransferEvent instances are equal
        /// </summary>
        /// <param name="other">Instance of MessagingEndTransferEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessagingEndTransferEvent other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
