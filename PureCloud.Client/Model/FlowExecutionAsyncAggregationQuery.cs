...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FlowExecutionAsyncAggregationQuery :  IEquatable<FlowExecutionAsyncAggregationQuery>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FlowExecutionAsyncAggregationQuery" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FlowExecutionAsyncAggregationQuery() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FlowExecutionAsyncAggregationQuery" /> class.
        /// </summary>
        ...
        public FlowExecutionAggregateQueryFilter Filter { get; set; }
        ...
        public List<FlowExecutionAggregationView> Views { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FlowExecutionAsyncAggregationQuery {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FlowExecutionAsyncAggregationQuery);
        }

        /// <summary>
        /// Returns true if FlowExecutionAsyncAggregationQuery instances are equal
        /// </summary>
        /// <param name="other">Instance of FlowExecutionAsyncAggregationQuery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlowExecutionAsyncAggregationQuery other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
