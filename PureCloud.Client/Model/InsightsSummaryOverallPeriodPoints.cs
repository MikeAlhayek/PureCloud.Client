...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsightsSummaryOverallPeriodPoints" /> class.
        /// </summary>
        ...
        public InsightsSummaryOverallPeriodPoints(int? Points = null, int? MaxPoints = null, int? DataPointCount = null, double? PercentOfGoal = null)
        {
            this.Points = Points;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InsightsSummaryOverallPeriodPoints);
        }

        /// <summary>
        /// Returns true if InsightsSummaryOverallPeriodPoints instances are equal
        /// </summary>
        /// <param name="other">Instance of InsightsSummaryOverallPeriodPoints to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsightsSummaryOverallPeriodPoints other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
