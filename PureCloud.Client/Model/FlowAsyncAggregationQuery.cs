...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FlowAsyncAggregationQuery :  IEquatable<FlowAsyncAggregationQuery>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FlowAsyncAggregationQuery" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FlowAsyncAggregationQuery() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FlowAsyncAggregationQuery" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FlowAsyncAggregationQuery {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FlowAsyncAggregationQuery);
        }

        /// <summary>
        /// Returns true if FlowAsyncAggregationQuery instances are equal
        /// </summary>
        /// <param name="other">Instance of FlowAsyncAggregationQuery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlowAsyncAggregationQuery other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
