...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class WfmBuShortTermForecastCopyCompleteTopicBuShortTermForecast :  IEquatable<WfmBuShortTermForecastCopyCompleteTopicBuShortTermForecast>
    {
        ...
        /// <summary>
        /// Returns true if WfmBuShortTermForecastCopyCompleteTopicBuShortTermForecast instances are equal
        /// </summary>
        /// <param name="other">Instance of WfmBuShortTermForecastCopyCompleteTopicBuShortTermForecast to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WfmBuShortTermForecastCopyCompleteTopicBuShortTermForecast other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
