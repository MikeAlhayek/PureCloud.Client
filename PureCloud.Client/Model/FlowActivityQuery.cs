...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class FlowActivityQuery :  IEquatable<FlowActivityQuery>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FlowActivityQuery" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FlowActivityQuery() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FlowActivityQuery" /> class.
        /// </summary>
        ...
        public FlowActivityQuery(List<FlowActivityQueryMetric> Metrics = null, List<GroupByEnum> GroupBy = null, FlowActivityQueryFilter Filter = null, OrderEnum? Order = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FlowActivityQuery);
        }

        /// <summary>
        /// Returns true if FlowActivityQuery instances are equal
        /// </summary>
        /// <param name="other">Instance of FlowActivityQuery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlowActivityQuery other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
