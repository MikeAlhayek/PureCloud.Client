...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class ConversationEventTopicConversationRoutingData :  IEquatable<ConversationEventTopicConversationRoutingData>
    {
        ...
        public ConversationEventTopicConversationRoutingData(ConversationEventTopicUriReference Queue = null, ConversationEventTopicUriReference Language = null, long? Priority = null, List<ConversationEventTopicUriReference> Skills = null, List<ConversationEventTopicScoredAgent> ScoredAgents = null)
        {
            this.Queue = Queue;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationEventTopicConversationRoutingData);
        }

        /// <summary>
        /// Returns true if ConversationEventTopicConversationRoutingData instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversationEventTopicConversationRoutingData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationEventTopicConversationRoutingData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
