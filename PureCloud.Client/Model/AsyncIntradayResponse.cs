...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class AsyncIntradayResponse :  IEquatable<AsyncIntradayResponse>
    {
        ...
        public AsyncIntradayResponse(StatusEnum? Status = null, string OperationId = null, BuIntradayResponse Result = null)
        {
            this.Status = Status;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AsyncIntradayResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AsyncIntradayResponse);
        }

        /// <summary>
        /// Returns true if AsyncIntradayResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of AsyncIntradayResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AsyncIntradayResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
