...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    public partial class QueueConversationEventTopicDisconnectReason :  IEquatable<QueueConversationEventTopicDisconnectReason>
    {
        ...
        public QueueConversationEventTopicDisconnectReason(TypeEnum? Type = null, long? Code = null, string Phrase = null)
        {
            this.Type = Type;
            this.Code = Code;
            this.Phrase = Phrase;
        ...
        /// <summary>
        /// Returns true if QueueConversationEventTopicDisconnectReason instances are equal
        /// </summary>
        /// <param name="other">Instance of QueueConversationEventTopicDisconnectReason to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueConversationEventTopicDisconnectReason other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
