...
namespace PureCloudPlatform.Client.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessagingProgressTransferEvent :  IEquatable<MessagingProgressTransferEvent>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="MessagingProgressTransferEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MessagingProgressTransferEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessagingProgressTransferEvent" /> class.
        /// </summary>
        ...
        public MessagingProgressTransferEvent(string EventId = null, DateTime? EventDateTime = null, string ConversationId = null, string CommandId = null, string ObjectCommunicationId = null, string DestinationCommunicationId = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MessagingProgressTransferEvent);
        }

        /// <summary>
        /// Returns true if MessagingProgressTransferEvent instances are equal
        /// </summary>
        /// <param name="other">Instance of MessagingProgressTransferEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessagingProgressTransferEvent other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
