...
public interface IVoicemailApi : IApiAccessor
{
    ...
    System.Threading.Tasks.Task<VoicemailMailboxInfo> GetVoicemailUserMailboxAsync(string userId);
    ...
    System.Threading.Tasks.Task<ApiResponse<VoicemailMailboxInfo>> GetVoicemailUserMailboxAsyncWithHttpInfo(string userId);
    ...
    System.Threading.Tasks.Task<VoicemailMessageEntityListing> GetVoicemailUserMessagesAsync(string userId, int? pageSize = null, int? pageNumber = null);
    ...
    System.Threading.Tasks.Task<ApiResponse<VoicemailMessageEntityListing>> GetVoicemailUserMessagesAsyncWithHttpInfo(string userId, int? pageSize = null, int? pageNumber = null);
...
public partial class VoicemailApi : IVoicemailApi
{
    ...
    public async System.Threading.Tasks.Task<VoicemailMailboxInfo> GetVoicemailUserMailboxAsync(string userId)
    {
    ...
    public async System.Threading.Tasks.Task<ApiResponse<VoicemailMailboxInfo>> GetVoicemailUserMailboxAsyncWithHttpInfo(string userId)
    {
        // verify the required parameter 'userId' is set
        if (userId == null)
        {
    ...
    public async System.Threading.Tasks.Task<VoicemailMessageEntityListing> GetVoicemailUserMessagesAsync(string userId, int? pageSize = null, int? pageNumber = null)
    {
    ...
    public async System.Threading.Tasks.Task<ApiResponse<VoicemailMessageEntityListing>> GetVoicemailUserMessagesAsyncWithHttpInfo(string userId, int? pageSize = null, int? pageNumber = null)
    {
        // verify the required parameter 'userId' is set
        if (userId == null)
        {
