...
public partial class CoachingApi : ICoachingApi
{
    ...
    public ApiResponse<CoachingAppointmentReference> DeleteCoachingAppointmentWithHttpInfo(string appointmentId)
    {
        ...
        if (appointmentId != null)
        {
            localVarPathParams.Add("appointmentId", this.Configuration.ApiClient.ParameterToString(appointmentId));
        }
    ...
    public ApiResponse<CoachingAppointmentResponseList> GetCoachingAppointmentsWithHttpInfo(List<string> userIds, string interval = null, int? pageNumber = null, int? pageSize = null, List<string> statuses = null, List<string> facilitatorIds = null, string sortOrder = null, List<string> relationships = null, string completionInterval = null, string overdue = null, string intervalCondition = null)
    {
        ...
        {
            facilitatorIds.ForEach(obj => { localVarQueryParams.Add(new Tuple<string, string>("facilitatorIds", this.Configuration.ApiClient.ParameterToString(obj))); });
        }
        ...
        {
            relationships.ForEach(obj => { localVarQueryParams.Add(new Tuple<string, string>("relationships", this.Configuration.ApiClient.ParameterToString(obj))); });
        }
        ...
        {
            localVarQueryParams.Add(new Tuple<string, string>("intervalCondition", this.Configuration.ApiClient.ParameterToString(intervalCondition)));
        }
    ...
    public ApiResponse<CoachingNotification> GetCoachingNotificationWithHttpInfo(string notificationId, List<string> expand = null)
    {
        ...
        if (notificationId != null)
        {
            localVarPathParams.Add("notificationId", this.Configuration.ApiClient.ParameterToString(notificationId));
        }
