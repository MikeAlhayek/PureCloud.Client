...
public interface ICarrierServicesApi : IApiAccessor
{
    ...
    Task<EmergencyLocation> GetCarrierservicesIntegrationsEmergencylocationsMeAsync(string phoneNumber);
    ...
    Task<ApiResponse<EmergencyLocation>> GetCarrierservicesIntegrationsEmergencylocationsMeAsyncWithHttpInfo(string phoneNumber);
    ...
    Task<EmergencyLocation> PostCarrierservicesIntegrationsEmergencylocationsMeAsync(EmergencyLocation body = null);
    ...
    Task<ApiResponse<EmergencyLocation>> PostCarrierservicesIntegrationsEmergencylocationsMeAsyncWithHttpInfo(EmergencyLocation body = null);
...
public partial class CarrierServicesApi : ICarrierServicesApi
{
    ...
    public async Task<EmergencyLocation> GetCarrierservicesIntegrationsEmergencylocationsMeAsync(string phoneNumber)
    {
    ...
    public async Task<ApiResponse<EmergencyLocation>> GetCarrierservicesIntegrationsEmergencylocationsMeAsyncWithHttpInfo(string phoneNumber)
    {
        // verify the required parameter 'phoneNumber' is set
        if (phoneNumber == null)
        {
    ...
    public async Task<EmergencyLocation> PostCarrierservicesIntegrationsEmergencylocationsMeAsync(EmergencyLocation body = null)
    {
    ...
    public async Task<ApiResponse<EmergencyLocation>> PostCarrierservicesIntegrationsEmergencylocationsMeAsyncWithHttpInfo(EmergencyLocation body = null)
    {
