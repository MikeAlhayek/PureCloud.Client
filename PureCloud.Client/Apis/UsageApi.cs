...
public interface IUsageApi : IApiAccessor
{
    ...
    Task<ApiUsageQueryResult> GetUsageQueryExecutionIdResultsAsync(string executionId);
    ...
    Task<ApiResponse<ApiUsageQueryResult>> GetUsageQueryExecutionIdResultsAsyncWithHttpInfo(string executionId);
    ...
    Task<ApiUsageQueryResult> GetUsageSimplesearchExecutionIdResultsAsync(string executionId, string after = null, int? pageSize = null);
    ...
    Task<ApiResponse<ApiUsageQueryResult>> GetUsageSimplesearchExecutionIdResultsAsyncWithHttpInfo(string executionId, string after = null, int? pageSize = null);
    ...
    Task<UsageExecutionResult> PostUsageQueryAsync(ApiUsageOrganizationQuery body);
    ...
    Task<ApiResponse<UsageExecutionResult>> PostUsageQueryAsyncWithHttpInfo(ApiUsageOrganizationQuery body);
    ...
    Task<UsageExecutionResult> PostUsageSimplesearchAsync(ApiUsageSimpleSearch body);
    ...
    Task<ApiResponse<UsageExecutionResult>> PostUsageSimplesearchAsyncWithHttpInfo(ApiUsageSimpleSearch body);
...
public partial class UsageApi : IUsageApi
{
    ...
    public async Task<ApiUsageQueryResult> GetUsageQueryExecutionIdResultsAsync(string executionId)
    {
    ...
    public async Task<ApiResponse<ApiUsageQueryResult>> GetUsageQueryExecutionIdResultsAsyncWithHttpInfo(string executionId)
    {
        // verify the required parameter 'executionId' is set
        if (executionId == null)
        {
    ...
    public async Task<ApiUsageQueryResult> GetUsageSimplesearchExecutionIdResultsAsync(string executionId, string after = null, int? pageSize = null)
    {
    ...
    public async Task<ApiResponse<ApiUsageQueryResult>> GetUsageSimplesearchExecutionIdResultsAsyncWithHttpInfo(string executionId, string after = null, int? pageSize = null)
    {
        // verify the required parameter 'executionId' is set
        if (executionId == null)
        {
    ...
    public async Task<UsageExecutionResult> PostUsageQueryAsync(ApiUsageOrganizationQuery body)
    {
    ...
    public async Task<ApiResponse<UsageExecutionResult>> PostUsageQueryAsyncWithHttpInfo(ApiUsageOrganizationQuery body)
    {
        // verify the required parameter 'body' is set
        if (body == null)
        {
    ...
    public async Task<UsageExecutionResult> PostUsageSimplesearchAsync(ApiUsageSimpleSearch body)
    {
    ...
    public async Task<ApiResponse<UsageExecutionResult>> PostUsageSimplesearchAsyncWithHttpInfo(ApiUsageSimpleSearch body)
    {
        // verify the required parameter 'body' is set
        if (body == null)
        {
