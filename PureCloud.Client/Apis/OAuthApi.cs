...
public partial class OAuthApi : IOAuthApi
{
    ...
    public ApiResponse<OAuthAuthorization> GetOauthAuthorizationWithHttpInfo(string clientId, string acceptLanguage = null)
    {
        ...
        {
            localVarHeaderParams.Add("Accept-Language", this.Configuration.ApiClient.ParameterToString(acceptLanguage)); // header parameter
        }
    ...
    public ApiResponse<ApiUsageQueryResult> GetOauthClientUsageQueryResultWithHttpInfo(string executionId, string clientId)
    {
        ...
        if (executionId != null)
        {
            localVarPathParams.Add("executionId", this.Configuration.ApiClient.ParameterToString(executionId));
        }
    ...
    public ApiResponse<UsageExecutionResult> GetOauthClientUsageSummaryWithHttpInfo(string clientId, string days = null)
    {
        ...
        if (days != null)
        {
            localVarQueryParams.Add(new Tuple<string, string>("days", this.Configuration.ApiClient.ParameterToString(days)));
        }
    ...
    public ApiResponse<OAuthScope> GetOauthScopeWithHttpInfo(string scopeId, string acceptLanguage = null)
    {
        ...
        if (scopeId != null)
        {
            localVarPathParams.Add("scopeId", this.Configuration.ApiClient.ParameterToString(scopeId));
        }
