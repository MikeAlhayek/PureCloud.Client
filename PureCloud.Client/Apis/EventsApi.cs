...
public interface IEventsApi : IApiAccessor
{
    ...
    Task<BatchEventResponse> PostEventsConversationsAsync(BatchConversationEventRequest body);
    ...
    Task<ApiResponse<BatchEventResponse>> PostEventsConversationsAsyncWithHttpInfo(BatchConversationEventRequest body);
    ...
    Task<BatchEventResponse> PostEventsUsersPresenceAsync(BatchUserPresenceEventRequest body);
    ...
    Task<ApiResponse<BatchEventResponse>> PostEventsUsersPresenceAsyncWithHttpInfo(BatchUserPresenceEventRequest body);
    ...
    Task<BatchEventResponse> PostEventsUsersRoutingstatusAsync(BatchUserRoutingStatusEventRequest body);
    ...
    Task<ApiResponse<BatchEventResponse>> PostEventsUsersRoutingstatusAsyncWithHttpInfo(BatchUserRoutingStatusEventRequest body);
...
public partial class EventsApi : IEventsApi
{
    ...
    public ApiResponse<BatchEventResponse> PostEventsConversationsWithHttpInfo(BatchConversationEventRequest body)
    {
        ...
        return new ApiResponse<BatchEventResponse>(localVarStatusCode,
            localVarHeaders,
            (BatchEventResponse)Configuration.ApiClient.Deserialize(localVarResponse, typeof(BatchEventResponse)),
    ...
    public async Task<BatchEventResponse> PostEventsConversationsAsync(BatchConversationEventRequest body)
    {
    ...
    public async Task<ApiResponse<BatchEventResponse>> PostEventsConversationsAsyncWithHttpInfo(BatchConversationEventRequest body)
    {
        // verify the required parameter 'body' is set
        if (body == null)
        {
    ...
    public async Task<BatchEventResponse> PostEventsUsersPresenceAsync(BatchUserPresenceEventRequest body)
    {
    ...
    public async Task<ApiResponse<BatchEventResponse>> PostEventsUsersPresenceAsyncWithHttpInfo(BatchUserPresenceEventRequest body)
    {
        // verify the required parameter 'body' is set
        if (body == null)
        {
    ...
    public async Task<BatchEventResponse> PostEventsUsersRoutingstatusAsync(BatchUserRoutingStatusEventRequest body)
    {
    ...
    public async Task<ApiResponse<BatchEventResponse>> PostEventsUsersRoutingstatusAsyncWithHttpInfo(BatchUserRoutingStatusEventRequest body)
    {
        // verify the required parameter 'body' is set
        if (body == null)
        {
