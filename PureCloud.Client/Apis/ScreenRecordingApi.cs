...
public interface IScreenRecordingApi : IApiAccessor
{
    ...
    Task<SignedData> PostScreenrecordingTokenAsync(ScreenRecordingUserAuthenticatedInfo body = null);
    ...
    Task<ApiResponse<SignedData>> PostScreenrecordingTokenAsyncWithHttpInfo(ScreenRecordingUserAuthenticatedInfo body = null);
...
public partial class ScreenRecordingApi : IScreenRecordingApi
{
    ...
    /// <returns></returns>
    public ScreenRecordingApi(Configuration configuration = null)
    {
    ...
    public async Task<SignedData> PostScreenrecordingTokenAsync(ScreenRecordingUserAuthenticatedInfo body = null)
    {
    ...
    public async Task<ApiResponse<SignedData>> PostScreenrecordingTokenAsyncWithHttpInfo(ScreenRecordingUserAuthenticatedInfo body = null)
    {
