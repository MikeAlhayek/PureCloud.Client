...
public interface IPresenceApi : IApiAccessor
{
    ...
    /// </summary>
    /// <remarks>
    /// The presence object can be patched one of three ways. Option 1: Set the 'primary' property to true. This will set the PureCloudEnvironment source as the user's primary presence source. Option 2: Provide the presenceDefinition value. The 'id' is the only value required within the presenceDefinition. Option 3: Provide the message value. Option 1 can be combined with Option 2 and/or Option 3.
    /// </remarks>
    /// <exception cref="PureCloudPlatform.Client.V2.Client.ApiException">Thrown when fails to make API call</exception>
    /// <param name="userId">user Id</param>
    /// <param name="body">User presence</param>
    ...
    Task DeletePresenceDefinition0Async(string definitionId);
    ...
    Task<ApiResponse<object>> DeletePresenceDefinition0AsyncWithHttpInfo(string definitionId);
    ...
    Task DeletePresenceSourceAsync(string sourceId);
    ...
    Task<ApiResponse<object>> DeletePresenceSourceAsyncWithHttpInfo(string sourceId);
    ...
    /// <returns>Task of void</returns>
    [Obsolete]
    Task DeletePresencedefinitionAsync(string presenceId);
    ...
    /// <returns>Task of ApiResponse</returns>
    [Obsolete]
    Task<ApiResponse<object>> DeletePresencedefinitionAsyncWithHttpInfo(string presenceId);
    ...
    Task<OrganizationPresenceDefinition> GetPresenceDefinition0Async(string definitionId, string localeCode = null);
    ...
    Task<ApiResponse<OrganizationPresenceDefinition>> GetPresenceDefinition0AsyncWithHttpInfo(string definitionId, string localeCode = null);
    ...
    Task<OrganizationPresenceDefinitionEntityListing> GetPresenceDefinitions0Async(string deactivated = null, List<string> divisionId = null, string localeCode = null);
    ...
    Task<ApiResponse<OrganizationPresenceDefinitionEntityListing>> GetPresenceDefinitions0AsyncWithHttpInfo(string deactivated = null, List<string> divisionId = null, string localeCode = null);
    ...
    Task<PresenceSettings> GetPresenceSettingsAsync();
    ...
    Task<ApiResponse<PresenceSettings>> GetPresenceSettingsAsyncWithHttpInfo();
    ...
    Task<Source> GetPresenceSourceAsync(string sourceId);
    ...
    Task<ApiResponse<Source>> GetPresenceSourceAsyncWithHttpInfo(string sourceId);
    ...
    Task<SourceEntityListing> GetPresenceSourcesAsync(string deactivated = null);
    ...
    Task<ApiResponse<SourceEntityListing>> GetPresenceSourcesAsyncWithHttpInfo(string deactivated = null);
    ...
    Task<UserPrimarySource> GetPresenceUserPrimarysourceAsync(string userId);
    ...
    Task<ApiResponse<UserPrimarySource>> GetPresenceUserPrimarysourceAsyncWithHttpInfo(string userId);
    ...
    [Obsolete]
    Task<OrganizationPresence> GetPresencedefinitionAsync(string presenceId, string localeCode = null);
    ...
    [Obsolete]
    Task<ApiResponse<OrganizationPresence>> GetPresencedefinitionAsyncWithHttpInfo(string presenceId, string localeCode = null);
    ...
    [Obsolete]
    Task<OrganizationPresenceEntityListing> GetPresencedefinitionsAsync(int? pageNumber = null, int? pageSize = null, string deleted = null, string localeCode = null);
    ...
    [Obsolete]
    Task<ApiResponse<OrganizationPresenceEntityListing>> GetPresencedefinitionsAsyncWithHttpInfo(int? pageNumber = null, int? pageSize = null, string deleted = null, string localeCode = null);
    ...
    Task<List<SystemPresence>> GetSystempresencesAsync();
    ...
    Task<ApiResponse<List<SystemPresence>>> GetSystempresencesAsyncWithHttpInfo();
    ...
    Task<UserPresence> GetUserPresenceAsync(string userId, string sourceId);
    ...
    Task<ApiResponse<UserPresence>> GetUserPresenceAsyncWithHttpInfo(string userId, string sourceId);
    ...
    Task<UserPresence> GetUserPresencesPurecloudAsync(string userId);
    ...
    Task<ApiResponse<UserPresence>> GetUserPresencesPurecloudAsyncWithHttpInfo(string userId);
    ...
    Task<List<UcUserPresence>> GetUsersPresenceBulkAsync(string sourceId, List<string> id = null);
    ...
    Task<ApiResponse<List<UcUserPresence>>> GetUsersPresenceBulkAsyncWithHttpInfo(string sourceId, List<string> id = null);
    ...
    Task<List<UcUserPresence>> GetUsersPresencesPurecloudBulkAsync(List<string> id = null);
    ...
    Task<ApiResponse<List<UcUserPresence>>> GetUsersPresencesPurecloudBulkAsyncWithHttpInfo(List<string> id = null);
    ...
    Task<UserPresence> PatchUserPresenceAsync(string userId, string sourceId, UserPresence body);
    ...
    Task<ApiResponse<UserPresence>> PatchUserPresenceAsyncWithHttpInfo(string userId, string sourceId, UserPresence body);
    ...
    Task<UserPresence> PatchUserPresencesPurecloudAsync(string userId, UserPresence body);
    ...
    Task<ApiResponse<UserPresence>> PatchUserPresencesPurecloudAsyncWithHttpInfo(string userId, UserPresence body);
    ...
    Task<OrganizationPresenceDefinition> PostPresenceDefinitions0Async(OrganizationPresenceDefinition body);
    ...
    Task<ApiResponse<OrganizationPresenceDefinition>> PostPresenceDefinitions0AsyncWithHttpInfo(OrganizationPresenceDefinition body);
    ...
    Task<Source> PostPresenceSourcesAsync(Source body);
    ...
    Task<ApiResponse<Source>> PostPresenceSourcesAsyncWithHttpInfo(Source body);
    ...
    /// <returns>Task of OrganizationPresence</returns>
    [Obsolete]
    Task<OrganizationPresence> PostPresencedefinitionsAsync(OrganizationPresence body);
    ...
    /// <returns>Task of ApiResponse (OrganizationPresence)</returns>
    [Obsolete]
    Task<ApiResponse<OrganizationPresence>> PostPresencedefinitionsAsyncWithHttpInfo(OrganizationPresence body);
    ...
    Task<OrganizationPresenceDefinition> PutPresenceDefinition0Async(string definitionId, OrganizationPresenceDefinition body);
    ...
    Task<ApiResponse<OrganizationPresenceDefinition>> PutPresenceDefinition0AsyncWithHttpInfo(string definitionId, OrganizationPresenceDefinition body);
    ...
    Task<PresenceSettings> PutPresenceSettingsAsync(PresenceSettings body);
    ...
    Task<ApiResponse<PresenceSettings>> PutPresenceSettingsAsyncWithHttpInfo(PresenceSettings body);
    ...
    Task<Source> PutPresenceSourceAsync(string sourceId, Source body);
    ...
    Task<ApiResponse<Source>> PutPresenceSourceAsyncWithHttpInfo(string sourceId, Source body);
    ...
    Task<UserPrimarySource> PutPresenceUserPrimarysourceAsync(string userId, UserPrimarySource body);
    ...
    Task<ApiResponse<UserPrimarySource>> PutPresenceUserPrimarysourceAsyncWithHttpInfo(string userId, UserPrimarySource body);
    ...
    /// <returns>Task of OrganizationPresence</returns>
    [Obsolete]
    Task<OrganizationPresence> PutPresencedefinitionAsync(string presenceId, OrganizationPresence body);
    ...
    /// <returns>Task of ApiResponse (OrganizationPresence)</returns>
    [Obsolete]
    Task<ApiResponse<OrganizationPresence>> PutPresencedefinitionAsyncWithHttpInfo(string presenceId, OrganizationPresence body);
    ...
    Task<List<UserPresence>> PutUsersPresencesBulkAsync(List<MutableUserPresence> body);
    ...
    Task<ApiResponse<List<UserPresence>>> PutUsersPresencesBulkAsyncWithHttpInfo(List<MutableUserPresence> body);
...
public partial class PresenceApi : IPresenceApi
{
    ...
    public async Task DeletePresenceDefinition0Async(string definitionId)
    {
    ...
    public async Task<ApiResponse<object>> DeletePresenceDefinition0AsyncWithHttpInfo(string definitionId)
    {
        // verify the required parameter 'definitionId' is set
        if (definitionId == null)
        {
    ...
    public async Task DeletePresenceSourceAsync(string sourceId)
    {
    ...
    public async Task<ApiResponse<object>> DeletePresenceSourceAsyncWithHttpInfo(string sourceId)
    {
        // verify the required parameter 'sourceId' is set
        if (sourceId == null)
        {
    ...
    /// <returns>Task of void</returns>
    [Obsolete]
    public async Task DeletePresencedefinitionAsync(string presenceId)
    {
    ...
    /// <returns>Task of ApiResponse</returns>
    [Obsolete]
    public async Task<ApiResponse<object>> DeletePresencedefinitionAsyncWithHttpInfo(string presenceId)
    {
        // verify the required parameter 'presenceId' is set
        if (presenceId == null)
        {
    ...
    public async Task<OrganizationPresenceDefinition> GetPresenceDefinition0Async(string definitionId, string localeCode = null)
    {
    ...
    public async Task<ApiResponse<OrganizationPresenceDefinition>> GetPresenceDefinition0AsyncWithHttpInfo(string definitionId, string localeCode = null)
    {
        // verify the required parameter 'definitionId' is set
        if (definitionId == null)
        {
    ...
    public async Task<OrganizationPresenceDefinitionEntityListing> GetPresenceDefinitions0Async(string deactivated = null, List<string> divisionId = null, string localeCode = null)
    {
    ...
    public async Task<ApiResponse<OrganizationPresenceDefinitionEntityListing>> GetPresenceDefinitions0AsyncWithHttpInfo(string deactivated = null, List<string> divisionId = null, string localeCode = null)
    {
    ...
    public async Task<PresenceSettings> GetPresenceSettingsAsync()
    {
    ...
    public async Task<ApiResponse<PresenceSettings>> GetPresenceSettingsAsyncWithHttpInfo()
    {
    ...
    public async Task<Source> GetPresenceSourceAsync(string sourceId)
    {
    ...
    public async Task<ApiResponse<Source>> GetPresenceSourceAsyncWithHttpInfo(string sourceId)
    {
        // verify the required parameter 'sourceId' is set
        if (sourceId == null)
        {
    ...
    public async Task<SourceEntityListing> GetPresenceSourcesAsync(string deactivated = null)
    {
    ...
    public async Task<ApiResponse<SourceEntityListing>> GetPresenceSourcesAsyncWithHttpInfo(string deactivated = null)
    {
    ...
    public async Task<UserPrimarySource> GetPresenceUserPrimarysourceAsync(string userId)
    {
    ...
    public async Task<ApiResponse<UserPrimarySource>> GetPresenceUserPrimarysourceAsyncWithHttpInfo(string userId)
    {
        // verify the required parameter 'userId' is set
        if (userId == null)
        {
    ...
    /// <returns>Task of OrganizationPresence</returns>
    [Obsolete]
    public async Task<OrganizationPresence> GetPresencedefinitionAsync(string presenceId, string localeCode = null)
    {
    ...
    /// <returns>Task of ApiResponse (OrganizationPresence)</returns>
    [Obsolete]
    public async Task<ApiResponse<OrganizationPresence>> GetPresencedefinitionAsyncWithHttpInfo(string presenceId, string localeCode = null)
    {
        // verify the required parameter 'presenceId' is set
        if (presenceId == null)
        {
    ...
    /// <returns>Task of OrganizationPresenceEntityListing</returns>
    [Obsolete]
    public async Task<OrganizationPresenceEntityListing> GetPresencedefinitionsAsync(int? pageNumber = null, int? pageSize = null, string deleted = null, string localeCode = null)
    {
    ...
    /// <returns>Task of ApiResponse (OrganizationPresenceEntityListing)</returns>
    [Obsolete]
    public async Task<ApiResponse<OrganizationPresenceEntityListing>> GetPresencedefinitionsAsyncWithHttpInfo(int? pageNumber = null, int? pageSize = null, string deleted = null, string localeCode = null)
    {
    ...
    public async Task<List<SystemPresence>> GetSystempresencesAsync()
    {
    ...
    public async Task<ApiResponse<List<SystemPresence>>> GetSystempresencesAsyncWithHttpInfo()
    {
    ...
    public async Task<UserPresence> GetUserPresenceAsync(string userId, string sourceId)
    {
    ...
    public async Task<ApiResponse<UserPresence>> GetUserPresenceAsyncWithHttpInfo(string userId, string sourceId)
    {
        // verify the required parameter 'userId' is set
        if (userId == null)
        {
    ...
    public async Task<UserPresence> GetUserPresencesPurecloudAsync(string userId)
    {
    ...
    public async Task<ApiResponse<UserPresence>> GetUserPresencesPurecloudAsyncWithHttpInfo(string userId)
    {
        // verify the required parameter 'userId' is set
        if (userId == null)
        {
    ...
    public async Task<List<UcUserPresence>> GetUsersPresenceBulkAsync(string sourceId, List<string> id = null)
    {
    ...
    public async Task<ApiResponse<List<UcUserPresence>>> GetUsersPresenceBulkAsyncWithHttpInfo(string sourceId, List<string> id = null)
    {
        // verify the required parameter 'sourceId' is set
        if (sourceId == null)
        {
    ...
    public async Task<List<UcUserPresence>> GetUsersPresencesPurecloudBulkAsync(List<string> id = null)
    {
    ...
    public async Task<ApiResponse<List<UcUserPresence>>> GetUsersPresencesPurecloudBulkAsyncWithHttpInfo(List<string> id = null)
    {
    ...
    public async Task<UserPresence> PatchUserPresenceAsync(string userId, string sourceId, UserPresence body)
    {
    ...
    public async Task<ApiResponse<UserPresence>> PatchUserPresenceAsyncWithHttpInfo(string userId, string sourceId, UserPresence body)
    {
        // verify the required parameter 'userId' is set
        if (userId == null)
        {
    ...
    public async Task<UserPresence> PatchUserPresencesPurecloudAsync(string userId, UserPresence body)
    {
    ...
    public async Task<ApiResponse<UserPresence>> PatchUserPresencesPurecloudAsyncWithHttpInfo(string userId, UserPresence body)
    {
        // verify the required parameter 'userId' is set
        if (userId == null)
        {
    ...
    public async Task<OrganizationPresenceDefinition> PostPresenceDefinitions0Async(OrganizationPresenceDefinition body)
    {
    ...
    public async Task<ApiResponse<OrganizationPresenceDefinition>> PostPresenceDefinitions0AsyncWithHttpInfo(OrganizationPresenceDefinition body)
    {
        // verify the required parameter 'body' is set
        if (body == null)
        {
    ...
    public async Task<Source> PostPresenceSourcesAsync(Source body)
    {
    ...
    public async Task<ApiResponse<Source>> PostPresenceSourcesAsyncWithHttpInfo(Source body)
    {
        // verify the required parameter 'body' is set
        if (body == null)
        {
    ...
    /// <returns>Task of OrganizationPresence</returns>
    [Obsolete]
    public async Task<OrganizationPresence> PostPresencedefinitionsAsync(OrganizationPresence body)
    {
    ...
    /// <returns>Task of ApiResponse (OrganizationPresence)</returns>
    [Obsolete]
    public async Task<ApiResponse<OrganizationPresence>> PostPresencedefinitionsAsyncWithHttpInfo(OrganizationPresence body)
    {
        // verify the required parameter 'body' is set
        if (body == null)
        {
    ...
    public async Task<OrganizationPresenceDefinition> PutPresenceDefinition0Async(string definitionId, OrganizationPresenceDefinition body)
    {
    ...
    public async Task<ApiResponse<OrganizationPresenceDefinition>> PutPresenceDefinition0AsyncWithHttpInfo(string definitionId, OrganizationPresenceDefinition body)
    {
        // verify the required parameter 'definitionId' is set
        if (definitionId == null)
        {
    ...
    public async Task<PresenceSettings> PutPresenceSettingsAsync(PresenceSettings body)
    {
    ...
    public async Task<ApiResponse<PresenceSettings>> PutPresenceSettingsAsyncWithHttpInfo(PresenceSettings body)
    {
        // verify the required parameter 'body' is set
        if (body == null)
        {
    ...
    public async Task<Source> PutPresenceSourceAsync(string sourceId, Source body)
    {
    ...
    public async Task<ApiResponse<Source>> PutPresenceSourceAsyncWithHttpInfo(string sourceId, Source body)
    {
        // verify the required parameter 'sourceId' is set
        if (sourceId == null)
        {
    ...
    public async Task<UserPrimarySource> PutPresenceUserPrimarysourceAsync(string userId, UserPrimarySource body)
    {
    ...
    public async Task<ApiResponse<UserPrimarySource>> PutPresenceUserPrimarysourceAsyncWithHttpInfo(string userId, UserPrimarySource body)
    {
        // verify the required parameter 'userId' is set
        if (userId == null)
        {
    ...
    /// <returns>Task of OrganizationPresence</returns>
    [Obsolete]
    public async Task<OrganizationPresence> PutPresencedefinitionAsync(string presenceId, OrganizationPresence body)
    {
    ...
    /// <returns>Task of ApiResponse (OrganizationPresence)</returns>
    [Obsolete]
    public async Task<ApiResponse<OrganizationPresence>> PutPresencedefinitionAsyncWithHttpInfo(string presenceId, OrganizationPresence body)
    {
        // verify the required parameter 'presenceId' is set
        if (presenceId == null)
        {
    ...
    public async Task<List<UserPresence>> PutUsersPresencesBulkAsync(List<MutableUserPresence> body)
    {
    ...
    public async Task<ApiResponse<List<UserPresence>>> PutUsersPresencesBulkAsyncWithHttpInfo(List<MutableUserPresence> body)
    {
        // verify the required parameter 'body' is set
        if (body == null)
        {
