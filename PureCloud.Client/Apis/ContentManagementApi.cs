...
public partial class ContentManagementApi : IContentManagementApi
{
    ...
    public ApiResponse<object> DeleteContentmanagementDocumentWithHttpInfo(string documentId, bool? _override = null)
    {
        ...
        if (_override != null)
        {
            localVarQueryParams.Add(new Tuple<string, string>("override", Configuration.ApiClient.ParameterToString(_override)));
        }
    ...
    public ApiResponse<object> DeleteContentmanagementShareWithHttpInfo(string shareId)
    {
        ...
        if (shareId != null)
        {
            localVarPathParams.Add("shareId", Configuration.ApiClient.ParameterToString(shareId));
        }
    ...
    public ApiResponse<object> DeleteContentmanagementWorkspaceWithHttpInfo(string workspaceId, string moveChildrenToWorkspaceId = null)
    {
        ...
        if (workspaceId != null)
        {
            localVarPathParams.Add("workspaceId", Configuration.ApiClient.ParameterToString(workspaceId));
        }

        // Query params
        if (moveChildrenToWorkspaceId != null)
        {
            localVarQueryParams.Add(new Tuple<string, string>("moveChildrenToWorkspaceId", Configuration.ApiClient.ParameterToString(moveChildrenToWorkspaceId)));
        }
    ...
    public ApiResponse<object> DeleteContentmanagementWorkspaceTagvalueWithHttpInfo(string workspaceId, string tagId)
    {
        ...
        if (tagId != null)
        {
            localVarPathParams.Add("tagId", Configuration.ApiClient.ParameterToString(tagId));
        }
    ...
    public ApiResponse<DownloadResponse> GetContentmanagementDocumentContentWithHttpInfo(string documentId, string disposition = null, string contentType = null)
    {
        ...
        if (disposition != null)
        {
            localVarQueryParams.Add(new Tuple<string, string>("disposition", Configuration.ApiClient.ParameterToString(disposition)));
        }

        if (contentType != null)
        {
            localVarQueryParams.Add(new Tuple<string, string>("contentType", Configuration.ApiClient.ParameterToString(contentType)));
        }
    ...
    public ApiResponse<DocumentEntityListing> GetContentmanagementDocumentsWithHttpInfo(string workspaceId, string name = null, List<string> expand = null, int? pageSize = null, int? pageNumber = null, string sortBy = null, string sortOrder = null)
    {
        ...
        if (workspaceId != null)
        {
            localVarQueryParams.Add(new Tuple<string, string>("workspaceId", Configuration.ApiClient.ParameterToString(workspaceId)));
        }
    ...
    public ApiResponse<QueryResults> GetContentmanagementQueryWithHttpInfo(string queryPhrase, int? pageSize = null, int? pageNumber = null, string sortBy = null, string sortOrder = null, List<string> expand = null)
    {
        ...
        if (queryPhrase != null)
        {
            localVarQueryParams.Add(new Tuple<string, string>("queryPhrase", Configuration.ApiClient.ParameterToString(queryPhrase)));
        }
    ...
    public ApiResponse<SecurityProfile> GetContentmanagementSecurityprofileWithHttpInfo(string securityProfileId)
    {
        ...
        if (securityProfileId != null)
        {
            localVarPathParams.Add("securityProfileId", Configuration.ApiClient.ParameterToString(securityProfileId));
        }
    ...
    public ApiResponse<SharedResponse> GetContentmanagementSharedSharedIdWithHttpInfo(string sharedId, string disposition = null, string contentType = null, string expand = null)
    {
        ...
        if (sharedId != null)
        {
            localVarPathParams.Add("sharedId", Configuration.ApiClient.ParameterToString(sharedId));
        }
    ...
    public ApiResponse<ShareEntityListing> GetContentmanagementSharesWithHttpInfo(string entityId = null, List<string> expand = null, int? pageSize = null, int? pageNumber = null)
    {
        ...
        if (entityId != null)
        {
            localVarQueryParams.Add(new Tuple<string, string>("entityId", Configuration.ApiClient.ParameterToString(entityId)));
        }
    ...
    public ApiResponse<TagValueEntityListing> GetContentmanagementWorkspaceTagvaluesWithHttpInfo(string workspaceId, string value = null, int? pageSize = null, int? pageNumber = null, List<string> expand = null)
    {
        ...
        if (value != null)
        {
            localVarQueryParams.Add(new Tuple<string, string>("value", Configuration.ApiClient.ParameterToString(value)));
        }
    ...
    public ApiResponse<WorkspaceEntityListing> GetContentmanagementWorkspacesWithHttpInfo(int? pageSize = null, int? pageNumber = null, List<string> access = null, List<string> expand = null)
    {
        ...
        if (access != null)
        {
            access.ForEach(obj => { localVarQueryParams.Add(new Tuple<string, string>("access", Configuration.ApiClient.ParameterToString(obj))); });
        }
    ...
    public ApiResponse<Document> PostContentmanagementDocumentsWithHttpInfo(DocumentUpload body, string copySource = null, string moveSource = null, bool? _override = null)
    {
        ...
        if (copySource != null)
        {
            localVarQueryParams.Add(new Tuple<string, string>("copySource", Configuration.ApiClient.ParameterToString(copySource)));
        }

        if (moveSource != null)
        {
            localVarQueryParams.Add(new Tuple<string, string>("moveSource", Configuration.ApiClient.ParameterToString(moveSource)));
        }
