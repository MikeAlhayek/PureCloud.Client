...
public interface IOrganizationApi
{
    ...
    Task<LimitDocumentation> GetOrganizationLimitsDocumentationAsync(CancellationToken cancellationToken = default);
    ...
    Task<FreeTrialLimitDocs> GetOrganizationLimitsFreeTrialDocumentationAsync(CancellationToken cancellationToken = default);
