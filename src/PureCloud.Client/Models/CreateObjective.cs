...
public sealed class CreateObjective
{
    ...
    public CreateObjectiveTopicIdsFilterTypeEnum? TopicIdsFilterType { get; set; }
    /// <summary>
    /// The initial direction to filter on
    /// </summary>
    /// <value>The initial direction to filter on</value>
    public CreateObjectiveInitialDirectionEnum? InitialDirection { get; set; }
    ...
    public IEnumerable<CreateObjectiveMediaTypesEnum> MediaTypes { get; set; }
