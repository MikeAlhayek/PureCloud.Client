...
public sealed class Salesforce
{
    /// <summary>
    /// Gets or Sets NameIdentifierFormat
    /// </summary>
    public SalesforceNameIdentifierFormatEnum? NameIdentifierFormat { get; set; }

    /// <summary>
    /// Gets or Sets SsoBinding
    /// </summary>
    public SalesforceSsoBindingEnum? SsoBinding { get; set; }
