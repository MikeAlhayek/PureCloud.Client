...
public partial class ExtensionPool : IEquatable<ExtensionPool>
{
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as ExtensionPool);
    }
    ...
    public bool Equals(ExtensionPool other)
    {
        ...
        return true &&
            ...
            (
                ...
                StartNumber != null &&
                StartNumber.Equals(other.StartNumber)
            ) &&
            (
                EndNumber == other.EndNumber ||
                EndNumber != null &&
                EndNumber.Equals(other.EndNumber)
            ) &&
            (
    ...
    public override int GetHashCode()
    {
        ...
        unchecked // Overflow is fine, just wrap
        {
            ...
            if (StartNumber != null)
            {
                hash = hash * 59 + StartNumber.GetHashCode();
            }

            if (EndNumber != null)
            {
                hash = hash * 59 + EndNumber.GetHashCode();
            }
