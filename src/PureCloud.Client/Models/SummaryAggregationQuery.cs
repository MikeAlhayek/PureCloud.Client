...
public sealed class SummaryAggregationQuery
{
    /// <summary>
    ...
    public SummaryAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public SummaryAggregationQueryQueryTypeEnum? QueryType { get; set; }
    ...
    public IEnumerable<SummaryAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<SummaryAggregationQueryMetricsEnum> Metrics { get; set; }
