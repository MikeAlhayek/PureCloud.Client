...
public sealed class FlowAggregationQuery
{
    /// <summary>
    ...
    public FlowAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public IEnumerable<FlowAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<FlowAggregationQueryMetricsEnum> Metrics { get; set; }
