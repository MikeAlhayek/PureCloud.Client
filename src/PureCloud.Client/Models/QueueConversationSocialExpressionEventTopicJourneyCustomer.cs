...
public partial class QueueConversationSocialExpressionEventTopicJourneyCustomer : IEquatable<QueueConversationSocialExpressionEventTopicJourneyCustomer>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="QueueConversationSocialExpressionEventTopicJourneyCustomer" /> class.
    /// </summary>
    ...
    public QueueConversationSocialExpressionEventTopicJourneyCustomer(string Id = null, string IdType = null)
    {
        this.Id = Id;
        this.IdType = IdType;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class QueueConversationSocialExpressionEventTopicJourneyCustomer {\n");
    ...
    /// <summary>
    /// Returns true if QueueConversationSocialExpressionEventTopicJourneyCustomer instances are equal
    /// </summary>
    /// <param name="other">Instance of QueueConversationSocialExpressionEventTopicJourneyCustomer to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(QueueConversationSocialExpressionEventTopicJourneyCustomer other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
