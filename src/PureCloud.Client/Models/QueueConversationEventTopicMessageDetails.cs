...
public sealed class QueueConversationEventTopicMessageDetails
{
    /// <summary>
    ...
    public IEnumerable<QueueConversationEventTopicMessageMedia> Media { get; set; }
    ...
    public IEnumerable<QueueConversationEventTopicMessageSticker> Stickers { get; set; }
