...
public partial class CustomProvider : IEquatable<CustomProvider>
{
    ...
    /// </summary>
    [JsonPropertyName("endpointCompression")]
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as CustomProvider);
    }

    /// <summary>
    /// Returns true if CustomProvider instances are equal
    /// </summary>
    /// <param name="other">Instance of CustomProvider to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(CustomProvider other)
    {
        ...
        return true &&
            ...
            (
                EndpointCompression == other.EndpointCompression ||
                EndpointCompression != null &&
                EndpointCompression.Equals(other.EndpointCompression)
            ) &&
            (
    ...
    public override int GetHashCode()
    {
        ...
        unchecked // Overflow is fine, just wrap
        {
            ...
            if (EndpointCompression != null)
            {
                hash = hash * 59 + EndpointCompression.GetHashCode();
            }
