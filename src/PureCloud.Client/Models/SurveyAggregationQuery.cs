...
public sealed class SurveyAggregationQuery
{
    /// <summary>
    ...
    public SurveyAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public IEnumerable<SurveyAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<SurveyAggregationQueryMetricsEnum> Metrics { get; set; }
