...
public sealed class DialerCampaignScheduleConfigChangeCampaignSchedule
{
    /// <summary>
    /// a list of start and end times
    /// </summary>
    /// <value>a list of start and end times</value>
    public IEnumerable<DialerCampaignScheduleConfigChangeScheduleInterval> Intervals { get; set; }

    /// <summary>
    /// a list of recurrences for a schedule
    /// </summary>
    /// <value>a list of recurrences for a schedule</value>
    public IEnumerable<DialerCampaignScheduleConfigChangeScheduleRecurrence> Recurrences { get; set; }
