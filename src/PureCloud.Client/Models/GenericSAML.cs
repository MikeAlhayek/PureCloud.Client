...
public sealed class GenericSAML
{
    /// <summary>
    /// Gets or Sets NameIdentifierFormat
    /// </summary>
    public GenericSAMLNameIdentifierFormatEnum? NameIdentifierFormat { get; set; }

    /// <summary>
    /// Gets or Sets SsoBinding
    /// </summary>
    public GenericSAMLSsoBindingEnum? SsoBinding { get; set; }
