...
public partial class ServiceNowSourceResponse : IEquatable<ServiceNowSourceResponse>
{
    ...
    public ServiceNowSourceResponse(string Name = null, DateTime? DateCreated = null, DateTime? DateModified = null, TypeEnum? Type = null, KnowledgeIntegrationReference Integration = null, int? SchedulePeriod = null, SourceLastSync LastSync = null, ServiceNowSettings Settings = null)
    {
        this.Name = Name;
    ...
    /// <summary>
    /// Returns true if ServiceNowSourceResponse instances are equal
    /// </summary>
    /// <param name="other">Instance of ServiceNowSourceResponse to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ServiceNowSourceResponse other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
