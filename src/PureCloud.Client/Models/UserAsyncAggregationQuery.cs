...
public sealed class UserAsyncAggregationQuery
{
    /// <summary>
    ...
    public UserAsyncAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public IEnumerable<UserAsyncAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<UserAsyncAggregationQueryMetricsEnum> Metrics { get; set; }
