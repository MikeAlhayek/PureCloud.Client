...
public partial class StatEventUserTopicStatsNotification : IEquatable<StatEventUserTopicStatsNotification>
{
    ...
    public StatEventUserTopicStatsNotification(Dictionary<string, string> Group = null, List<StatEventUserTopicIntervalMetrics> Data = null)
    {
        this.Group = Group;
        this.Data = Data;
    ...
    public List<StatEventUserTopicIntervalMetrics> Data { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as StatEventUserTopicStatsNotification);
    }
