...
public sealed class ResolutionAsyncAggregationQuery
{
    /// <summary>
    ...
    public ResolutionAsyncAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public IEnumerable<ResolutionAsyncAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<ResolutionAsyncAggregationQueryMetricsEnum> Metrics { get; set; }
    ...
    public IEnumerable<ResolutionAggregationView> Views { get; set; }
