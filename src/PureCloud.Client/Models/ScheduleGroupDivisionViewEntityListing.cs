...
public partial class ScheduleGroupDivisionViewEntityListing : IEquatable<ScheduleGroupDivisionViewEntityListing>, IPagedResource<ScheduleGroupDivisionView>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ScheduleGroupDivisionViewEntityListing" /> class.
    /// </summary>
    ...
    public ScheduleGroupDivisionViewEntityListing(List<ScheduleGroupDivisionView> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, long? TotalNumberOfEntities = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public List<ScheduleGroupDivisionView> Entities { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ScheduleGroupDivisionViewEntityListing {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as ScheduleGroupDivisionViewEntityListing);
    }

    /// <summary>
    /// Returns true if ScheduleGroupDivisionViewEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of ScheduleGroupDivisionViewEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ScheduleGroupDivisionViewEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
