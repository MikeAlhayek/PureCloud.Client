...
public sealed class SummaryAsyncAggregationQuery
{
    /// <summary>
    ...
    public SummaryAsyncAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public SummaryAsyncAggregationQueryQueryTypeEnum? QueryType { get; set; }
    ...
    public IEnumerable<SummaryAsyncAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<SummaryAsyncAggregationQueryMetricsEnum> Metrics { get; set; }
    ...
    public IEnumerable<SummaryAggregationView> Views { get; set; }
