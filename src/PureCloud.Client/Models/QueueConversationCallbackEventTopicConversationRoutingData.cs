...
public sealed class QueueConversationCallbackEventTopicConversationRoutingData
{
    /// <summary>
    ...
    public IEnumerable<QueueConversationCallbackEventTopicUriReference> Skills { get; set; }
    ...
    public IEnumerable<QueueConversationCallbackEventTopicScoredAgent> ScoredAgents { get; set; }
}
