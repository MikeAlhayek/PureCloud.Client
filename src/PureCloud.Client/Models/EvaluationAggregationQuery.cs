...
public sealed class EvaluationAggregationQuery
{
    /// <summary>
    ...
    public EvaluationAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public IEnumerable<EvaluationAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<EvaluationAggregationQueryMetricsEnum> Metrics { get; set; }
