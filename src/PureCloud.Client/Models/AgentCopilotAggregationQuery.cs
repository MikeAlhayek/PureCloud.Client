...
public sealed class AgentCopilotAggregationQuery
{
    /// <summary>
    ...
    public AgentCopilotAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public AgentCopilotAggregationQueryQueryTypeEnum? QueryType { get; set; }
    ...
    public IEnumerable<AgentCopilotAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<AgentCopilotAggregationQueryMetricsEnum> Metrics { get; set; }
