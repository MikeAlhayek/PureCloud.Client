...
public sealed class SummaryAggregationView
{
    /// <summary>
    /// Target metric name
    /// </summary>
    /// <value>Target metric name</value>
    public SummaryAggregationViewTargetEnum? Target { get; set; }

    /// <summary>
    /// Type of view you wish to create
    /// </summary>
    /// <value>Type of view you wish to create</value>
    public SummaryAggregationViewFunctionEnum? Function { get; set; }
