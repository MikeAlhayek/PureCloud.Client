...
public sealed class QueueConversationSocialExpressionEventTopicInternalMessage
{
    /// <summary>
    /// Gets or Sets State
    /// </summary>
    public QueueConversationSocialExpressionEventTopicInternalMessageStateEnum? State { get; set; }

    /// <summary>
    /// Gets or Sets InitialState
    /// </summary>
    public QueueConversationSocialExpressionEventTopicInternalMessageInitialStateEnum? InitialState { get; set; }

    /// <summary>
    /// System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.
    /// </summary>
    /// <value>System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.</value>
    public QueueConversationSocialExpressionEventTopicInternalMessageDisconnectTypeEnum? DisconnectType { get; set; }
    ...
    public IEnumerable<QueueConversationSocialExpressionEventTopicInternalMessageDetails> Messages { get; set; }
}
