...
public sealed class QueueConversationChatEventTopicConversationRoutingData
{
    /// <summary>
    ...
    public IEnumerable<QueueConversationChatEventTopicUriReference> Skills { get; set; }
    ...
    public IEnumerable<QueueConversationChatEventTopicScoredAgent> ScoredAgents { get; set; }
}
