...
public sealed class DialerCampaignScheduleConfigChangeRecurrencePattern
{
    /// <summary>
    /// Gets or Sets Type
    /// </summary>
    public DialerCampaignScheduleConfigChangeRecurrencePatternTypeEnum? Type { get; set; }
