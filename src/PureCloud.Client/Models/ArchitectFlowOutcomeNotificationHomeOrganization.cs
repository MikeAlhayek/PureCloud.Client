...
public partial class ArchitectFlowOutcomeNotificationHomeOrganization : IEquatable<ArchitectFlowOutcomeNotificationHomeOrganization>
{
    ...
    public ArchitectFlowOutcomeNotificationHomeOrganization(string Id = null, string Name = null, string ThirdPartyOrgName = null)
    {
        this.Id = Id;
        this.Name = Name;
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as ArchitectFlowOutcomeNotificationHomeOrganization);
    }

    /// <summary>
    /// Returns true if ArchitectFlowOutcomeNotificationHomeOrganization instances are equal
    /// </summary>
    /// <param name="other">Instance of ArchitectFlowOutcomeNotificationHomeOrganization to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ArchitectFlowOutcomeNotificationHomeOrganization other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
