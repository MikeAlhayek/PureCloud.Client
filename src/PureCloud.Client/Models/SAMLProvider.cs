...
public sealed class SAMLProvider
{
    /// <summary>
    /// Gets or Sets NameIdentifierFormat
    /// </summary>
    public SAMLProviderNameIdentifierFormatEnum? NameIdentifierFormat { get; set; }

    /// <summary>
    /// Gets or Sets SsoBinding
    /// </summary>
    public SAMLProviderSsoBindingEnum? SsoBinding { get; set; }
