...
public sealed class TranscriptConversationDetailSearchCriteria
{
    /// <summary>
    /// How to apply this search criteria against other criteria
    /// </summary>
    /// <value>How to apply this search criteria against other criteria</value>
    public TranscriptConversationDetailSearchCriteriaOperatorEnum? Operator { get; set; }

    /// <summary>
    /// Gets or Sets Type
    /// </summary>
    public TranscriptConversationDetailSearchCriteriaTypeEnum? Type { get; set; }
    ...
    public IEnumerable<TranscriptConversationDetailSearchCriteria> Group { get; set; }
