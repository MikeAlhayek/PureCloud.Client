...
/// <summary>
/// Conversation - using existing model structure instead of creating new simplified version
/// </summary>
public partial class Conversation : IEquatable<Conversation>
{
    ...
    /// <param name="StartTime">The time when the conversation started. This will be the time when the first participant joined the conversation. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z.</param>
    ...
    public Conversation(string Name = null, string ExternalTag = null, DateTime? StartTime = null, DateTime? EndTime = null, List<ConversationDivisionMembership> Divisions = null, bool? SecurePause = null, string UtilizationLabelId = null)
    {
        this.Name = Name;
    ...
    public bool Equals(Conversation other)
    {
        ...
        return true &&
            ...
            (ExternalTag == other.ExternalTag || ExternalTag != null && ExternalTag.Equals(other.ExternalTag)) &&
            (StartTime == other.StartTime || StartTime != null && StartTime.Equals(other.StartTime)) &&
            (EndTime == other.EndTime || EndTime != null && EndTime.Equals(other.EndTime)) &&
            (Divisions == other.Divisions || Divisions != null && Divisions.SequenceEqual(other.Divisions)) &&
            (SecurePause == other.SecurePause || SecurePause != null && SecurePause.Equals(other.SecurePause)) &&
            (UtilizationLabelId == other.UtilizationLabelId || UtilizationLabelId != null && UtilizationLabelId.Equals(other.UtilizationLabelId)) &&
            (SelfUri == other.SelfUri || SelfUri != null && SelfUri.Equals(other.SelfUri)) &&
            (Participants == other.Participants || Participants != null && Participants.SequenceEqual(other.Participants));
    }
    ...
    public override int GetHashCode()
    {
        unchecked
        {
            ...
            if (ExternalTag != null) hash = hash * 59 + ExternalTag.GetHashCode();
            if (StartTime != null) hash = hash * 59 + StartTime.GetHashCode();
            if (EndTime != null) hash = hash * 59 + EndTime.GetHashCode();
            if (Divisions != null) hash = hash * 59 + Divisions.GetHashCode();
            if (SecurePause != null) hash = hash * 59 + SecurePause.GetHashCode();
            if (UtilizationLabelId != null) hash = hash * 59 + UtilizationLabelId.GetHashCode();
            if (SelfUri != null) hash = hash * 59 + SelfUri.GetHashCode();
            if (Participants != null) hash = hash * 59 + Participants.GetHashCode();
            return hash;
        }
    }
}