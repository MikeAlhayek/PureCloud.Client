...
public sealed class ConversationVideoEventTopicConversationRoutingData
{
    /// <summary>
    ...
    public IEnumerable<ConversationVideoEventTopicUriReference> Skills { get; set; }
    ...
    public IEnumerable<ConversationVideoEventTopicScoredAgent> ScoredAgents { get; set; }
}
