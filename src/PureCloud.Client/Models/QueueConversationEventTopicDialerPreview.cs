...
public sealed class QueueConversationEventTopicDialerPreview
{
    /// <summary>
    /// Gets or Sets Id
    /// </summary>
    ...
    public IEnumerable<QueueConversationEventTopicPhoneNumberColumn> PhoneNumberColumns { get; set; }
}
