...
public sealed class BulkOrganizationsEnrichResponse
{
    /// <summary>
    ...
    public IEnumerable<BulkResponseResultExternalOrganizationExternalOrganizationEnrichRequestBulkEntityErrorExternalOrganizationEnrichRequest> Results { get; set; }
