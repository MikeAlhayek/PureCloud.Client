...
public sealed class ConversationAggregationQuery
{
    /// <summary>
    ...
    public ConversationAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public IEnumerable<ConversationAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    /// </summary>
    public IEnumerable<ConversationAggregationQueryMetricsEnum> Metrics { get; set; }
