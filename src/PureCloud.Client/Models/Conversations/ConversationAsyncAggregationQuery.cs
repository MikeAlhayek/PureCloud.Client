...
public sealed class ConversationAsyncAggregationQuery
{
    /// <summary>
    ...
    public ConversationAsyncAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public IEnumerable<ConversationAsyncAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<ConversationAsyncAggregationQueryMetricsEnum> Metrics { get; set; }
    ...
    public IEnumerable<ConversationAggregationView> Views { get; set; }
