...
public sealed class ConversationScreenShareEventTopicConversationRoutingData
{
    /// <summary>
    ...
    public IEnumerable<ConversationScreenShareEventTopicUriReference> Skills { get; set; }
    ...
    public IEnumerable<ConversationScreenShareEventTopicScoredAgent> ScoredAgents { get; set; }
}
