...
public sealed class ConversationMessageEventTopicConversationRoutingData
{
    /// <summary>
    ...
    public IEnumerable<ConversationMessageEventTopicUriReference> Skills { get; set; }
    ...
    public IEnumerable<ConversationMessageEventTopicScoredAgent> ScoredAgents { get; set; }
}
