...
public sealed class ConversationCobrowseEventTopicConversationRoutingData
{
    /// <summary>
    ...
    public IEnumerable<ConversationCobrowseEventTopicUriReference> Skills { get; set; }
    ...
    public IEnumerable<ConversationCobrowseEventTopicScoredAgent> ScoredAgents { get; set; }
}
