...
public sealed class ConversationChatEventTopicConversationRoutingData
{
    /// <summary>
    ...
    public IEnumerable<ConversationChatEventTopicUriReference> Skills { get; set; }
    ...
    public IEnumerable<ConversationChatEventTopicScoredAgent> ScoredAgents { get; set; }
}
