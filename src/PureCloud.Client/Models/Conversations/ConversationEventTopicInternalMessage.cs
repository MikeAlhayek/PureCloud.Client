...
public sealed class ConversationEventTopicInternalMessage
{
    /// <summary>
    /// Gets or Sets State
    /// </summary>
    public ConversationEventTopicInternalMessageState? State { get; set; }

    /// <summary>
    /// Gets or Sets InitialState
    /// </summary>
    public ConversationEventTopicInternalMessageInitialState? InitialState { get; set; }

    /// <summary>
    /// System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.
    /// </summary>
    /// <value>System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.</value>
    public ConversationEventTopicInternalMessageDisconnectType? DisconnectType { get; set; }
    ...
    public IEnumerable<ConversationEventTopicInternalMessageDetails> Messages { get; set; }
}
