...
public sealed class ConversationEventTopicCallback
{
    /// <summary>
    /// Gets or Sets State
    /// </summary>
    public ConversationEventTopicCallbackState? State { get; set; }

    /// <summary>
    /// Gets or Sets InitialState
    /// </summary>
    public ConversationEventTopicCallbackInitialState? InitialState { get; set; }

    /// <summary>
    /// The direction of the call
    /// </summary>
    /// <value>The direction of the call</value>
    public ConversationEventTopicCallbackDirection? Direction { get; set; }

    /// <summary>
    /// System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.
    /// </summary>
    /// <value>System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.</value>
    public ConversationEventTopicCallbackDisconnectType? DisconnectType { get; set; }
