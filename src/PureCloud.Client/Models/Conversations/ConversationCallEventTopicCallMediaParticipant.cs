...
public sealed class ConversationCallEventTopicCallMediaParticipant
{
    ...
    /// Gets or Sets State
    /// </summary>
    public ConversationCallEventTopicCallMediaParticipantStateEnum? State { get; set; }

    /// <summary>
    /// Gets or Sets InitialState
    /// </summary>
    public ConversationCallEventTopicCallMediaParticipantInitialStateEnum? InitialState { get; set; }

    /// <summary>
    /// Gets or Sets Direction
    /// </summary>
    public ConversationCallEventTopicCallMediaParticipantDirectionEnum? Direction { get; set; }

    /// <summary>
    /// Gets or Sets DisconnectType
    /// </summary>
    public ConversationCallEventTopicCallMediaParticipantDisconnectTypeEnum? DisconnectType { get; set; }

    /// <summary>
    /// Gets or Sets FlaggedReason
    /// </summary>
    public ConversationCallEventTopicCallMediaParticipantFlaggedReasonEnum? FlaggedReason { get; set; }
