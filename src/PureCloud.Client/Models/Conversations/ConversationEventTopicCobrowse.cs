...
public sealed class ConversationEventTopicCobrowse
{
    /// <summary>
    /// Gets or Sets State
    /// </summary>
    public ConversationEventTopicCobrowseState? State { get; set; }

    /// <summary>
    /// Gets or Sets InitialState
    /// </summary>
    public ConversationEventTopicCobrowseInitialState? InitialState { get; set; }

    /// <summary>
    /// System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.
    /// </summary>
    /// <value>System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.</value>
    public ConversationEventTopicCobrowseDisconnectType? DisconnectType { get; set; }
