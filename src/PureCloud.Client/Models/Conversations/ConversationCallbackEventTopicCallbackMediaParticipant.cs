...
public sealed class ConversationCallbackEventTopicCallbackMediaParticipant
{
    /// <summary>
    /// Gets or Sets State
    /// </summary>
    public ConversationCallbackEventTopicCallbackMediaParticipantStateEnum? State { get; set; }

    /// <summary>
    /// Gets or Sets InitialState
    /// </summary>
    public ConversationCallbackEventTopicCallbackMediaParticipantInitialStateEnum? InitialState { get; set; }

    /// <summary>
    /// Gets or Sets Direction
    /// </summary>
    public ConversationCallbackEventTopicCallbackMediaParticipantDirectionEnum? Direction { get; set; }

    /// <summary>
    /// Gets or Sets DisconnectType
    /// </summary>
    public ConversationCallbackEventTopicCallbackMediaParticipantDisconnectTypeEnum? DisconnectType { get; set; }

    /// <summary>
    /// Gets or Sets FlaggedReason
    /// </summary>
    public ConversationCallbackEventTopicCallbackMediaParticipantFlaggedReasonEnum? FlaggedReason { get; set; }
