...
public sealed class ConversationActivityEntityData
{
    /// <summary>
    /// Activity metric
    /// </summary>
    /// <value>Activity metric</value>
    public ConversationActivityEntityDataMetricEnum? Metric { get; set; }

    /// <summary>
    /// Active routing method
    /// </summary>
    /// <value>Active routing method</value>
    public ConversationActivityEntityDataActiveRoutingEnum? ActiveRouting { get; set; }

    /// <summary>
    /// The direction of the communication
    /// </summary>
    /// <value>The direction of the communication</value>
    public ConversationActivityEntityDataDirectionEnum? Direction { get; set; }

    /// <summary>
    /// The session media type
    /// </summary>
    /// <value>The session media type</value>
    public ConversationActivityEntityDataMediaTypeEnum? MediaType { get; set; }

    /// <summary>
    /// Complete routing method
    /// </summary>
    /// <value>Complete routing method</value>
    public ConversationActivityEntityDataUsedRoutingEnum? UsedRouting { get; set; }
    ...
    public IEnumerable<ConversationActivityEntityDataRequestedRoutingsEnum> RequestedRoutings { get; set; }
    ...
    public IEnumerable<ConversationActivityScoredAgent> ScoredAgents { get; set; }
}
