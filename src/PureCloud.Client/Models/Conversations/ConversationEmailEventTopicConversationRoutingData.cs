...
public sealed class ConversationEmailEventTopicConversationRoutingData
{
    /// <summary>
    ...
    public IEnumerable<ConversationEmailEventTopicUriReference> Skills { get; set; }
    ...
    public IEnumerable<ConversationEmailEventTopicScoredAgent> ScoredAgents { get; set; }
}
