...
public sealed class ConversationCallbackEventTopicConversationRoutingData
{
    /// <summary>
    ...
    public IEnumerable<ConversationCallbackEventTopicUriReference> Skills { get; set; }
    ...
    public IEnumerable<ConversationCallbackEventTopicScoredAgent> ScoredAgents { get; set; }
}
