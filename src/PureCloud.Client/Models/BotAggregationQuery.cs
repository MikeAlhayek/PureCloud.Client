...
public sealed class BotAggregationQuery
{
    /// <summary>
    ...
    public BotAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public IEnumerable<BotAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<BotAggregationQueryMetricsEnum> Metrics { get; set; }
