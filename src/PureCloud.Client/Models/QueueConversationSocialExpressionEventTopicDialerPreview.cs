...
public sealed class QueueConversationSocialExpressionEventTopicDialerPreview
{
    /// <summary>
    /// Gets or Sets Id
    /// </summary>
    ...
    public IEnumerable<QueueConversationSocialExpressionEventTopicPhoneNumberColumn> PhoneNumberColumns { get; set; }
}
