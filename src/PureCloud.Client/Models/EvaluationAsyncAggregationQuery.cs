...
public sealed class EvaluationAsyncAggregationQuery
{
    /// <summary>
    ...
    public EvaluationAsyncAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public IEnumerable<EvaluationAsyncAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<EvaluationAsyncAggregationQueryMetricsEnum> Metrics { get; set; }
    ...
    public IEnumerable<EvaluationAggregationView> Views { get; set; }
