...
public sealed class KnowledgeAggregationQuery
{
    /// <summary>
    ...
    public KnowledgeAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public KnowledgeAggregationQueryQueryTypeEnum? QueryType { get; set; }
    ...
    public IEnumerable<KnowledgeAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<KnowledgeAggregationQueryMetricsEnum> Metrics { get; set; }
