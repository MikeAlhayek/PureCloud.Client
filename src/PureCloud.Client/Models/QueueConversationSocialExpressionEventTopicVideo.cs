...
public sealed class QueueConversationSocialExpressionEventTopicVideo
{
    /// <summary>
    /// Gets or Sets State
    /// </summary>
    public QueueConversationSocialExpressionEventTopicVideoStateEnum? State { get; set; }

    /// <summary>
    /// Gets or Sets InitialState
    /// </summary>
    public QueueConversationSocialExpressionEventTopicVideoInitialStateEnum? InitialState { get; set; }

    /// <summary>
    /// System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.
    /// </summary>
    /// <value>System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.</value>
    public QueueConversationSocialExpressionEventTopicVideoDisconnectTypeEnum? DisconnectType { get; set; }
