...
public partial class LineBase : IEquatable<LineBase>
{
    ...
    public bool Equals(LineBase other)
    {
        ...
        return true &&
            ...
            (
                LineMetaBase == other.LineMetaBase ||
                LineMetaBase != null &&
                LineMetaBase.Equals(other.LineMetaBase)
            ) &&
            (
    ...
    public override int GetHashCode()
    {
        ...
        unchecked // Overflow is fine, just wrap
        {
            ...
            if (LineMetaBase != null)
            {
                hash = hash * 59 + LineMetaBase.GetHashCode();
            }
