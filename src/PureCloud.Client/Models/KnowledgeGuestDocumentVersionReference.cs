...
public partial class KnowledgeGuestDocumentVersionReference : IEquatable<KnowledgeGuestDocumentVersionReference>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="KnowledgeGuestDocumentVersionReference" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected KnowledgeGuestDocumentVersionReference() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="KnowledgeGuestDocumentVersionReference" /> class.
    /// </summary>
    /// <param name="VersionId">The globally unique identifier for the version of the document. (required).</param>
    public KnowledgeGuestDocumentVersionReference(string VersionId = null)
    {
    ...
    /// <summary>
    /// Returns true if KnowledgeGuestDocumentVersionReference instances are equal
    /// </summary>
    /// <param name="other">Instance of KnowledgeGuestDocumentVersionReference to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(KnowledgeGuestDocumentVersionReference other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
