...
public sealed class QueueConversationSocialExpressionEventTopicScreenshare
{
    /// <summary>
    /// Gets or Sets State
    /// </summary>
    public QueueConversationSocialExpressionEventTopicScreenshareStateEnum? State { get; set; }

    /// <summary>
    /// Gets or Sets InitialState
    /// </summary>
    public QueueConversationSocialExpressionEventTopicScreenshareInitialStateEnum? InitialState { get; set; }

    /// <summary>
    /// System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.
    /// </summary>
    /// <value>System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.</value>
    public QueueConversationSocialExpressionEventTopicScreenshareDisconnectTypeEnum? DisconnectType { get; set; }
