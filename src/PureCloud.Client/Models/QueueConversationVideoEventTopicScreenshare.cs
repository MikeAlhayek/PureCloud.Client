...
public sealed class QueueConversationVideoEventTopicScreenshare
{
    /// <summary>
    /// Gets or Sets State
    /// </summary>
    public QueueConversationVideoEventTopicScreenshareStateEnum? State { get; set; }

    /// <summary>
    /// Gets or Sets InitialState
    /// </summary>
    public QueueConversationVideoEventTopicScreenshareInitialStateEnum? InitialState { get; set; }

    /// <summary>
    /// System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.
    /// </summary>
    /// <value>System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.</value>
    public QueueConversationVideoEventTopicScreenshareDisconnectTypeEnum? DisconnectType { get; set; }
