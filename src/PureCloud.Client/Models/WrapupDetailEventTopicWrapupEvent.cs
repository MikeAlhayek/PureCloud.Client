...
public sealed class WrapupDetailEventTopicWrapupEvent
{
    /// <summary>
    /// Gets or Sets MediaType
    /// </summary>
    public WrapupDetailEventTopicWrapupEventMediaTypeEnum? MediaType { get; set; }

    /// <summary>
    /// Gets or Sets Direction
    /// </summary>
    public WrapupDetailEventTopicWrapupEventDirectionEnum? Direction { get; set; }

    /// <summary>
    /// Gets or Sets MessageType
    /// </summary>
    public WrapupDetailEventTopicWrapupEventMessageTypeEnum? MessageType { get; set; }
