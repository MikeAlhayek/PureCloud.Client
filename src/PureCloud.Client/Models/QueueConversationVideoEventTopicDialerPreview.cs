...
public sealed class QueueConversationVideoEventTopicDialerPreview
{
    /// <summary>
    /// Gets or Sets Id
    /// </summary>
    ...
    public IEnumerable<QueueConversationVideoEventTopicPhoneNumberColumn> PhoneNumberColumns { get; set; }
}
