...
public sealed class JourneyAsyncAggregationQuery
{
    /// <summary>
    ...
    public JourneyAsyncAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public IEnumerable<JourneyAsyncAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<JourneyAsyncAggregationQueryMetricsEnum> Metrics { get; set; }
    ...
    public IEnumerable<JourneyAggregationView> Views { get; set; }
