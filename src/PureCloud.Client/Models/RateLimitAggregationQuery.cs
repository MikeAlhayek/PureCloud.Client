...
public sealed class RateLimitAggregationQuery
{
    /// <summary>
    ...
    public RateLimitAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public IEnumerable<RateLimitAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<RateLimitAggregationQueryMetricsEnum> Metrics { get; set; }
    ...
    public IEnumerable<RateLimitAggregationView> Views { get; set; }
}
