...
public sealed class ConversationEventTopicParticipant
{
    /// <summary>
    ...
    public ScreenRecordingState? ScreenRecordingState { get; set; }
    ...
    /// Gets or Sets Calls
    /// </summary>
    public IEnumerable<ConversationEventTopicCall> Calls { get; set; }

    /// <summary>
    /// Gets or Sets Callbacks
    /// </summary>
    public IEnumerable<ConversationEventTopicCallback> Callbacks { get; set; }

    /// <summary>
    /// Gets or Sets Chats
    /// </summary>
    public IEnumerable<ConversationEventTopicChat> Chats { get; set; }

    /// <summary>
    /// Gets or Sets Cobrowsesessions
    /// </summary>
    public IEnumerable<ConversationEventTopicCobrowse> Cobrowsesessions { get; set; }

    /// <summary>
    /// Gets or Sets Emails
    /// </summary>
    public IEnumerable<ConversationEventTopicEmail> Emails { get; set; }

    /// <summary>
    /// Gets or Sets Messages
    /// </summary>
    public IEnumerable<ConversationEventTopicMessage> Messages { get; set; }

    /// <summary>
    /// Gets or Sets InternalMessages
    /// </summary>
    public IEnumerable<ConversationEventTopicInternalMessage> InternalMessages { get; set; }

    /// <summary>
    /// Gets or Sets Screenshares
    /// </summary>
    public IEnumerable<ConversationEventTopicScreenshare> Screenshares { get; set; }

    /// <summary>
    /// Gets or Sets SocialExpressions
    /// </summary>
    public IEnumerable<ConversationEventTopicSocialExpression> SocialExpressions { get; set; }

    /// <summary>
    /// Gets or Sets Videos
    /// </summary>
    public IEnumerable<ConversationEventTopicVideo> Videos { get; set; }
