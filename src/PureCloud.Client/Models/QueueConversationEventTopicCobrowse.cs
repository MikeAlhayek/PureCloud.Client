...
public sealed class QueueConversationEventTopicCobrowse
{
    /// <summary>
    /// Gets or Sets State
    /// </summary>
    public QueueConversationEventTopicCobrowseStateEnum? State { get; set; }

    /// <summary>
    /// Gets or Sets InitialState
    /// </summary>
    public QueueConversationEventTopicCobrowseInitialStateEnum? InitialState { get; set; }

    /// <summary>
    /// System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.
    /// </summary>
    /// <value>System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.</value>
    public QueueConversationEventTopicCobrowseDisconnectTypeEnum? DisconnectType { get; set; }
