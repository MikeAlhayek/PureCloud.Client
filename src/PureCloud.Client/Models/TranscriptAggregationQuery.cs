...
public sealed class TranscriptAggregationQuery
{
    /// <summary>
    ...
    public TranscriptAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public IEnumerable<TranscriptAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<TranscriptAggregationQueryMetricsEnum> Metrics { get; set; }
