...
public sealed class BulkContactsEnrichResponse
{
    /// <summary>
    ...
    public IEnumerable<BulkResponseResultExternalContactContactEnrichRequestBulkEntityErrorContactEnrichRequest> Results { get; set; }
