...
public sealed class DialerCampaignScheduleConfigChangeScheduleRecurrence
{
    /// <summary>
    /// the recurrence id
    /// </summary>
    ...
    public IEnumerable<DialerCampaignScheduleConfigChangeAlteration> Alterations { get; set; }
