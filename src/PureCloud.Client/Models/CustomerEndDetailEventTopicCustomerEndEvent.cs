...
public sealed class CustomerEndDetailEventTopicCustomerEndEvent
{
    /// <summary>
    /// Gets or Sets DisconnectType
    /// </summary>
    public CustomerEndDetailEventTopicCustomerEndEventDisconnectTypeEnum? DisconnectType { get; set; }

    /// <summary>
    /// Gets or Sets MediaType
    /// </summary>
    public CustomerEndDetailEventTopicCustomerEndEventMediaTypeEnum? MediaType { get; set; }

    /// <summary>
    /// Gets or Sets Direction
    /// </summary>
    public CustomerEndDetailEventTopicCustomerEndEventDirectionEnum? Direction { get; set; }

    /// <summary>
    /// Gets or Sets MessageType
    /// </summary>
    public CustomerEndDetailEventTopicCustomerEndEventMessageTypeEnum? MessageType { get; set; }
