...
public sealed class FlowExecutionAggregationQuery
{
    /// <summary>
    ...
    public FlowExecutionAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public IEnumerable<FlowExecutionAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<FlowExecutionAggregationQueryMetricsEnum> Metrics { get; set; }
