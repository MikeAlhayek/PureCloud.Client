...
public sealed class WorkitemsUserEventsNotificationWorkitem
{
    /// <summary>
    /// Gets or Sets StatusCategory
    /// </summary>
    public WorkitemsUserEventsNotificationWorkitemStatusCategoryEnum? StatusCategory { get; set; }

    /// <summary>
    /// Gets or Sets Operation
    /// </summary>
    public WorkitemsUserEventsNotificationWorkitemOperationEnum? Operation { get; set; }

    /// <summary>
    /// Gets or Sets AssignmentState
    /// </summary>
    public WorkitemsUserEventsNotificationWorkitemAssignmentStateEnum? AssignmentState { get; set; }
    ...
    /// </summary>
    public IEnumerable<WorkitemsUserEventsNotificationDelta> Changes { get; set; }
    ...
    /// </summary>
    public IEnumerable<WorkitemsUserEventsNotificationSession> Sessions { get; set; }
