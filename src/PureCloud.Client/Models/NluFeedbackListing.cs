...
public partial class NluFeedbackListing : IEquatable<NluFeedbackListing>, IPagedResource<NluFeedbackResponse>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="NluFeedbackListing" /> class.
    /// </summary>
    ...
    public NluFeedbackListing(IEnumerable<NluFeedbackResponse> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public IEnumerable<NluFeedbackResponse> Entities { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class NluFeedbackListing {\n");
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as NluFeedbackListing);
    }

    /// <summary>
    /// Returns true if NluFeedbackListing instances are equal
    /// </summary>
    /// <param name="other">Instance of NluFeedbackListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(NluFeedbackListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
