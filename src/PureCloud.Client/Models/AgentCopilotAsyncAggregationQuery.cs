...
public sealed class AgentCopilotAsyncAggregationQuery
{
    /// <summary>
    ...
    public AgentCopilotAsyncAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public AgentCopilotAsyncAggregationQueryQueryTypeEnum? QueryType { get; set; }
    ...
    public IEnumerable<AgentCopilotAsyncAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<AgentCopilotAsyncAggregationQueryMetricsEnum> Metrics { get; set; }
    ...
    public IEnumerable<AgentCopilotAggregationView> Views { get; set; }
