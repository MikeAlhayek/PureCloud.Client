...
public sealed class ContactDetailEventTopicContactUpdateEvent
{
    /// <summary>
    /// Gets or Sets MediaType
    /// </summary>
    public ContactDetailEventTopicContactUpdateEventMediaTypeEnum? MediaType { get; set; }

    /// <summary>
    /// Gets or Sets Direction
    /// </summary>
    public ContactDetailEventTopicContactUpdateEventDirectionEnum? Direction { get; set; }

    /// <summary>
    /// Gets or Sets MessageType
    /// </summary>
    public ContactDetailEventTopicContactUpdateEventMessageTypeEnum? MessageType { get; set; }
