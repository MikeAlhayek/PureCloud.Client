...
public sealed class QueueConversationSocialExpressionEventTopicDisconnectReason
{
    /// <summary>
    /// Disconnect reason protocol type.
    /// </summary>
    /// <value>Disconnect reason protocol type.</value>
    public QueueConversationSocialExpressionEventTopicDisconnectReasonTypeEnum? Type { get; set; }
