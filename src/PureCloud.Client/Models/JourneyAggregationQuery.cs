...
public sealed class JourneyAggregationQuery
{
    /// <summary>
    ...
    public JourneyAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public IEnumerable<JourneyAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<JourneyAggregationQueryMetricsEnum> Metrics { get; set; }
