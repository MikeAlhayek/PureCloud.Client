...
public sealed class BulkFetchOrganizationsResponse
{
    /// <summary>
    ...
    public IEnumerable<BulkResponseResultExternalOrganizationEntityBulkEntityErrorEntity> Results { get; set; }
