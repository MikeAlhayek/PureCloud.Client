...
public sealed class QueueConversationEmailEventTopicEmailMediaParticipant
{
    /// <summary>
    /// Gets or Sets State
    /// </summary>
    public QueueConversationEmailEventTopicEmailMediaParticipantStateEnum? State { get; set; }

    /// <summary>
    /// Gets or Sets InitialState
    /// </summary>
    public QueueConversationEmailEventTopicEmailMediaParticipantInitialStateEnum? InitialState { get; set; }

    /// <summary>
    /// Gets or Sets Direction
    /// </summary>
    public QueueConversationEmailEventTopicEmailMediaParticipantDirectionEnum? Direction { get; set; }

    /// <summary>
    /// Gets or Sets DisconnectType
    /// </summary>
    public QueueConversationEmailEventTopicEmailMediaParticipantDisconnectTypeEnum? DisconnectType { get; set; }

    /// <summary>
    /// Gets or Sets FlaggedReason
    /// </summary>
    public QueueConversationEmailEventTopicEmailMediaParticipantFlaggedReasonEnum? FlaggedReason { get; set; }
    ...
    /// </summary>
    public IEnumerable<QueueConversationEmailEventTopicAttachment> DraftAttachments { get; set; }
