...
public sealed class WfmBuShortTermForecastUpdateCompleteTopicBuShortTermForecast
{
    /// <summary>
    /// Gets or Sets CreationMethod
    /// </summary>
    public WfmBuShortTermForecastUpdateCompleteTopicBuShortTermForecastCreationMethodEnum? CreationMethod { get; set; }
    ...
    /// </summary>
    public IEnumerable<WfmBuShortTermForecastUpdateCompleteTopicForecastSourceDayPointer> SourceDays { get; set; }

    /// <summary>
    /// Gets or Sets Modifications
    /// </summary>
    public IEnumerable<WfmBuShortTermForecastUpdateCompleteTopicBuForecastModification> Modifications { get; set; }
