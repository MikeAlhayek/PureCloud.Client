...
public sealed class CustomerInteractionCenter
{
    /// <summary>
    /// Gets or Sets NameIdentifierFormat
    /// </summary>
    public CustomerInteractionCenterNameIdentifierFormatEnum? NameIdentifierFormat { get; set; }

    /// <summary>
    /// Gets or Sets SsoBinding
    /// </summary>
    public CustomerInteractionCenterSsoBindingEnum? SsoBinding { get; set; }
