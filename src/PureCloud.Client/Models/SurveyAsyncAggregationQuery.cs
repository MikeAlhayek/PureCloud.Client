...
public sealed class SurveyAsyncAggregationQuery
{
    /// <summary>
    ...
    public SurveyAsyncAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public IEnumerable<SurveyAsyncAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<SurveyAsyncAggregationQueryMetricsEnum> Metrics { get; set; }
    ...
    public IEnumerable<SurveyAggregationView> Views { get; set; }
