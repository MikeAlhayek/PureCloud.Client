...
public sealed class FlowExecutionAsyncAggregationQuery
{
    /// <summary>
    ...
    public FlowExecutionAsyncAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public IEnumerable<FlowExecutionAsyncAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<FlowExecutionAsyncAggregationQueryMetricsEnum> Metrics { get; set; }
    ...
    public IEnumerable<FlowExecutionAggregationView> Views { get; set; }
