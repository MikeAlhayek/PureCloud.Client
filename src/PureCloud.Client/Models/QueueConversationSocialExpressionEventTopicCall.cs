...
public sealed class QueueConversationSocialExpressionEventTopicCall
{
    /// <summary>
    /// Gets or Sets State
    /// </summary>
    public QueueConversationSocialExpressionEventTopicCallStateEnum? State { get; set; }

    /// <summary>
    /// Gets or Sets InitialState
    /// </summary>
    public QueueConversationSocialExpressionEventTopicCallInitialStateEnum? InitialState { get; set; }

    /// <summary>
    /// State of recording on this call.
    /// </summary>
    /// <value>State of recording on this call.</value>
    public QueueConversationSocialExpressionEventTopicCallRecordingStateEnum? RecordingState { get; set; }

    /// <summary>
    /// System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.
    /// </summary>
    /// <value>System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.</value>
    public QueueConversationSocialExpressionEventTopicCallDisconnectTypeEnum? DisconnectType { get; set; }

    /// <summary>
    /// Whether a call is inbound or outbound.
    /// </summary>
    /// <value>Whether a call is inbound or outbound.</value>
    public QueueConversationSocialExpressionEventTopicCallDirectionEnum? Direction { get; set; }
    ...
    public IEnumerable<QueueConversationSocialExpressionEventTopicDisconnectReason> DisconnectReasons { get; set; }
