...
public sealed class QueueConversationEventTopicParticipant
{
    /// <summary>
    ...
    /// Gets or Sets Calls
    /// </summary>
    public IEnumerable<QueueConversationEventTopicCall> Calls { get; set; }

    /// <summary>
    /// Gets or Sets Callbacks
    /// </summary>
    public IEnumerable<QueueConversationEventTopicCallback> Callbacks { get; set; }

    /// <summary>
    /// Gets or Sets Chats
    /// </summary>
    public IEnumerable<QueueConversationEventTopicChat> Chats { get; set; }

    /// <summary>
    /// Gets or Sets Cobrowsesessions
    /// </summary>
    public IEnumerable<QueueConversationEventTopicCobrowse> Cobrowsesessions { get; set; }

    /// <summary>
    /// Gets or Sets Emails
    /// </summary>
    public IEnumerable<QueueConversationEventTopicEmail> Emails { get; set; }

    /// <summary>
    /// Gets or Sets Messages
    /// </summary>
    public IEnumerable<QueueConversationEventTopicMessage> Messages { get; set; }

    /// <summary>
    /// Gets or Sets InternalMessages
    /// </summary>
    public IEnumerable<QueueConversationEventTopicInternalMessage> InternalMessages { get; set; }

    /// <summary>
    /// Gets or Sets Screenshares
    /// </summary>
    public IEnumerable<QueueConversationEventTopicScreenshare> Screenshares { get; set; }

    /// <summary>
    /// Gets or Sets SocialExpressions
    /// </summary>
    public IEnumerable<QueueConversationEventTopicSocialExpression> SocialExpressions { get; set; }

    /// <summary>
    /// Gets or Sets Videos
    /// </summary>
    public IEnumerable<QueueConversationEventTopicVideo> Videos { get; set; }
