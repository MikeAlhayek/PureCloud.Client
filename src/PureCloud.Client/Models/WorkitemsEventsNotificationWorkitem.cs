...
public sealed class WorkitemsEventsNotificationWorkitem
{
    /// <summary>
    /// Gets or Sets StatusCategory
    /// </summary>
    public WorkitemsEventsNotificationWorkitemStatusCategoryEnum? StatusCategory { get; set; }

    /// <summary>
    /// Gets or Sets Operation
    /// </summary>
    public WorkitemsEventsNotificationWorkitemOperationEnum? Operation { get; set; }

    /// <summary>
    /// Gets or Sets AssignmentState
    /// </summary>
    public WorkitemsEventsNotificationWorkitemAssignmentStateEnum? AssignmentState { get; set; }
    ...
    /// </summary>
    public IEnumerable<WorkitemsEventsNotificationDelta> Changes { get; set; }
    ...
    /// </summary>
    public IEnumerable<WorkitemsEventsNotificationSession> Sessions { get; set; }
