...
public sealed class QueueConversationVideoEventTopicVideo
{
    /// <summary>
    /// Gets or Sets State
    /// </summary>
    public QueueConversationVideoEventTopicVideoStateEnum? State { get; set; }

    /// <summary>
    /// Gets or Sets InitialState
    /// </summary>
    public QueueConversationVideoEventTopicVideoInitialStateEnum? InitialState { get; set; }

    /// <summary>
    /// System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.
    /// </summary>
    /// <value>System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.</value>
    public QueueConversationVideoEventTopicVideoDisconnectTypeEnum? DisconnectType { get; set; }
