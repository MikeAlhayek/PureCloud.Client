...
public sealed class ActionAsyncAggregationQuery
{
    /// <summary>
    ...
    public ActionAsyncAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public IEnumerable<ActionAsyncAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<ActionAsyncAggregationQueryMetricsEnum> Metrics { get; set; }
    ...
    public IEnumerable<ActionAggregationView> Views { get; set; }
