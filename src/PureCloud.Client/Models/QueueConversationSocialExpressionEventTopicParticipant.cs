...
public sealed class QueueConversationSocialExpressionEventTopicParticipant
{
    /// <summary>
    ...
    public QueueConversationSocialExpressionEventTopicParticipantScreenRecordingStateEnum? ScreenRecordingState { get; set; }
    ...
    /// Gets or Sets Calls
    /// </summary>
    public IEnumerable<QueueConversationSocialExpressionEventTopicCall> Calls { get; set; }

    /// <summary>
    /// Gets or Sets Callbacks
    /// </summary>
    public IEnumerable<QueueConversationSocialExpressionEventTopicCallback> Callbacks { get; set; }

    /// <summary>
    /// Gets or Sets Chats
    /// </summary>
    public IEnumerable<QueueConversationSocialExpressionEventTopicChat> Chats { get; set; }

    /// <summary>
    /// Gets or Sets Cobrowsesessions
    /// </summary>
    public IEnumerable<QueueConversationSocialExpressionEventTopicCobrowse> Cobrowsesessions { get; set; }

    /// <summary>
    /// Gets or Sets Emails
    /// </summary>
    public IEnumerable<QueueConversationSocialExpressionEventTopicEmail> Emails { get; set; }

    /// <summary>
    /// Gets or Sets Messages
    /// </summary>
    public IEnumerable<QueueConversationSocialExpressionEventTopicMessage> Messages { get; set; }

    /// <summary>
    /// Gets or Sets InternalMessages
    /// </summary>
    public IEnumerable<QueueConversationSocialExpressionEventTopicInternalMessage> InternalMessages { get; set; }

    /// <summary>
    /// Gets or Sets Screenshares
    /// </summary>
    public IEnumerable<QueueConversationSocialExpressionEventTopicScreenshare> Screenshares { get; set; }

    /// <summary>
    /// Gets or Sets SocialExpressions
    /// </summary>
    public IEnumerable<QueueConversationSocialExpressionEventTopicSocialExpression> SocialExpressions { get; set; }

    /// <summary>
    /// Gets or Sets Videos
    /// </summary>
    public IEnumerable<QueueConversationSocialExpressionEventTopicVideo> Videos { get; set; }
