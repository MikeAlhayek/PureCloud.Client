...
public sealed class BuSchedulingSettingsResponse
{
    ...
    public BuSchedulingSettingsResponseActivitySmoothingTypeEnum? ActivitySmoothingType { get; set; }
    ...
    public IEnumerable<BuSchedulingSettingsResponseSyncTimeOffPropertiesEnum> SyncTimeOffProperties { get; set; }
