...
public sealed class KnowledgeAggregationView
{
    /// <summary>
    /// Target metric name
    /// </summary>
    /// <value>Target metric name</value>
    public KnowledgeAggregationViewTargetEnum? Target { get; set; }

    /// <summary>
    /// Type of view you wish to create
    /// </summary>
    /// <value>Type of view you wish to create</value>
    public KnowledgeAggregationViewFunctionEnum? Function { get; set; }
