...
public sealed class QueueConversationSocialExpressionEventTopicMessage
{
    /// <summary>
    /// Gets or Sets State
    /// </summary>
    public QueueConversationSocialExpressionEventTopicMessageStateEnum? State { get; set; }

    /// <summary>
    /// Gets or Sets InitialState
    /// </summary>
    public QueueConversationSocialExpressionEventTopicMessageInitialStateEnum? InitialState { get; set; }

    /// <summary>
    /// Whether a message is inbound or outbound.
    /// </summary>
    /// <value>Whether a message is inbound or outbound.</value>
    public QueueConversationSocialExpressionEventTopicMessageDirectionEnum? Direction { get; set; }

    /// <summary>
    /// System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.
    /// </summary>
    /// <value>System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.</value>
    public QueueConversationSocialExpressionEventTopicMessageDisconnectTypeEnum? DisconnectType { get; set; }

    /// <summary>
    /// Indicates the type of message platform from which the message originated.
    /// </summary>
    /// <value>Indicates the type of message platform from which the message originated.</value>
    public QueueConversationSocialExpressionEventTopicMessageTypeEnum? Type { get; set; }
    ...
    public IEnumerable<QueueConversationSocialExpressionEventTopicMessageDetails> Messages { get; set; }
