...
public sealed class ConversationEventTopicScreenshare
{
    /// <summary>
    /// Gets or Sets State
    /// </summary>
    public ConversationEventTopicScreenshareState? State { get; set; }

    /// <summary>
    /// Gets or Sets InitialState
    /// </summary>
    public ConversationEventTopicScreenshareInitialState? InitialState { get; set; }

    /// <summary>
    /// System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.
    /// </summary>
    /// <value>System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.</value>
    public ConversationEventTopicScreenshareDisconnectType? DisconnectType { get; set; }
