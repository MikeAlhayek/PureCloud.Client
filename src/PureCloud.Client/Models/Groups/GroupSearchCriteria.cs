...
public sealed class GroupSearchCriteria
{
    /// <summary>
    /// How to apply this search criteria against other criteria
    /// </summary>
    /// <value>How to apply this search criteria against other criteria</value>
    public GroupSearchCriteriaOperatorEnum? Operator { get; set; }

    /// <summary>
    /// Search Type
    /// </summary>
    /// <value>Search Type</value>
    public GroupSearchCriteriaTypeEnum? Type { get; set; }
    ...
    public IEnumerable<GroupSearchCriteria> Group { get; set; }
