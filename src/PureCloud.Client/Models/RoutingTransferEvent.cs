...
public partial class RoutingTransferEvent : IEquatable<RoutingTransferEvent>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="RoutingTransferEvent" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected RoutingTransferEvent() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="RoutingTransferEvent" /> class.
    /// </summary>
    ...
    /// <summary>
    /// Returns true if RoutingTransferEvent instances are equal
    /// </summary>
    /// <param name="other">Instance of RoutingTransferEvent to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(RoutingTransferEvent other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
