...
public sealed class QueueConversationCallbackEventTopicDialerPreview
{
    /// <summary>
    /// Gets or Sets Id
    /// </summary>
    ...
    public IEnumerable<QueueConversationCallbackEventTopicPhoneNumberColumn> PhoneNumberColumns { get; set; }
}
