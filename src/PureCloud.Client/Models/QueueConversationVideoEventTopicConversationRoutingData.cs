...
public sealed class QueueConversationVideoEventTopicConversationRoutingData
{
    /// <summary>
    /// Gets or Sets Queue
    /// </summary>
    ...
    public IEnumerable<QueueConversationVideoEventTopicUriReference> Skills { get; set; }
    ...
    public IEnumerable<QueueConversationVideoEventTopicScoredAgent> ScoredAgents { get; set; }
}
