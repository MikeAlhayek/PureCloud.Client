...
public sealed class PureEngage
{
    /// <summary>
    /// Gets or Sets NameIdentifierFormat
    /// </summary>
    public PureEngageNameIdentifierFormatEnum? NameIdentifierFormat { get; set; }
    /// <summary>
    /// Gets or Sets SsoBinding
    /// </summary>
    public PureEngageSsoBindingEnum? SsoBinding { get; set; }
