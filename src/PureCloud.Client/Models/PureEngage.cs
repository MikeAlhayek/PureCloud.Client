...
public partial class PureEngage : IEquatable<PureEngage>
{
    ...
    /// </summary>
    [JsonPropertyName("autoProvisionUsers")]
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as PureEngage);
    }
    ...
    public bool Equals(PureEngage other)
    {
        ...
        return true &&
            ...
            (
                AutoProvisionUsers == other.AutoProvisionUsers ||
                AutoProvisionUsers != null &&
                AutoProvisionUsers.Equals(other.AutoProvisionUsers)
            ) &&
            (
    ...
    public override int GetHashCode()
    {
        ...
        unchecked // Overflow is fine, just wrap
        {
            ...
            {
                hash = hash * 59 + AutoProvisionUsers.GetHashCode();
            }
