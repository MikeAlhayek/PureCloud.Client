...
public sealed class TranscriptAsyncAggregationQuery
{
    /// <summary>
    ...
    public TranscriptAsyncAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public IEnumerable<TranscriptAsyncAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<TranscriptAsyncAggregationQueryMetricsEnum> Metrics { get; set; }
    ...
    public IEnumerable<TranscriptAggregationView> Views { get; set; }
