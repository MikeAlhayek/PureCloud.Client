...
public sealed class PingIdentity
{
    /// <summary>
    /// Gets or Sets NameIdentifierFormat
    /// </summary>
    public PingIdentityNameIdentifierFormatEnum? NameIdentifierFormat { get; set; }
    /// <summary>
    /// Gets or Sets SsoBinding
    /// </summary>
    public PingIdentitySsoBindingEnum? SsoBinding { get; set; }
