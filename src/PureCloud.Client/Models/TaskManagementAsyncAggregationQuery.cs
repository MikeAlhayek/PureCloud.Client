...
public sealed class TaskManagementAsyncAggregationQuery
{
    /// <summary>
    ...
    public TaskManagementAsyncAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public IEnumerable<TaskManagementAsyncAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<TaskManagementAsyncAggregationQueryMetricsEnum> Metrics { get; set; }
    ...
    public IEnumerable<TaskManagementAggregationView> Views { get; set; }
