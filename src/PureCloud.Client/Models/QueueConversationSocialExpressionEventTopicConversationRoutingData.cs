...
public sealed class QueueConversationSocialExpressionEventTopicConversationRoutingData
{
    /// <summary>
    /// Gets or Sets Queue
    /// </summary>
    ...
    public IEnumerable<QueueConversationSocialExpressionEventTopicUriReference> Skills { get; set; }
    ...
    public IEnumerable<QueueConversationSocialExpressionEventTopicScoredAgent> ScoredAgents { get; set; }
}
