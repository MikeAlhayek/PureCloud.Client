...
public sealed class TaskManagementAggregationQuery
{
    /// <summary>
    ...
    public TaskManagementAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public IEnumerable<TaskManagementAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<TaskManagementAggregationQueryMetricsEnum> Metrics { get; set; }
