...
public sealed class CustomerStartDetailEventTopicCustomerStartEvent
{
    /// <summary>
    /// Gets or Sets MediaType
    /// </summary>
    public CustomerStartDetailEventTopicCustomerStartEventMediaTypeEnum? MediaType { get; set; }

    /// <summary>
    /// Gets or Sets Direction
    /// </summary>
    public CustomerStartDetailEventTopicCustomerStartEventDirectionEnum? Direction { get; set; }

    /// <summary>
    /// Gets or Sets MessageType
    /// </summary>
    public CustomerStartDetailEventTopicCustomerStartEventMessageTypeEnum? MessageType { get; set; }
