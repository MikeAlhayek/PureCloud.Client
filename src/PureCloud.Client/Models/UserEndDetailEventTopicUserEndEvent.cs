...
public sealed class UserEndDetailEventTopicUserEndEvent
{
    /// <summary>
    /// Gets or Sets DisconnectType
    /// </summary>
    public UserEndDetailEventTopicUserEndEventDisconnectTypeEnum? DisconnectType { get; set; }

    /// <summary>
    /// Gets or Sets MediaType
    /// </summary>
    public UserEndDetailEventTopicUserEndEventMediaTypeEnum? MediaType { get; set; }

    /// <summary>
    /// Gets or Sets Direction
    /// </summary>
    public UserEndDetailEventTopicUserEndEventDirectionEnum? Direction { get; set; }

    /// <summary>
    /// Gets or Sets MessageType
    /// </summary>
    public UserEndDetailEventTopicUserEndEventMessageTypeEnum? MessageType { get; set; }
