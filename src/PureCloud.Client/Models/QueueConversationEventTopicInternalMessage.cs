...
public sealed class QueueConversationEventTopicInternalMessage
{
    /// <summary>
    /// Gets or Sets State
    /// </summary>
    public QueueConversationEventTopicInternalMessageStateEnum? State { get; set; }

    /// <summary>
    /// Gets or Sets InitialState
    /// </summary>
    public QueueConversationEventTopicInternalMessageInitialStateEnum? InitialState { get; set; }

    /// <summary>
    /// System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.
    /// </summary>
    /// <value>System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.</value>
    public QueueConversationEventTopicInternalMessageDisconnectTypeEnum? DisconnectType { get; set; }
    ...
    public IEnumerable<QueueConversationEventTopicInternalMessageDetails> Messages { get; set; }
}
