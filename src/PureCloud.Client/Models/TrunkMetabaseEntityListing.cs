...
public partial class TrunkMetabaseEntityListing : IEquatable<TrunkMetabaseEntityListing>, IPagedResource<Metabase>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="TrunkMetabaseEntityListing" /> class.
    /// </summary>
    ...
    public TrunkMetabaseEntityListing(List<Metabase> Entities = null, int? PageSize = null, int? PageNumber = null, long? Total = null, long? TotalNumberOfEntities = null, string FirstUri = null, string LastUri = null, string SelfUri = null, string NextUri = null, string PreviousUri = null, int? PageCount = null)
    {
    ...
    public List<Metabase> Entities { get; set; }
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as TrunkMetabaseEntityListing);
    }

    /// <summary>
    /// Returns true if TrunkMetabaseEntityListing instances are equal
    /// </summary>
    /// <param name="other">Instance of TrunkMetabaseEntityListing to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(TrunkMetabaseEntityListing other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
