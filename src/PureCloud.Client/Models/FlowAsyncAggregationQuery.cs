...
public sealed class FlowAsyncAggregationQuery
{
    /// <summary>
    ...
    public FlowAsyncAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public IEnumerable<FlowAsyncAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<FlowAsyncAggregationQueryMetricsEnum> Metrics { get; set; }
    ...
    public IEnumerable<FlowAggregationView> Views { get; set; }
