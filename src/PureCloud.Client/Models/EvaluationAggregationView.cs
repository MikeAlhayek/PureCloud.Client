...
public sealed class EvaluationAggregationView
{
    /// <summary>
    /// Target metric name
    /// </summary>
    /// <value>Target metric name</value>
    public EvaluationAggregationViewTargetEnum? Target { get; set; }

    /// <summary>
    /// Type of view you wish to create
    /// </summary>
    /// <value>Type of view you wish to create</value>
    public EvaluationAggregationViewFunctionEnum? Function { get; set; }
