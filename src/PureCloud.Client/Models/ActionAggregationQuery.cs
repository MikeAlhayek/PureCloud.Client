...
public sealed class ActionAggregationQuery
{
    /// <summary>
    ...
    public ActionAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public IEnumerable<ActionAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<ActionAggregationQueryMetricsEnum> Metrics { get; set; }
