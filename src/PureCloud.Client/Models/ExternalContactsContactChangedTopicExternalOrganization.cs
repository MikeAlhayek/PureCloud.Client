...
public sealed class ExternalContactsContactChangedTopicExternalOrganization
{
    /// <summary>
    /// Gets or Sets Id
    /// </summary>
    ...
    /// </summary>
    public IEnumerable<ExternalContactsContactChangedTopicTicker> Tickers { get; set; }
