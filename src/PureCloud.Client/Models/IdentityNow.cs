...
public sealed class IdentityNow
{
    /// <summary>
    /// Gets or Sets NameIdentifierFormat
    /// </summary>
    public IdentityNowNameIdentifierFormatEnum? NameIdentifierFormat { get; set; }

    /// <summary>
    /// Gets or Sets SsoBinding
    /// </summary>
    public IdentityNowSsoBindingEnum? SsoBinding { get; set; }
