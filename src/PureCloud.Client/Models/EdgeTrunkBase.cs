...
public partial class EdgeTrunkBase : IEquatable<EdgeTrunkBase>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="EdgeTrunkBase" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected EdgeTrunkBase() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="EdgeTrunkBase" /> class.
    /// </summary>
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as EdgeTrunkBase);
    }

    /// <summary>
    /// Returns true if EdgeTrunkBase instances are equal
    /// </summary>
    /// <param name="other">Instance of EdgeTrunkBase to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(EdgeTrunkBase other)
    {
        // credit: http://stackoverflow.com/a/10454552/677735
        if (other == null)
        {
        ...
        return true &&
            ...
            (
                InboundSite == other.InboundSite ||
                InboundSite != null &&
                InboundSite.Equals(other.InboundSite)
            ) &&
            (
    ...
    public override int GetHashCode()
    {
        ...
        unchecked // Overflow is fine, just wrap
        {
            ...
            if (InboundSite != null)
            {
                hash = hash * 59 + InboundSite.GetHashCode();
            }
