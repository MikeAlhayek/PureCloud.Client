...
public sealed class ResolutionAggregationView
{
    public ResolutionAggregationViewTargetEnum? Target { get; set; }

    /// <summary>
    /// Type of view you wish to create
    /// </summary>
    /// <value>Type of view you wish to create</value>
    public ResolutionAggregationViewFunctionEnum? Function { get; set; }
