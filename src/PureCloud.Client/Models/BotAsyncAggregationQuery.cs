...
public sealed class BotAsyncAggregationQuery
{
    /// <summary>
    ...
    public BotAsyncAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public IEnumerable<BotAsyncAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<BotAsyncAggregationQueryMetricsEnum> Metrics { get; set; }
    ...
    public IEnumerable<BotAggregationView> Views { get; set; }
