...
public sealed class BulkContactsResponse
{
    /// <summary>
    ...
    public IEnumerable<BulkResponseResultExternalContactExternalContactBulkEntityErrorExternalContact> Results { get; set; }
