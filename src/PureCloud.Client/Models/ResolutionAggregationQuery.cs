...
public sealed class ResolutionAggregationQuery
{
    /// <summary>
    ...
    public ResolutionAggregationQueryAlternateTimeDimensionEnum? AlternateTimeDimension { get; set; }
    ...
    public IEnumerable<ResolutionAggregationQueryGroupByEnum> GroupBy { get; set; }
    ...
    public IEnumerable<ResolutionAggregationQueryMetricsEnum> Metrics { get; set; }
