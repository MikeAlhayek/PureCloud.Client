...
public sealed class AnalyticsParticipant
{
    /// <summary>
    /// Reason for which participant flagged conversation
    /// </summary>
    /// <value>Reason for which participant flagged conversation</value>
    public AnalyticsParticipantFlaggedReasonEnum? FlaggedReason { get; set; }

    /// <summary>
    /// The participant's purpose
    /// </summary>
    /// <value>The participant's purpose</value>
    public AnalyticsParticipantPurposeEnum? Purpose { get; set; }
