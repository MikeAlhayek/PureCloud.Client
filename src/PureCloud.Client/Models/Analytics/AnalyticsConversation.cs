...
public sealed class AnalyticsConversation
{
    /// <summary>
    ...
    public AnalyticsConversationConversationInitiatorEnum? ConversationInitiator { get; set; }

    /// <summary>
    /// The original direction of the conversation
    /// </summary>
    /// <value>The original direction of the conversation</value>
    public AnalyticsConversationOriginatingDirectionEnum? OriginatingDirection { get; set; }
    ...
    public IEnumerable<AnalyticsParticipant> Participants { get; set; }
}
